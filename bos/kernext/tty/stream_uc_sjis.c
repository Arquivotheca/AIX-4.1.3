#ifndef lint
static char sccsid[] = "@(#)67 1.3 src/bos/kernext/tty/stream_uc_sjis.c, sysxldterm, bos411, 9438C411e 9/22/94 17:36:47";
#endif
/*
 * COMPONENT_NAME: (sysxtty)
 *
 * FUNCTIONS: uc_conv_ajec2sjis, uc_conv_sjis2ajec, uc_sjis_readdata,
 *            uc_sjis_writedata, uc_sjis_config
 *
 * ORIGINS: 40, 71, 83
 *
 */
