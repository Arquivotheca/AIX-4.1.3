/* @(#)07	1.2  src/bos/diag/tu/pcitok/sky_err_codes.h, tu_pcitok, bos41J, 9519B_all 5/12/95 11:13:12  */
/*
...
#define RX_DESC_ERR     0xD03
#define RX_LEN_ERR      0xD04
#define DATA_MISCOMPARE 0xD05
#define TX_UNDERRUN_ERR 0xD06
#define TX_PROTOCOL_ERR 0xD07
#define TX_DESC_ERR     0xD08


  #define CHG_STATE_ERR 0xC20

  /************ CFG Register Error Codes (tu001) **************************/
  #define VID_ERR      0x1000  /* Vendor ID register error */
  #define DID_ERR      0x1100  /* Device ID register error */
  #define CFG_ERR      0x1200  /* Configuration register error */
  #define MDD_OPEN_FAILED 0x1300 /* Open of machine device driver failed */
  #define MDD_CLOSE_FAILED 0x1400 /* Close of machine device driver failed */

  /************ I/O Register Error Codes (tu001) **************************/
  #define BCONFIG_ERR  0x1500  /* BConfig register error */
  #define BMCONFIG_ERR 0x1600  /* Bus Maseter Config register error */
  #define PCT_ERR      0x1700  /* PCI Control Threshold register error */
...
#define Tx2DBA_HI_ERR     0x7900
  ...
  /************ MPS Error Codes  **************************/
  #define D_MAP_INIT_ERR    0xE00
  #define MBUF_ERR          0xE03
  #define D_MAP_ERR         0xE04
  #define MEMORY_ERR        0xE05
...
#define CFG_PREFIX        "CONFIGURATION REGISTER TEST ERROR: "
