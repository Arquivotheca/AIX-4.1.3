static char sccsid[] = "@(#)66  1.3  src/bos/diag/tu/wga/crosstu.c, tu_wga, bos411, 9428A410j 1/3/94 17:08:24";
/*
...
typedef struct
{
  ...
  ulong_t delta_y;
  BOOL draw_cursor;
  ulong_t x_cursor_pos;
  ulong_t y_cursor_pos;
