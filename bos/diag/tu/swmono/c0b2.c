static char sccsid[] = "@(#)56	1.2  src/bos/diag/tu/swmono/c0b2.c, tu_swmono, bos411, 9428A410j 10/29/93 14:18:41";
/*
...
c0b2()
{
  ...
  { 
    ...
    for (msz=1279,xoff=yoff=0; msz>2; yoff=(xoff=(1279-(msz/=1.3))/2)*1023/1279)
    {
      ...
      rc = make_map(MASK, skyvbase+0x0A0000, ht, wth, BPP1);FUSE;
      writebyte(BPP1, MEM_ACCESS_MODE);
