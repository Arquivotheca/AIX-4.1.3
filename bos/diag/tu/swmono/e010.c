static char sccsid[] = "@(#)63	1.1.1.2  src/bos/diag/tu/swmono/e010.c, tu_swmono, bos411, 9428A410j 2/16/94 10:37:10";
/*
...
e010()
{
  ...
  do
  {
    ...
    fcol = white=0x0F;
    bcol = black=0x00;
    rc = make_map(MAPA, skyvbase, 1024, 1279, BPP4); FUSE;
    rc = clrscr(MAPA, white=0x0F); FUSE;
    rc = make_map(MAPC, skyvbase+0x0A0000, fldht-1, fldwth-1, BPP4); FUSE;
    ...
    rc = make_map(MAPB, skyvbase, fldht-1, 1280-1, BPP4);FUSE;
    ...
    rc = make_map(MAPC, skyvbase, 1024-1+SCRL, 1280-1, BPP4);FUSE;
