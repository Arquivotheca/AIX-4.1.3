static char sccsid[] = "@(#)57	1.2  src/bos/diag/tu/swmono/c0b3.c, tu_swmono, bos411, 9428A410j 10/29/93 14:18:46";
/*
...
c0b3()
{
  ...
  { 
    ...
    rc = make_map(MASK, skyvbase+0x0C8000, ht, wth, BPP1);FUSE;
    rc = make_map(MAPC, skyvbase+0x0C8000, ht, wth, BPP1);FUSE;
    ...
    for (msz=1279, xoff=yoff=0; msz > 2; yoff=(xoff+=(msz/=2)/2)*1023/1279)
    {
      ...
      rc = make_map(MAPB, skyvbase+0x0A0000, ht, wth, BPP1);FUSE;
