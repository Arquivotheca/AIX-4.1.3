static char sccsid[] = "@(#)63	1.1  src/bos/diag/tu/gga/colorbartu.c, tu_gla, bos41J, 9515A_all 4/6/95 09:26:43";
/*
...
static struct RGB default_colors [PAL_LINES] =   /* default color for palette*/
  { { 0x00, 0x00, 0x00 }, { 0xff, 0x00, 0x00 }, { 0x00, 0xff, 0x00 },
    { 0xf0, 0xf0, 0x00 }, { 0x00, 0x00, 0xf0 }, { 0xb0, 0x00, 0xb0 },
    { 0x00, 0xf0, 0xf0 }, { 0xc8, 0xc8, 0xc8 }, { 0x78, 0x78, 0x78 },
    { 0xf0, 0x80, 0x20 }, { 0x50, 0xe0, 0x30 }, { 0xc0, 0x80, 0x20 },
    { 0x30, 0x60, 0xff }, { 0xe0, 0x30, 0xe0 }, { 0x70, 0xf0, 0xd0 },
    { 0xff, 0xff, 0xff }, { 0xf9, 0x2f, 0x5d }, { 0xdf, 0x7e, 0x0a },
    { 0xfe, 0x47, 0xd6 }, { 0xf5, 0xbe, 0x9f }, { 0xbc, 0xcf, 0x07 },
    { 0xe3, 0x6f, 0x76 }, { 0xde, 0xeb, 0xef }, { 0xdf, 0xed, 0x77 },
    { 0x5e, 0x77, 0xfa }, { 0xf7, 0xaa, 0xe2 }, { 0x7b, 0x4a, 0x31 },
    { 0x9d, 0xbd, 0x9f }, { 0x78, 0xd5, 0xdb }, { 0xfe, 0xfd, 0xf9 },
    { 0x6f, 0xcf, 0xdc }, { 0x35, 0xf0, 0xea }, { 0x5c, 0xaf, 0xfb },
    { 0x6d, 0xd3, 0x8f }, { 0xff, 0x3f, 0x14 }, { 0xff, 0x65, 0x6c },
    { 0xd6, 0xbd, 0xfd }, { 0xff, 0xaf, 0x17 }, { 0xbd, 0x3f, 0xdf },
    { 0x77, 0xee, 0x73 }, { 0xbe, 0x1f, 0xf5 }, { 0xef, 0x09, 0x56 },
    { 0xdb, 0xcb, 0xdf }, { 0x7a, 0xa6, 0xbb }, { 0x9f, 0x5a, 0x9f },
    { 0x7f, 0xbf, 0xf4 }, { 0xec, 0xf2, 0x7f }, { 0xe6, 0x13, 0xfb },
    { 0xff, 0x77, 0x50 }, { 0xb8, 0x67, 0xf6 }, { 0xea, 0xc4, 0xfb },
    { 0xfd, 0xa7, 0xce }, { 0xfd, 0xe7, 0xfb }, { 0xc8, 0xbd, 0x1b },
    { 0xb8, 0x7b, 0xfd }, { 0xfb, 0x5e, 0x99 }, { 0xfd, 0x76, 0xfd },
    { 0xaf, 0xb1, 0x6f }, { 0x1d, 0x57, 0x5f }, { 0xb2, 0x47, 0x77 },
    { 0xde, 0x39, 0xe9 }, { 0xdf, 0xd7, 0x1b }, { 0x3f, 0x4b, 0x7f },
    { 0x79, 0x16, 0xe3 }, { 0x97, 0xbb, 0xfd }, { 0xd7, 0xbb, 0xf6 },
    { 0xef, 0x5e, 0x4c }, { 0x0f, 0xe2, 0x7e }, { 0x7d, 0xdf, 0xf3 },
    { 0xfe, 0xff, 0xb7 }, { 0xff, 0x79, 0x2f }, { 0xb5, 0x42, 0xec },
    { 0xa5, 0x79, 0xf9 }, { 0xdc, 0x58, 0x7b }, { 0x7b, 0xc0, 0xfd },
    { 0xea, 0xfb, 0x5b }, { 0x8b, 0x17, 0xfa }, { 0xa4, 0xce, 0xcf },
    { 0x8a, 0x45, 0xfd }, { 0xdd, 0x4d, 0xd7 }, { 0xfc, 0xa7, 0xd3 },
    { 0xff, 0x67, 0x97 }, { 0xff, 0x9a, 0xac }, { 0xc7, 0x72, 0x7f },
    { 0xfe, 0x90, 0xf7 }, { 0x86, 0xff, 0xd7 }, { 0xcb, 0xbf, 0x3f },
    { 0xe6, 0x97, 0xe9 }, { 0xf3, 0x4d, 0xbd }, { 0xb3, 0xbb, 0x9f },
    { 0x7e, 0xf7, 0x45 }, { 0xbf, 0xfb, 0xdd }, { 0x74, 0xa0, 0xa3 },
    { 0xd3, 0xb7, 0x9f }, { 0xfe, 0x9b, 0x77 }, { 0x9e, 0x36, 0x49 },
    { 0xb6, 0xb6, 0x81 } };
#endif
...
static int  draw_single_pixels(UCHAR, float, float);
 ...
 * patterns for the evaluation of the performance of the GGA and
...
int colorbar_tu (void)
{
  ...
  if ((rc = clear_screen ()) == SUCCESS)
  {
    ...
    {
      fill_palette (tone, tone, tone, i, i);
    } /* endfor */
     ...
     if ((rc = draw_color_bars(xscale, yscale)) == SUCCESS)
      if ((rc = draw_grey_scale(xscale, yscale)) == SUCCESS)
       if ((rc = draw_piano_bars(xscale, yscale)) == SUCCESS)
        if ((rc = draw_single_pixels((UCHAR) WHITE, xscale, yscale)) == SUCCESS)
        {
...
static int draw_color_bars(float xscale, float yscale)
{
  ...
  UCHAR color_bars [] = { GREEN, YELLOW, RED, MAGENTA, BLUE,
...
static int draw_single_pixels(UCHAR color, float xscale, float yscale)
{
  POINT    point;
  ULONG  x, y, i, j, status, packed_xy;
  float    xdelta, ydelta;
  int      rc;
 ...
 /* ydelta = trunc ((4.0/16.0) * yscale); */
  xdelta = uitrunc ((4.0/16.0) * xscale);
  ydelta = uitrunc ((4.0/16.0) * yscale);

  rc = SUCCESS;
  point.color = color;
  for(j = 0, y = (ULONG) uitrunc (DOTS_YSTART * yscale);
        rc == SUCCESS && j < NUMBER_DOTS; j++, y += (ULONG) ydelta)
  {
    point.y = y;
    for(i = 0, x = (ULONG) uitrunc (DOTS_XSTART * xscale);
          rc == SUCCESS && i < NUMBER_DOTS; i++, x += (ULONG) xdelta)
    {
      point.x = x;
      rc = draw_point (&point);
    }
...
void save_default_colors (void)
{
  ...
  if (!saved_colors)
  {
    ReadPalette(0, 256, (UCHAR *) default_colors);
    saved_colors = TRUE;
  }
...
void restore_default_colors (void)
{
  ...
  if (palette_initialized)
    {
      WritePalette(0, 256, (UCHAR *) default_colors);
    }
...
void color_init (void)
{
  int    i;
  UCHAR  zero_pal[768];
  static struct RGB colors [NUM_COLORS+1] =
                      { 0,       0,    0,     /* BLACK         */
                        0xFF,    0,    0,     /* RED           */
                        0,    0xFF,    0,     /* GREEN         */
                        0xF0, 0xF0,    0,     /* YELLOW        */
  ...
  WritePalette(0, 256, zero_pal);

   /* Write new entries used by tests */
  WritePalette(0, (NUM_COLORS+1), (UCHAR *) colors);
...
ULONG get_color_pattern (ULONG color)
{
  ULONG i, color_pattern;
