/* static char sccsid[] = "@(#)51  1.1  src/bos/diag/tu/niokta/sem.c, tu_adpkbd, bos411, 9428A410j 1/17/94 16:10:31"; */
/*
 *
...
int set_sem(int fdes, int wait_time)
{
    int                 semid;
    long                long_time;
...
/* FUNCTION NAME: rel_sem()
   ...
   completion of access to POS register 2 by that particular device.
   
   NOTES:         
   ***************************************************************************/

int rel_sem(int fdes)
{
    int    semid;
    struct sembuf       sembuf_s;
    int    pid;
