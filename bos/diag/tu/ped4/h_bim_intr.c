static char sccsid[] = "@(#)39	1.3  src/bos/diag/tu/ped4/h_bim_intr.c, tu_ped4, bos411, 9428A410j 1/12/94 18:08:17";
/*
 ...
 *                  our_gsc_handle from dd_interface.c
 *
 *     TABLES:  None.
 *
 *     MACROS:  None.
...
#define U_SECS_BETWEEN_REG_ACCESSES   1000
   ...
   extern struct hfmomring ring_buff;
   extern set_mc_speed();
 ...
 *
 *
 * EXECUTION ENVIRONMENT:  AIX  during PED/PED4 diagnostics
 *
 * NOTES: Signal handler is set up as part of enter_mom() in dd_interface.c
 *
 * RECOVERY OPERATION: None.
