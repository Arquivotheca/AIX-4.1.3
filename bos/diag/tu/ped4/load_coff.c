static char sccsid[] = "@(#)42	1.2  src/bos/diag/tu/ped4/load_coff.c, tu_ped4, bos411, 9428A410j 8/2/93 11:53:50";
/*
 ...
 * DATA STRUCTURES: None.
 *
 * RETURNS : zero if ped/ped4 address, non-zero if illegal address
 *
