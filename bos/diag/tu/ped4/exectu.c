static char sccsid[] = "@(#)51	1.9  src/bos/diag/tu/ped4/exectu.c, tu_ped4, bos411, 9428A410j 4/20/94 16:42:07";
/*
 ...
 *                     tu_open() in dd_interface.c
 *                     tu_close() in dd_interface.c
 ...
 *           the test units
 *
 * EXECUTION ENVIRONMENT: AIX v3.1 during PED/PED4 diagnostics
 *
 * NOTES: None
 *
 * RECOVERY OPERATION:
...
int exectu(char *logical_device_name, PED4_TU_TYPE *tucb_ptr) 
{
   int ret_code = 0;
...
/* Due to a bug in the BIM chip, set the bus cycles to 300 ns */
   ...
   case TU_03:  /* host_bim_test */
      *(bim_base_addr + DSP_CONTROL) = RESET_DSP;
      ...
      reload_microcode = 1;
      break;
   case TU_04:  /* host_mem_test (test 256K words) */
      *(bim_base_addr + DSP_CONTROL) = RESET_DSP;
      while (!ret_code && loop_count) {
      ...
      reload_microcode = 1;
      break;
   case TU_05:  /* MASTER C30 memory test */
      ...
      reload_microcode = 1;
      break;
   case TU_08:  /* Host interrupt test */
      if (reload_microcode) {
   ...
   case TU_30:
   case TU_31:
   case TU_32:  /* green screen test */
   case TU_33:  /* blue screen test  */
   case TU_34:  /* white screen test */
   case TU_35:  /* black screen test */
   case TU_36:  /* cross hatch 9 x 9 */
   case TU_37:  /* cross hatch 11x 9 */
   case TU_39:  /* overlays, windows, visual test */
   case TU_40:
   case TU_41:
   case TU_42:
   case TU_45:
   ...
   case TU_77:
      ...
      break;
   case TU_43: /* BIM GETHOT thermal exerciser */
   case TU_44: /* BLAST GETHOT and BIM GETHOT running together */
      ret_code = findmcode(C30M_DIAG_MCODE,mc_file,VERSIONING,0);
      if (!ret_code) {
         return(MICROCODE_FILE_NOT_FOUND);
      } /* endif */
 ...
 *                  value.
 *
 * EXECUTION ENVIRONMENT: AIX 3.1 during PED/PED4 diagnostics
 *
 * NOTES:  None.
 *
 * RECOVERY OPERATION: None.
