static char sccsid[] = "src/bos/diag/tu/eth/rw_ctrl.c, tu_eth, bos411, 9428A410j 6/19/91 15:01:14";
/*
 * COMPONENT_NAME: (TU_ETH) Ethernet Test Unit
 *
 * FUNCTIONS: hio_ctrl_wr, hio_ctrl_rd
 *
 * ORIGINS: 27
 *
...
Function(s) Read/Write HIO Control Register

Module Name :  rw_ctrl.c
SCCS ID     :  1.8

Current Date:  6/13/91, 13:11:20
Newest Delta:  1/19/90, 16:25:50
...
int hio_ctrl_wr (fdes, hio_val, status, tucb_ptr)
   int fdes;
...
unsigned char hio_ctrl_rd (fdes, status, tucb_ptr)
   int fdes;
   unsigned long *status;
   TUTYPE *tucb_ptr;
   {
