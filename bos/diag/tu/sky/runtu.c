static char sccsid[] = "@(#)92	1.3  src/bos/diag/tu/sky/runtu.c, tu_sky, bos411, 9428A410j 1/21/94 15:27:57";
/*
 ...
 *  DEBUG */
 ...
 /* DEBUG  set return codes to zero until interrupts and dma support fixed */
     case 0xC0D0: rc = 0; /* DEBUG */
                  break; /* DEBUG */
     case 0xC0D4: rc = 0; /* DEBUG */
                  break; /* DEBUG */
 ...
 /*               break;               */
     ...
     case 0xE00E: rc = e00e();
                  break;
     case 0xE001: rc=e001(0,1);
		  disablesprite();
                  break;
     case 0xE011: rc = e001(0,1);
                  rc = set_ret(CROSHATCH11,E011CRC,rc,MAPA);
		  disablesprite();
                  break;
     case 0xE002: rc=e001(1,0);
		  disablesprite();
                  break;
     case 0xE012: rc = e001(1,0);
                  rc = set_ret(CROSHATCH12,E012CRC,rc,MAPA);
		  disablesprite();
                  break;
     case 0xE003: rc=e002(0,1);
		  disablesprite();
                  break;
     case 0xE013: rc = e002(0,1);
                  rc = set_ret(CROSHATCH13,E013CRC,rc,MAPA);
		  disablesprite();
                  break;
     case 0xE004: rc=e002(1,0);
		  disablesprite();
                  break;
     case 0xE014: rc = e002(1,0);
                  rc = set_ret(CROSHATCH14,E014CRC,rc,MAPA);
		  disablesprite();
                  break;
     case 0xE005: rc=e003(0,1);
		  disablesprite();
                  break;
     case 0xE015: rc = e003(0,1);
                  rc = set_ret(0xE0150000,0xDBDC,rc,MAPA);
		  disablesprite();
                  break;
     case 0xE006: rc=e003(1,0);
		  disablesprite();
                  break;
     case 0xE016: rc = e003(1,0);
                  rc = set_ret(0xE0160000,0xBAA5,rc,MAPA);
		  disablesprite();
                  break;
     case 0xE009: for (color=0; color<0x09; color++)
		 { rc = e002(color,color+1); FUSE; disablesprite();
