static char sccsid[] = "@(#)18	1.2  src/bos/diag/tu/sky/c030.c, tu_sky, bos411, 9428A410j 10/29/93 13:39:19";
/*
...
c030()
{
  ...
  do
  {
    ...
    rc = make_map(MAPB, skyvbase+0x140000, ht, wth, BPP8);FUSE;
...
c032()
{
  ...
  do
  {
    initcop();
    /*set mapA to the screen, set mapB to the test Destination map on screen*/
    rc = make_map(MAPA, skyvbase, 1024-1, 1280-1, BPP8);
