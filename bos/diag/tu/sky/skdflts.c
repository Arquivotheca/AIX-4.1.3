static char sccsid[] = "@(#)09	1.3  src/bos/diag/tu/sky/skdflts.c, tu_sky, bos411, 9428A410j 1/21/94 11:32:41";
/*
...
skydflts()
{
  ...
  tinfo.memory.membot = skyvbase + 0x140000;
  ...
  tinfo.dadcr.mem_accs = 0x0B;  /* 8bit, Motorola  */
  tinfo.dadcr.index    = 0x0A;  /* Base+A */

  /*  Indirect Access Display Control Registers */
  tinfo.mcsrr.memconfg = 0x9E;  /* 64bSerializer, 256x4k, 32bSerWidth */ 
  tinfo.mcsrr.autoconf = 0x01;  /* expecting a 32bit LEPB */

  tinfo.crtcdspl.horz_tot    = 0xDB;/* 10 */
  tinfo.crtcdspl.horz_end    = 0x9F;/* 12 */
  tinfo.crtcdspl.horz_ebrd   = 0x9F;/* 14 */
  tinfo.crtcdspl.horz_sbrd   = 0x9F;/* 16 */
  tinfo.crtcdspl.horz_syncs  = 0xAD;/* 18 */
  tinfo.crtcdspl.horz_synce1 = 0x96;/* 1A */
  tinfo.crtcdspl.horz_synce2 = 0x25;/* 1C */
  ...
  tinfo.crtcdspl.vert_ebrdl  = 0x1F;/* 24 */
  tinfo.crtcdspl.vert_ebrdh  = 0x04;/* 25 */
  tinfo.crtcdspl.vert_sbrdl  = 0xFF;/* 26 */
  tinfo.crtcdspl.vert_sbrdh  = 0x03;/* 27 */
  tinfo.crtcdspl.vert_syncsl = 0x01;/* 28 */
  tinfo.crtcdspl.vert_syncsh = 0x04;/* 29 */
  tinfo.crtcdspl.vert_synce  = 0x05;/* 2A */
  ...
  tinfo.misc.buffpilo = 0xA0;         
  tinfo.misc.buffpihi = 0x00;          
  tinfo.misc.dispmod1 = 0x67;           
  tinfo.misc.dispmod2 = 0x03;            
