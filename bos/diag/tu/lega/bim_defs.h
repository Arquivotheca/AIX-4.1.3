/* @(#)10       1.2  src/bos/diag/tu/lega/bim_defs.h, tu_lega, bos411, 9428A410j 11/11/91 18:15:57 */
/*
 ...
 *      OPTIONS:
 *
 * NOTES: BIM register definitions for LEGA. These are compatible with Ped.
 *
 * CHANGE ACTIVITIES:
 *
