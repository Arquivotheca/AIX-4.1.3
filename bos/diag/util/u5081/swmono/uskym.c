static char sccsid[] = "@(#)01	1.4  src/bos/diag/util/u5081/swmono/uskym.c, dsau5081, bos411, 9428A410j 3/18/94 14:25:28";
/*
...
char	*argv[];
{
	...
	int	rc=0;
	#if	DEBUG
	fdebug=fopen("/tmp/uskym.debug","a+");
	#endif
...
{
	int	tus[]={ 0xe051,0xe052,0xe006,0xe004};
