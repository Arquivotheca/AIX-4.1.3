static char sccsid[] = "@(#)70	1.2  src/bos/usr/ccs/lib/libbsd/madd.c, libbsd, bos411, 9428A410j 6/16/90 00:59:59";
/*
...
/*
 * NAME: m_add
 * FUNCTION:  add a and b and put the results in c
 */
m_add(a,b,c)
struct mint *a,*b,*c;
{	
...
/*
 * NAME: madd
 * FUNCTION:  assign to c the sum of a and b
 */
madd(a,b,c)
struct mint *a,*b,*c;
{	
...
/*
 * NAME: m_sub
 * FUNCTION: put the difference of a and b in c
 */ 
m_sub(a,b,c)
struct mint *a,*b,*c;
{	
