static char sccsid[] = "@(#)32  1.1  src/bos/usr/ccs/lib/libcurses/infotocap.c, libcurses, bos411, 9428A410j 9/3/93 15:09:14";
/*
...
static char _newvalue[TBUFSIZE];
...
dobyhand:
    sprintf(_newvalue, "!!! %s !!!%s", MSGSTR(BYHAND, "MUST CHANGE BY HAND"),
	savevalue);
    *err = 1;
    return _newvalue;
}
