static char sccsid[] = "@(#)80  1.9  src/bos/usr/ccs/lib/libcurses/compat/initkeypad.c, libcurses, bos411, 9428A410j 6/3/93 16:28:16";
/*
 ...
 */
#define MAXKEYS 128      /* number of keys we understand */
...
_init_keypad()
{
	...
	p = _addone(p, key_newline,     KEY_ENTER,      "nl");
	...
	p = _addone(p, key_back_tab,	KEY_BTAB,	"btab");
	p = _addone(p, key_end,		KEY_END,	"end");
