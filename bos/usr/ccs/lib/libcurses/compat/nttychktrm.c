static char sccsid[] = "@(#)33  1.10  src/bos/usr/ccs/lib/libcurses/compat/nttychktrm.c, libcurses, bos411, 9428A410j 4/18/94 18:10:33";
/*
...
FILE	*fd;
{
	...
	if (retcode <= 0) {
		/*
		 * This happens if /usr/share/lib/terminfo doesn't exist,  
		 * there is no such terminal type, or the file is corrupted.
