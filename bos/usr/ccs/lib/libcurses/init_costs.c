...
static char sccsid[] = "@(#)35  1.2  src/bos/usr/ccs/lib/libcurses/init_costs.c, libcurses, bos411, 9428A410j 4/15/94 16:57:27";
/*
 ...
 */
    ...
    *costptr++ = _cost_fn(tparm(row_address, 8), 1);
    ...
    if (outf)
    {
	/* icvar and dcvar were removed.  these were undefined. */
