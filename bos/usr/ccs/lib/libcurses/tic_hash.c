static char sccsid[] = "@(#)99  1.1  src/bos/usr/ccs/lib/libcurses/tic_hash.c, libcurses, bos411, 9428A410j 9/3/93 15:13:50";
/*
 *   COMPONENT_NAME: LIBCURSES
 *
 *   FUNCTIONS:  Routines to deal with the hashtable of capability names.
 *
 *   ORIGINS: 4
 *
 */
