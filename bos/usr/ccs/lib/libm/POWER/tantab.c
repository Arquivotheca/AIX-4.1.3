#if (!( _FRTINT | _SVID))
static char sccsid[] = "@(#)84	1.5  src/bos/usr/ccs/lib/libm/POWER/tantab.c, libm, bos411, 9428A410j 6/15/90 17:58:55";
#endif
/*
...
/* atan(x + T5[i][0]) = T5(i,1) * x**5 + T5(i,2)] * x**4 +
 * T5(i,3) * x**3 + T5(i,4) * x**2 + T5(i,5) * x + T5(i,6),
 * for x from [(i+16)/256-1/512,(i+16)/256+1/512] for i=1,...,250
 * or for x from [1/16,1/16+1/512] for i=0;
 * rel error <= 1.7E-18 for all i.
 */
