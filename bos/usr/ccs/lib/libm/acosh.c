static char sccsid[] = "@(#)52	1.12  src/bos/usr/ccs/lib/libm/acosh.c, libm, bos411, 9428A410j 6/16/90 02:08:21";
/*
 ...
 *                                                                    
 * ACOSH(X)
 * FUNCTION: RETURN THE INVERSE HYPERBOLIC COSINE OF X
 ...
 * shown.
 *
 * RETURNS: arc hyperbolic cosine of x in the range of [1,+INF]
 *	    Returns a QNaN if paramter is less than 1
 *  
 */
