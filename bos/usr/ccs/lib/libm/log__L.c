#if (!( _FRTINT ))
static char sccsid[] = "@(#)07	1.9  src/bos/usr/ccs/lib/libm/log__L.c, libm, bos411, 9428A410j 6/16/90 02:13:47";
#endif
/*
 ...
 * NAME: log__L
 *                                                                    
 * FUNCTION: KERNEL FUNCTION FOR LOG; TO BE USED IN LOG1P, LOG, 
 *           AND POW FUNCTIONS
