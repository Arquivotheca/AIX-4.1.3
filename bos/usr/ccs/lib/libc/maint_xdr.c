static char sccsid[] = "@(#)24	1.5  src/bos/usr/ccs/lib/libc/maint_xdr.c, libcyp, bos411, 9428A410j 6/16/90 02:43:04";
/* 
 * COMPONENT_NAME: (LIBCYP) Yellow Pages Library
 * 
 * FUNCTIONS: xdr_ypall, xdr_ypbind_setdom, xdr_ypmaplist, 
 *	      xdr_ypmaplist_wrap_string, 
 *            xdr_yppushresp_xfr, xdr_ypreq_xfr, xdr_ypresp_maplist, 
 *            xdr_ypresp_master, xdr_ypresp_order 
 *
 * ORIGINS: 24 
 *
 *                  SOURCE MATERIALS
