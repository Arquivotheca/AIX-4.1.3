static char sccsid[] = "@(#)28	1.2.1.2  src/bos/usr/ccs/lib/libc/__mbstopcs_eucjp.c, libccppc, bos411, 9428A410j 2/10/93 15:56:27";
/*
 * COMPONENT_NAME: (LIBCCPPC) LIBC Code-Point/Process-Code Conversion Functions
 *
 * FUNCTIONS: __mbstopcs_eucjp
 *
 * ORIGINS: 27
 *
...
#include <stdlib.h>
#include <ctype.h>
size_t __mbstopcs_eucjp(_LC_charmap_objhdl_t hdl, wchar_t *pwcs, size_t pwcs_len, 
