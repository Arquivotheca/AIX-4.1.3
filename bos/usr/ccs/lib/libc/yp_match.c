static char sccsid[] = "@(#)29	1.4.1.2  src/bos/usr/ccs/lib/libc/yp_match.c, libcyp, bos411, 9432B411a 7/25/94 14:25:16";
/* 
 * COMPONENT_NAME: (LIBCYP) Yellow Pages Library
 * 
 * FUNCTIONS: detachnode, freenode, makenode, v1domatch, v2domatch, yp_match 
 *
 * ORIGINS: 24 
 *
 *                  SOURCE MATERIALS
