static char sccsid[] = "@(#)41	1.2  src/bos/usr/ccs/lib/libc/ujtosj.c, libcnls, bos411, 9428A410j 6/8/91 15:59:43";
/*
...
/*									*/
/************************************************************************/
unsigned char *ujtosj(unsigned char *s1, unsigned char *s2)
{
	int c1, c2;
	unsigned char *s0 = s1;
