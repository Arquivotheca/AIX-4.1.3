#ifndef lint
static char _sccsid[] = "@(#)78	1.3  src/bos/usr/ccs/lib/libc/ns_addr.c, cmdnet, bos411, 9428A410j 5/5/91 16:00:23";
#endif
/* 
 * COMPONENT_NAME: LIBCINET ns_addr.c
 * 
 * FUNCTIONS: 
 *           
 *          
