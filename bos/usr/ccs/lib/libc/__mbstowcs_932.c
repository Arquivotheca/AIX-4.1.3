static char sccsid[] = "@(#)41	1.3.1.2  src/bos/usr/ccs/lib/libc/__mbstowcs_932.c, libccppc, bos411, 9428A410j 1/12/93 11:09:49";
/*
 * COMPONENT_NAME: (LIBCCPPC) LIBC Code-Point/Process-Code Conversion Functions
 *
 * FUNCTIONS: __mbstowcs_932
 *
 * ORIGINS: 27
 *
...
#include <stdlib.h>
#include <ctype.h>
size_t __mbstowcs_932(_LC_charmap_objhdl_t hdl, wchar_t *pwcs, const char *s, 
		      size_t n)
{
    int len = n;
    int rc;
