static char sccsid[] = "@(#)47	1.4.1.2  src/bos/usr/ccs/lib/libc/__wcstombs_932.c, libccppc, bos411, 9428A410j 1/12/93 11:11:36";
/*
 * COMPONENT_NAME: (LIBCCPPC) LIBC Code-Point/Process-Code Conversion Functions
 *
 * FUNCTIONS: __wcstombs_932
 *
 * ORIGINS: 27
 *
...
#include <stdlib.h>
#include <ctype.h>
size_t 	__wcstombs_932(_LC_charmap_objhdl_t hdl, char *s, const wchar_t *pwcs, 
		       size_t n)
{
    int cnt=0;
    int len=0;
