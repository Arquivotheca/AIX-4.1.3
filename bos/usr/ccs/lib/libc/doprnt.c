#ifndef LD_128
static char sccsid[] = "@(#)38  1.109  src/bos/usr/ccs/lib/libc/doprnt.c, libcprnt, bos41J, 9523A_all 6/2/95 11:47:54";
#endif /* LD_128 */
/*
...
int *ibuf, char *cvtbuf)
{
	...
	*sign = (unsigned int)u.i[0] >> 31;
	...
	/* The fast path code will only handle round to nearest mode
         * and when all the floating point exception traps and NI bit
         * are disabled.
	 * Other rounding modes require manipulation of the FPSCR, which
	 * becomes expensive.
	 */
	if (0 != (0xFF & VALL(saverm)))
