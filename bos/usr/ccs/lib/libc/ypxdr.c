static char sccsid[] = "@(#)36	1.5  src/bos/usr/ccs/lib/libc/ypxdr.c, libcyp, bos411, 9428A410j 6/16/90 02:44:36";
/* 
 * COMPONENT_NAME: (LIBCYP) Yellow Pages Library
 * 
 * FUNCTIONS: xdr_datum, xdr_yp_binding, xdr_yp_inaddr, xdr_ypbind_resp, 
 *            xdr_ypdomain_wrap_string, xdr_ypmap_parms, 
 *            xdr_ypmap_wrap_string, xdr_ypowner_wrap_string, xdr_ypreq_key, 
 *            xdr_ypreq_nokey, xdr_ypresp_key_val, xdr_ypresp_val 
 *
 * ORIGINS: 24 
 *
 *                  SOURCE MATERIALS
