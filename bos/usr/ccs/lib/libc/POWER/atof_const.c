static char sccsid[] = "@(#)49	1.2  src/bos/usr/ccs/lib/libc/POWER/atof_const.c, libccnv, bos411, 9428A410j 2/21/94 09:49:12";
/*
...
/*
 * power of two tables used by atof, strtod, wcstod
 *
 * if you change this structure or the table names, be sure
 * to reflect that in "atof.h" as well
 */
