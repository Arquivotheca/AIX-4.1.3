static char sccsid[] = "@(#)10  1.1  src/bos/usr/ccs/lib/libc/POWER/wcstoull.c, libccnv, bos411, 9428A410j 9/10/93 13:42:33";
/*
 ...
 * NOTES:
 *
 * The function wcstoull() converts the initial portion of the wide
...
#define FUNC wcstoull		/* strtol, strtoul, strtoll, strtoull,
