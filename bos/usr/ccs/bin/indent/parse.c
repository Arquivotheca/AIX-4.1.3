static char sccsid[] = "@(#)12  1.4  src/bos/usr/ccs/bin/indent/parse.c, cmdprog, bos411, 9428A410j 5/15/91 16:05:01";
/*
 * COMPONENT_NAME: (CMDPROG) Programming Utilites
 *
 * FUNCTIONS: parse, reduce
 *
 * ORIGINS: 26; 27
 *
    ...
    switch (tk) {               /* go on and figure out what to do with
        ...
        case elselit:           /* scanned an else */
            ...
            if (ps.p_stack[ps.tos] != ifhead)
                diag(1,MSGSTR(SOLO_ELSE, "Unmatched 'else'")); /*MSG*/
            else {
        ...
        case rbrace:            /* scanned a } */
            ...
            if (ps.p_stack[ps.tos - 1] == lbrace) {
                ...
                diag(1,MSGSTR(NESTINGERROR, "Stmt nesting error.")); /*MSG*/
            break;
        ...
        default:                /* this is an error */
            diag(1,MSGSTR(UNKNOWNCODE, "Unknown code to parser")); /*MSG*/
            return;
