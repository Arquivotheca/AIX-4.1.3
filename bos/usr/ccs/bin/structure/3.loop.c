static char sccsid[] = "@(#)80	1.2  src/bos/usr/ccs/bin/structure/3.loop.c, cmdprog, bos411, 9428A410j 6/15/90 22:55:31";
/*
 * COMPONENT_NAME: (CMDPROG) Programming Utilites
 *
 * FUNCTIONS: cntarcs, fixhd, fixloop, getloop, getswitch, getun, getwh
 *
 * ORIGINS: 26; 27
 *
