static char sccsid[] = "@(#)88	1.2  src/bos/usr/ccs/bin/structure/4.out.c, cmdprog, bos411, 9428A410j 6/15/90 22:56:02";
/*
 * COMPONENT_NAME: (CMDPROG) Programming Utilites
 *
 * FUNCTIONS: newlevel, outrat, prcom, prlab, prpred, prstln
 *
 * ORIGINS: 26; 27
 *
