static char sccsid[] = "@(#)98	1.4  src/bos/usr/ccs/bin/beautify/tree.c, cmdprog, bos411, 9428A410j 3/9/94 12:49:33";
/*
 * COMPONENT_NAME: (CMDPROG) Programming Utilites
 *
 * FUNCTIONS: addroot, asoc, checkneg, freenode, freetree, gettree, insib,
	      prec, prtr, prtree, puttree, yield
 *
 * ORIGINS: 26 27
 *
...
int length;
	...
	fprintf(stderr,MSGSTR(STRG2LONG, "string %s too long to be copied by str_copy at address %d\n"), /*MSG*/
			*s,ptr);
	exit(1);
	}
str_eq(s,t)
