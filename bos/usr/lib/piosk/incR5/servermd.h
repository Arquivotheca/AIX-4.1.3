/* @(#)23       1.1  src/bos/usr/lib/piosk/incR5/servermd.h, cmdpiosk, bos411, 9428A410j 7/31/92 23:38:25 */
/*
 * COMPONENT_NAME: XSERVER
 *
 * FUNCTIONS:
 *
 * ORIGINS: 27, 16, 40
 *
 * (C) COPYRIGHT International Business Machines Corp. 1987, 1989, 1992
 * All Rights Reserved
