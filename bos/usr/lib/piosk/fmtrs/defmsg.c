/* @(#)45  1.4  src/bos/usr/lib/piosk/fmtrs/defmsg.c, cmdpiosk, bos411, 9428A410j 3/22/94 04:22:59 */
...
#define MSG_BADNLSDIR    152
#define MSG_BADTOORNLS   153
#define MSG_BADFORMATF   154
#define MSG_BADFORMATP   155
#define MSG_BADTRASFILE  156
#endif 
...
{ MSG_BADNLSDIR ,
"0782-719 Cannot open file %s.\n" },

{ MSG_BADTOORNLS ,
"0782-720 Cannot specify which font to use, printer or X font.\n\
\t Check the discription of parameter To in colon file.\n\
\t Check the data base file %s.\n" },

{ MSG_BADFORMATF ,
"0782-721 Data base file %s for printer has incompatible format.\n"},

{ MSG_BADFORMATP ,
"0782-722 The discription of parameter %s in colon file is not valid.\n"},

{ MSG_BADTRASFILE ,
"0782-723 Cannot open translation file %s.\n\
\t Check the file or /usr/lib/lpd/pio/transJP/trans.dir.\n"},
...
char *stringval;
{
	...
	if( md == -1 ){	/* message catalog file must not changed in a process */
		md = catopen( PIOMSGCAT, NL_CAT_LOCALE );
	}
