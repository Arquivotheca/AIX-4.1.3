/* @(#)76	1.3 8/12/91 23:34:00 */

/*
 * COMPONEMT_NAME: (CMDPIOSK) Printer Backend for Japanese Printers
 *
 * ORIGINS: 27
 *
...
/* Path Name of Next Alternate Translate Stage 2 Translate Table */
#define TABLE_2        "t2"
...
/* Set SBCS Data Stream Mode */
#define SET_SBCS_CMD   "ez"
...
"_W"   , VAR_INT        , lkup_bool      , (union dtypes *) &_Cont_dblwide   ,
...
#undef OPTSTRING
#endif
#define OPTSTRING  "b:e:g:i:j:l:p:q:t:v:w:x:y:E:J:K:L:W:X:Z:"
