...
/* Paper Source Drawer (0xfd:No change 1: Upper  2: Lower 0xfe: Panel setting 0xff: Default Drawer ) */
...
/* Font Path Name */
#define Font_path (*(_Font_path + piomode))  /* variable name */
struct str_info *_Font_path;   /* pointer to the variable */
...
/* Machine type */
#define Mach_type (*(_Mach_type + piomode))  /* variable name */
int *_Mach_type;   /* pointer to the variable */
...
/*  */
#define Escarglen (*(_Escarglen + piomode))  /* variable name */
int *_Escarglen;   /* pointer to the variable */
...
#define	MEDIA_SIZE_CMD	"Ea"
#define	DRAW_BOX2_CMD	"Eb"
#define	DRAW_BOX3_CMD	"Ec"
#define	REL_LINE_CMD	"Ed"
#define	MEDIA_AXIS_CMD	"Ee"
#define	PAGE_FMT_CMD	"Ef"
#define	PAGE_DSCRPT_CMD	"Eg"
#define	LOGICAL_ZERO_CMD	"Eh"
#define	COMPOSE_C_CMD	"Ei"
#define	MESH_CMD	"Ej"
#define	MESH_REF_CMD	"Ek"
#define	MESH_CLR_CMD	"El"
#define	MESH_REC_CMD	"Em"
#define	GRPH_CNTL_CMD	"En"
#define	GRPH_DRAW_CMD	"Eo"
...
"mt"   , VAR_INT        , mach_type      , (union dtypes *) &_Mach_type      ,
...
"w0"   , VAR_INT        , NULL           , (union dtypes *) &_Escarglen,
"Ti"   , VAR_STR	, NULL           , (union dtypes *) &_Trans_in       ,
"To"   , VAR_STR	, NULL           , (union dtypes *) &_Trans_out      ,
NULL   , 0              , NULL           , NULL
