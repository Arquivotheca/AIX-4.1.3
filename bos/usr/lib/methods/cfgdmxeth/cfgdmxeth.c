static char sccsid[] = "@(#)25  1.1  src/bos/usr/lib/methods/cfgdmxeth/cfgdmxeth.c, sysxent, bos411, 9428A410j 9/20/93 17:26:21";
/*
 * COMPONENT_NAME: (sysxent) cfgdmxeth.c - Ethernet Demuxer Method
 *
 * FUNCTIONS: main
 *
 * ORIGINS: 27
...
#include "cfgdmxeth.h"          /* Ethernet specific information */
