/* @(#)83	1.1  src/bos/usr/lib/piostw/fmtrsTW/defmsg.c, cmdpiostw, bos411, 9428A410j 7/31/92 21:13:33 */

/*
 * COMPONEMT_NAME: (CMDPIOSTW) Printer Backend for Traditional Chinese Printers
 *
 * ORIGINS: 27
 *
