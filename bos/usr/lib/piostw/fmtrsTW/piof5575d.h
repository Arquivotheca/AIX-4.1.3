/* @(#)04	1.2  src/bos/usr/lib/piostw/fmtrsTW/piof5575d.h, cmdpiostw, bos411, 9428A410j 7/31/92 23:44:23 */

/*
 * COMPONEMT_NAME: (CMDPIOSK) Printer Backend for Traditional Chinese Printers
*
 * ORIGINS: 27
 *
...
#undef OPTSTRING
#endif
#define OPTSTRING  "b:e:g:i:j:l:p:s:t:v:w:x:y:E:F:J:K:L:S:U:V:W:Z:"
