static char sccsid[] = "@(#)06  1.3  src/bos/usr/lib/piostw/fmtrsTW/piof5xxxdcht.c, cmdpiostw, bos411, 9428A410j 10/6/92 12:04:28";
/******************************************************************************
*								              *
* COMPONEMT_NAME: CMDPIOSTW						      *
*									      *
* Print Formatter For 			                                      *
...
#  if defined( X11R5BOS )
	...
	if( strcmp( Codepagename.ptr, "ISO8859-1" ) == 0 ){
		strcpy( Codepagename.ptr, "IBM-eucTW" );
	}
