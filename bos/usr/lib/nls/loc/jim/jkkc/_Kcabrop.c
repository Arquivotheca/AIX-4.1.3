static char sccsid[] = "@(#)97	1.2 src/bos/usr/lib/nls/loc/jim/jkkc/_Kcabrop.c, libKJI, bos411, 9428A410j 6/4/91 10:05:57";
/*
 ...
 *
 * MODULE NAME:       _Kcabrop
 *
 * DESCRIPTIVE NAME:  OPEN AND FORWARD FOR ALL CANDIDATES OF ALPHANUMERIC
 *
 * FUNCTION:
 *
 * INPUT:
