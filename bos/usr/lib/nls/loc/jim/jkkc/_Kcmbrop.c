static char sccsid[] = "@(#)46	1.2 src/bos/usr/lib/nls/loc/jim/jkkc/_Kcmbrop.c, libKJI, bos411, 9428A410j 6/4/91 15:13:52";
/*
 ...
 *      START OF FUNCTION                                                 
 ************************************************************************/ 
short   _Kcmbrop( z_kcbptr )
struct  KCB     *z_kcbptr;              /* pointer of KCB              */
{
/*----------------------------------------------------------------------*  
 *      EXTERNAL REFERENCE
 *----------------------------------------------------------------------*/ 
   extern short           _Kcmncv1();   /* Making Next Conv Env. for A/N*/
