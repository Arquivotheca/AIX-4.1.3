static char sccsid[] = "@(#)89	1.2 src/bos/usr/lib/nls/loc/jim/jkkc/_Kc0dici.c, libKJI, bos411, 9428A410j 6/4/91 10:03:40";
/*
 ...
 *
 * MODULE NAME:       _Kc0dici
 *
 * DESCRIPTIVE NAME:  INQUIRE OF WORD ENTRY FOR USER DICTIONARY
 *
 * FUNCTION:
 *
 * INPUT:
 ...
 *----------------------------------------------------------------------*/ 
   ...
   z_rldcta = _Kcldcta(kcbptr1, (short)U_MODINQ);
                                        /* Call function                */
   return( z_rldcta );
}
