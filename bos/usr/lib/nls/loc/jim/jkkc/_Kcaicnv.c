static char sccsid[] = "@(#)00	1.2 src/bos/usr/lib/nls/loc/jim/jkkc/_Kcaicnv.c, libKJI, bos411, 9428A410j 6/4/91 10:06:35";
/*
 ...
 *                    0x0004 (NO_CAND): no candidate exists
 *                    0x0108 (WSPOVER): internal work buffer overflow
 *                    0x1104 (JTEOVER): JTE buffer overflow
 *                    0x1204 (JKJOVER): JKJ buffer overflow
 *                    0x1304 (JLEOVER): JLE buffer overflow
 *                    0x1404 (BTEOVER): BTE buffer overflow
 *                    0x1704 (FTEOVER): FTE buffer overflow
 *                    0x1804 (PTEOVER): PTE buffer overflow
 ...
 *----------------------------------------------------------------------*/ 
   ...
   extern short           _Kcamktb();   /* Making Cand. Table for A/N   */
 ...
 *----------------------------------------------------------------------*/ 
   short           z_ramktb;    /* Define Area for Return of _Kcamktb   */
 ...
 *----------------------------------------------------------------------*/ 
   z_rrsout = _Kcrsout(z_kcbptr,bteptr1,seiptr1,semptr1,grmptr1,ymmptr1);
   if ( z_rrsout != SUCCESS )
      return(z_rrsout);
