static char sccsid[] = "@(#)51	1.2 src/bos/usr/lib/nls/loc/jim/jkkc/_Kcmncnv.c, libKJI, bos411, 9428A410j 6/4/91 15:15:00";
/*
 ...
 *
 * MODULE NAME:       _Kcmncnv
 *
 * DESCRIPTIVE NAME:  TRY TO NEXT CONVERT
 *
 * INPUT:
 *
 * OUTPUT:
 ...
 *      START OF FUNCTION                                                 
 ************************************************************************/ 
short   _Kcmncnv( z_kcbptr )
struct  KCB     *z_kcbptr;              /* pointer of KCB              */
{
/*----------------------------------------------------------------------*  
 *      EXTERNAL REFERENCE
 *----------------------------------------------------------------------*/ 
   extern short           _Kcmncv1();   /* Make Next Cnv tb. for Kansuji*/
 ...
 *----------------------------------------------------------------------*/ 
   short           z_rmncv1;    /* Define Area for Return of _Kcancv1   */
 ...
 *----------------------------------------------------------------------*/
   z_roncv2 = _Kconcv2( kcbptr1, (short)NEXTCNV );
