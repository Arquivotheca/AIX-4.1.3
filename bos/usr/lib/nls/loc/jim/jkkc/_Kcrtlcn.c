static char sccsid[] = "@(#)87	1.2 src/bos/usr/lib/nls/loc/jim/jkkc/_Kcrtlcn.c, libKJI, bos411, 9428A410j 6/4/91 15:23:02";
/*
 ...
 *
 * MODULE NAME:       _Kcrtlcn
 *
 * DESCRIPTIVE NAME:  OUTPUT THE LAST  CANDIDET TO THE OUTPUT AREA
 *
 * INPUT:
 *
 * OUTPUT:
