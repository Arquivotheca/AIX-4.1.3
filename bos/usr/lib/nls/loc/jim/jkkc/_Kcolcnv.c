static char sccsid[] = "@(#)66	1.2 src/bos/usr/lib/nls/loc/jim/jkkc/_Kcolcnv.c, libKJI, bos411, 9428A410j 6/4/91 15:18:27";
/*
 ...
 *
 * MODULE NAME:       _Kcolcnv
 *
 * DESCRIPTIVE NAME:  SELSECT LAST CANDIDATE
 *
 * INPUT:
 *
 * OUTPUT:
 ...
 *      SELECT CANDIDATES
 *----------------------------------------------------------------------*/
   z_rtcode = _Kconcv2( z_kcbptr, (short)LASTCNV );
