static char sccsid[] = "@(#)53	1.2.1.1  src/bos/usr/lib/nls/loc/jim/jkkc/_Kcdctrg.c, libKJI, bos411, 9428A410j 7/23/92 03:01:20";
/*
...
#include   "dict.h"                   	/* Define Constant file         */

/************************************************************************
 *      START OF FUNCTION
 ************************************************************************/
short _Kcdctrg( z_mcbptr )
 ...
 *----------------------------------------------------------------------*/
   kcb.func     = FUNDCTAD;             /* registration of word entry   */
 ...
 *      SET STATUS ON 
 *----------------------------------------------------------------------*/
      z_rt = _Kcxstat( z_mcbptr, Z_SET_ON );
...
/*----------------------------------------------------------------------* 
 *      WRITE INDEX & DATA IN USER DICTIONARY 
 *----------------------------------------------------------------------*/
      z_rt = _Kcxusrd( z_mcbptr, Z_WRITE , (z_buf.st_size-MDESIZE));
 ...
 *      SET STATUS OFF 
 *----------------------------------------------------------------------*/
      z_rt = _Kcxstat( z_mcbptr, Z_SET_OFF );
 ...
 *----------------------------------------------------------------------*/
   ...
   udictp->dumtime = mcb.dumtime = z_buf.st_mtime;
   udictp->ductime = mcb.ductime = z_buf.st_ctime;
