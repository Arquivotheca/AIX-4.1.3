/* @(#)66	1.2  src/bos/usr/lib/nls/loc/jim/jmnt/kcb.h, libKJI, bos411, 9428A410j 6/6/91 14:29:43 */
 ...
 * MODULE NAME:         kcb.h
 *
 * DESCRIPTIVE NAME:    Kanji Monitor Control Block Structure.
 *
...
#include "kmdef.h"      /* Kanji Monitor Control Structure Define.        */
#include "kmisa.h"      /* Kanji Monitor Internal Save Area Structure.    */
#include "trb.h"        /* Trace Control Block Structure.                 */
...
uchar  *string; /* Pointer to whole input string.                         */
                /* It points to an active input field.                    */
                /* DBCS Editor Sets this.                                 */

uchar  *hlatst; /* Pointer to whole input string highlighting             */
                /* attribute.                                             */
                /* Kanji monitor sets this.                               */

uchar  *aux1;   /* Pointer to auxiliary area No.1.                        */
                /* Kanji monitor sets this.                               */

uchar  *hlata1; /* **** RESERVED FOR FUTURE USE ****                      */
                /* Pointer to auxiliary area No.1 Highlighting            */
                /* attribute.                                             */
                /* Kanji monitor sets this.                               */

uchar  *aux2;   /* **** RESERVED FOR FUTURE USE ****                      */
                /* Pointer to auxiliary area No.2.                        */
                /* Kanji monitor sets this.                               */

uchar  *hlata2; /* **** RESERVED FOR FUTURE USE ****                      */
                /* Pointer to auxiliary area No.2 Highlighting            */
                /* attribute.                                             */
                /* Kanji monitor sets this.                               */

uchar  *aux3;   /* **** RESERVED FOR FUTURE USE ****                      */
                /* Pointer to auxiliary area No.3.                        */
                /* Kanji monitor sets this.                               */

uchar  *hlata3; /* **** RESERVED FOR FUTURE USE ****                      */
                /* Pointer to auxiliary area No.3 Highlighting            */
                /* attribute.                                             */
                /* Kanji monitor sets this.                               */

uchar  *aux4;   /* **** RESERVED FOR FUTURE USE ****                      */
                /* Pointer to auxiliary area No.4.                        */
                /* Kanji monitor sets this.                               */

uchar  *hlata4; /* **** RESERVED FOR FUTURE USE ****                      */
                /* Pointer to auxiliary area No.4 Highlighting            */
                /* attribute.                                             */
                /* Kanji monitor sets this.                               */

uchar  *auxdir; /* Pointer to auiliary area.                              */
                /* Kanji monitor sets this.                               */
...
short  csid;    /* Character set id.                                      */
                ...
                /* 301 for Kanji. After then DBCS Monitor always          */
...
short  curcol;  /* Cursor position (offset) in the input line in byte.    */
                ...
                /* (0, 2, 4 ...). DBCS Editor sets the initial            */
...
char   kbdlok;  /* Keyboard Lock Flag.                                    */
                /* =0 ... Keyboard Lock On.                               */
                /* =1 ... Keyboard Not Lock.                              */

char   rsv1[3]; /* **** RESERVED FOR FUTURE USE                           */
