static char sccsid[] = "@(#)48	1.1  src/bos/usr/lib/nls/loc/locale/zh_CN/__mbtowc_euccn.c, ils-zh_CN, bos41B, 9504A 12/20/94 10:25:34";
/*
 *   COMPONENT_NAME: ils-zh_CN
 *
 *   FUNCTIONS: __mbtowc_euccn
 *
 *   ORIGINS: 27
 *
...
#include "eucCN_ucs.h"
 ...
 extern unsigned short  udc_index[UDC_TRAILER+1]=
 {
   0xa2a1,
   0xa2a2,
   0xa2a3,
 ...
 extern unsigned short nonhanzi1[94]=      
 {
   0x3000,	/* Chinese space */
   0x3001,
   0x3002,
   0x30FB,      /* */
   0x02D7,
   ...
   0x221A,
   0x22A5,
   0x9FA6,	/* Not included in Unicode */
   0x2220,
   0x25E0,	/* Changed by Wolf Lee */
   0x2299,
   0x222B,
   0x222E,
   0x2261,
 ...
 extern unsigned short nonhanzi2[50]= 
   {
   0x2488,
   0x2489,
   0x248A,
 ...
 extern unsigned short nonhanzi3[10]=
   {
   0x3220,
   0x3221,
   0x3222,
  ...
  extern unsigned short nonhanzi4[12]=
   {
   0x2160,
   0x2161,
   0x2162,
   ...
   extern unsigned short nonhanzi5[177]=
    {
   0xFF01,
   0xFF02,
   0xFF03,
   ...
   extern unsigned short nonhanzi6[86]=
    { 
   0x30A1,
   0x30A2,
   0x30A3,
  ...
  extern unsigned short nonhanzi7[]=
    {
   0x0391,
   0x0392,
   0x0393,
  ...
  extern unsigned short nonhanzi8[24]=
    {
   0x03B1,
   0x03B2,
   0x03B3,
 ...
 extern unsigned short nonhanzi9[33]=
    {
   0x0410,
   0x0411,
   0x0412,
 ...
 extern unsigned short nonhanzi10[33]=
    {
   0x0430,
   0x0431,
   0x0432,
 ...
 extern unsigned short nonhanzi11[26]=
    {
   0x0101,
   0x00E1,
   0x0103,
   ...
   0x00F9,
   0x01D6,
   0x01D8,	/* Not included in Unicode */
   0x01DA,
   0x01DC,
   0x00FC,
   0x00EA
/* 0x0251,
   ...
   0x0144,
   0x0148,
   0x9FAC,	 Not included in Unicode 
   0x0261 */
      };
    
 extern unsigned short nonhanzi12[37]=
    {
   0x3105,
   0x3106,
   0x3107,
 ...
 extern unsigned short nonhanzi13[76]=
    {
   0x2500,
   0x2501,
   0x2502,
   ...
   extern unsigned short hanzi1[3755]=
    {
   0x554A,
   0x963F,
   0x57C3,
 ...
 extern unsigned short hanzi2[3008]=
    {
   0x4E8D,
   0x4E0C,
   0x5140,
...
int __mbtowc_euccn(_LC_charmap_objhdl_t handle, wchar_t *pwc, const char *s, size_t maxlen)
 {
	wchar_t dummy;
	unsigned short indx;
	 ...
	 ***********/
 	 ...
 	 ************/
		  ...
		  else if((unsigned char)s[0] >= 0xaa && (unsigned char)s[0] <= 0xaf && (unsigned char)s[1] >= 0xa1 && (unsigned char)s[1] <= 0xfe) {
...
unsigned char)s[1] - 0xa1));
                  ...
                  else if((unsigned char)s[0] == 0xd7 && (unsigned char)s[1] >= 0xfa && (unsigned char)s[1] <= 0xfe) {
