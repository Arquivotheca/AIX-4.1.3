static char sccsid[] = "@(#)32	1.1  src/bos/usr/lib/nls/loc/locale/ZH_CN/__mbstowcs_utf8cn.c, ils-zh_CN, bos41B, 9504A 12/20/94 10:24:27";
/*
 *   COMPONENT_NAME: ils-zh_CN
 *
 *   FUNCTIONS: __mbstowcs_utf8cn
 *
 *   ORIGINS: 27
 *
...
size_t 
__mbstowcs_utf8cn(_LC_charmap_objhdl_t handle, wchar_t *pwcs, const char *s, size_t n)
{
    int len = n;
    int rc;
    int cnt;
    ...
    **********/
    ...
    while (len-- > 0) {
        ...
        **********/
        ...
        if ((cnt = __mbtowc_utf8cn(handle, pwcs, s, MB_CUR_MAX)) < 0) 
  	      return(-1);
        s += cnt;
        ++pwcs;
    }
