static char sccsid[] = "@(#)42	1.1  src/bos/usr/lib/nls/loc/iconv/PRC.LocalSolution/UTF-8_IBM-836.c, ils-zh_CN, bos41J, 9509A_all 2/19/95 23:32:24";
/*
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
        ...
        while (in < e_in) {
	   if (in[0] == 0xc2&&(in[1] == 0xaf||in[1] == 0xa3 ||in[1]==0xac||in[1]==0xa5)){
		if(in[1] == 0xaf)
		    out[0] = 0xa1;
		else if(in[1] == 0xa3)
		    out[0] = 0x4a;
