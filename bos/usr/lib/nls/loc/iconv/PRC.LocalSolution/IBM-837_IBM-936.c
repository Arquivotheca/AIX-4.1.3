static char sccsid[] = "@(#)32	1.1  src/bos/usr/lib/nls/loc/iconv/PRC.LocalSolution/IBM-837_IBM-936.c, ils-zh_CN, bos41J, 9509A_all 2/19/95 23:32:04";
/*
...
unsigned short hosttopc[TRAILER][2]=
{
    {0x4040, 0x8140},
    {0x4141, 0x83BF},
    {0x4142, 0x83C0},
 ...
 */
	    ...
	    while((*host2in != hosttopc[middle][0])&&(start <= end)){
	        if((*host2in) > hosttopc[middle][0])
	 	    start = middle + 1;
		else
		if((*host2in) < hosttopc[middle][0])
		    end = middle - 1;
