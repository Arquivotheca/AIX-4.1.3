static char sccsid[] = "@(#)35	1.1  src/bos/usr/lib/nls/loc/iconv/PRC.LocalSolution/IBM-837_UTF-8.c, ils-zh_CN, bos41J, 9509A_all 2/19/95 23:32:10";
/*
				...
				unsigned char** outbuf, size_t *outbytesleft)
{
	...
	while (in < e_in) {
	    ...
	    /* 
	      First use bisect algorithm to locate, and then call wctomb() to convert
              ucs code to utf
            */
