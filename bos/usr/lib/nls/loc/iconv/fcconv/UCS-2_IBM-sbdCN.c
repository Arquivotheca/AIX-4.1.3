static char sccsid[] = "@(#)88	1.1  src/bos/usr/lib/nls/loc/iconv/fcconv/UCS-2_IBM-sbdCN.c, ils-zh_CN, bos41B, 9504A 12/19/94 14:49:38";
/*
...
/*                                                                         */
/* MODULE NAME:        UCS-2_IBM-sbdCN                                     */
/*                                                                         */
/* DESCRIPTIVE NAME:   Convert Data Encoding in UCS-2 to IBM-sbdCN         */
/*                                                                         */
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
	...
	outtmp = &outbuf1;
	    ...
	    *((unsigned char*)ucs2in + 1) = in[1];
	    ...
	    while((*ucs2in!=ucstosbdcn[middle][0])&&(start<= end)){
	        if(*ucs2in > ucstosbdcn[middle][0])
	            start = middle + 1;
		else
		if(*ucs2in < ucstosbdcn[middle][0])
		    end = middle-1;
