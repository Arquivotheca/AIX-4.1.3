static char sccsid[] = "@(#)77	1.1  src/bos/usr/lib/nls/loc/iconv/fcconv/IBM-eucCN_CNS11643.1986-2.c, ils-zh_CN, bos41B, 9504A 12/19/94 14:49:17";
/*
...
/*                                                                         */
/* MODULE NAME:        IBM-eucCN_CNS11643.1986-2                           */
/*                                                                         */
/* DESCRIPTIVE NAME:                                                       */
/*                                                                         */
 ...
 ***************************/
 ...
 /*****************************************
  Process Various Errors That May Encounter
  *****************************************/
 ...
 /******************************************************* 
  Obtain One Input Hanzi or Graphic Word in EUC CS1 of CN 
  *******************************************************/
         *((unsigned char *)euc2in) = in[0];
         *((unsigned char *)euc2in +1) = in[1];
			
 /************************
  Convert to Hanzi in CNS2
  ************************/
	    ...
	    while((*euc2in != euccntocns2[middle][0]) && (start <= end)){
	   	if(*euc2in > euccntocns2[middle][0]){
		    start = middle + 1;
		} 
		else
		if(*euc2in < euccntocns2[middle][0]){
	    ...
	    if(*euc2in != euccntocns2[middle][0]){
	        *(unsigned short*)outtmp = DEFAULTCNS2;
	    }

	    if(*euc2in == euccntocns2[middle][0]){
	        *(unsigned short*)outtmp = euccntocns2[middle][1];
	    }
        }else {
             errno = EILSEQ;
             ret_value = -1;
...
/* DESCRIPTION : Free Memory Allocated for IBM-eucCN_CNS11643.1986-2      */
...
/* DESCRIPTION : Initialize IBM-eucCN_CNS11643.1986-2 Converter-Specific  */
/*               Descriptor                                               */
/* EXTERNAL REFERENCES:                                                   */
