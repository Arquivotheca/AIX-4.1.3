static char sccsid[] = "@(#)12  1.1  src/bos/usr/lib/nls/loc/iconv/fold/IBM-932_fold8.c, cmdiconv, bos411, 9428A410j 4/7/94 01:51:31";
/*
...
static	_LC_fold_iconv_t	*init (
	...
	if (cd->defgl == cd->defgr) cd->defgr = &_invalid_cd;
	cd->gl    = cd->defgl;
	cd->gr    = cd->defgr;
	cd->curcd = cd->gl;
