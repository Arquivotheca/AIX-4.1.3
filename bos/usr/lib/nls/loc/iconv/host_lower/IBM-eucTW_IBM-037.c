static char sccsid[] = "@(#)13  1.4  src/bos/usr/lib/nls/loc/iconv/host_lower/IBM-eucTW_IBM-037.c, cmdiconv, bos411, 9428A410j 4/4/94 02:58:28";
/*
...
static	_LC_host_lower_iconv_t	*init (
	...
	if ((cd = (_LC_host_lower_iconv_t*)malloc (
