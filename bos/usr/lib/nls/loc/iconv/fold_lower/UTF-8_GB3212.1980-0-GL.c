static char sccsid[] = "@(#)48	1.1  src/bos/usr/lib/nls/loc/iconv/fold_lower/UTF-8_GB3212.1980-0-GL.c, ils-zh_CN, bos41B, 9504A 12/19/94 15:17:08";
/*
...
/*                                                                         */
/* DESCRIPTIVE NAME:   Convert Data Encoding in UTF to gb2312.1980-0       */
/*                                                                         */
...
*/
	    ...
	    /* Call mbtowc() to convert utf code to ucs*/
/*
...
*/
	...
	else if(wcsid(*ucs2in) == 4 || wcsid(*ucs2in) == 5){
		*outtmp = DEFAULTUCS;
	}else{
                errno = EILSEQ;
	        ret_value = -1;
