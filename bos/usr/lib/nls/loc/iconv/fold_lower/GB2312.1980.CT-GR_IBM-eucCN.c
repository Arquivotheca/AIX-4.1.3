static char sccsid[] = "@(#)29	1.1  src/bos/usr/lib/nls/loc/iconv/fold_lower/GB2312.1980.CT-GR_IBM-eucCN.c, ils-zh_CN, bos41B, 9504A 12/19/94 15:16:34";
/*
...
/*                                                                         */
/* MODULE NAME:        GB2312.1980.CT-GR_IBM-eucCN.c                       */
/*                                                                         */
/* DESCRIPTIVE NAME:   Used for X Consoutrium                              */
/*                                                                         */
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
		...
		if(in[0] == 0x00 || in[0] == 0x0a) {
		    ...
		    continue;
                ...
                if (e_in - in < 2) {
                        if (e_in - in == 1) {
                                if ((in[0] < 0x21 || 0x7e < in[0]) && (in[0] < 0x21 || 0x7e < in[0]))
				{
...
/* DESCRIPTION : Free Memory Allocated for GB2312.1980.CT-GR_IBM-eucCN    */
...
/* DESCRIPTION : Initialize GB2312.1980.CT-GR_IBM-eucCN Converter-Specific*/
/*               Descriptor                                               */
/* EXTERNAL REFERENCES:                                                   */
