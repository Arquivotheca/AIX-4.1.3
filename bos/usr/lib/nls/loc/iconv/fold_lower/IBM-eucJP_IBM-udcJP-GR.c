static char sccsid[] = "@(#)43  1.6  src/bos/usr/lib/nls/loc/iconv/fold_lower/IBM-eucJP_IBM-udcJP-GR.c, cmdiconv, bos411, 9428A410j 8/26/93 01:05:22";
/*
	...
	while (in < e_in) {
		if (in[0] == EUCSS3) {
			...
			if (in[1] < 0xf3) {
				...
				out[0] = code >> 8 & 0x7f | 0x80;
				out[1] = code & 0x7f | 0x80;
			}
 ...
 *
 *   RETURNS:	Pointer to a descriptor, of -1 if error.
 */
