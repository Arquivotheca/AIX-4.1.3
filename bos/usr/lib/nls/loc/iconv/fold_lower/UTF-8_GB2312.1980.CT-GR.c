static char sccsid[] = "@(#)47	1.1  src/bos/usr/lib/nls/loc/iconv/fold_lower/UTF-8_GB2312.1980.CT-GR.c, ils-zh_CN, bos41B, 9504A 12/19/94 15:17:06";
/*
...
/*
 Output to the output buffer, and adjust input/output buffer pointer
*/
