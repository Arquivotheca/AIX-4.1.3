static char sccsid[] = "@(#)32	1.1  src/bos/usr/lib/nls/loc/iconv/fold_lower/IBM-eucCN_GB2312.1980-0-GL.c, ils-zh_CN, bos41B, 9504A 12/19/94 15:16:39";
/*
...
/*                                                                         */
/* MODULE NAME:        IBM-eucCN_GB2312.1980-0-GL                          */
/*                                                                         */
/* DESCRIPTIVE NAME:                                                       */
/*                                                                         */
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
  ...
  *******************************/
                ...
                if (*in < 0xa1 || *(in + 1) < 0xa1 || *in > 0xfe || *(in+1) > 0xfe) {
                        errno = EILSEQ;
			ret_value = -1;
                        break;
                }
...
/* DESCRIPTION : Free Memory Allocated for IBM-eucCN_GB2312.1980-0-GL     */
...
/* DESCRIPTION : Initialize IBM-eucCN_GB2312.1980-0-GL Converter-Specific */
/*               Descriptor                                               */
/* EXTERNAL REFERENCES:                                                   */
