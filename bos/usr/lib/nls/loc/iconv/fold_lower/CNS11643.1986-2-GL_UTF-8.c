static char sccsid[] = "@(#)13	1.1  src/bos/usr/lib/nls/loc/iconv/fold_lower/CNS11643.1986-2-GL_UTF-8.c, ils-zh_CN, bos41B, 9504A 12/19/94 15:16:08";
/*
...
/*                                                                         */
/* MODULE NAME:        CNS11643.1986-2_utf8.c                              */
/*                                                                         */
/* DESCRIPTIVE NAME:   Convert Data Encoding in UTF to CNS11643.1986-2     */
/*                                                                         */
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
	...
	(void)setlocale(LC_ALL, "zh_CN.utf-8" );
	    ...
	    *((unsigned char *)cns2in + 1) = in[1];
	    ...
	    middle= (begin + end) / 2;
	    while(*cns2in != cns2toucs[middle][0] && begin <= end){
		if(*cns2in > cns2toucs[middle][0])
		    begin = middle + 1;
		if(*cns2in < cns2toucs[middle][0])
		    end   = middle - 1;
	        middle = (begin + end ) / 2;
...
/* DESCRIPTION : Free Memory Allocated for CNS11643.1986-2_utf8           */
...
/* DESCRIPTION : Initialize CNS11643.1986-2_utf8  Converter-Specific      */
/*               Descriptor                                               */
/* EXTERNAL REFERENCES:                                                   */
