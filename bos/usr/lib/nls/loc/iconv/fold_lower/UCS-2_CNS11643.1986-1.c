static char sccsid[] = "@(#)35	1.1  src/bos/usr/lib/nls/loc/iconv/fold_lower/UCS-2_CNS11643.1986-1.c, ils-zh_CN, bos41B, 9504A 12/19/94 15:16:46";
/*
...
/*                                                                         */
/* MODULE NAME:        utf8_GB2312.1980-0.c                                */
/*                                                                         */
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
	...
	int  inlen, start, middle, end;
		...
		if (!inbuf) return 0;
        	...
        	e_in = (in = *inbuf) + *inbytesleft;   /* Assign begin/end address of input buffer to in/e_in pointer */
        	e_out = (out = *outbuf) + *outbytesleft; /* Assign begin/end address of output buffer to in/e_in pointer */
        	ret_value = 0;
		ucs2in = &ucs2;
		outtmp = &outbuf1;
