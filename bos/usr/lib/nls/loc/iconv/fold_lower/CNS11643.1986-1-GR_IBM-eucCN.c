static char sccsid[] = "@(#)09	1.2  src/bos/usr/lib/nls/loc/iconv/fold_lower/CNS11643.1986-1-GR_IBM-eucCN.c, ils-zh_CN, bos41J, 9514A_all 3/28/95 14:46:59";
/*
...
/*                                                                         */
/* MODULE NAME:        CNS11643.1986-1-GR_IBM-eucCN.c                      */
/*                                                                         */
/* DESCRIPTIVE NAME:                                                       */
/*                                                                         */
 ...
 ***************************/
 ...
 /******************* 
  Convert Hanzi Words
  *******************/
			if((*euc2in >= 0xc4a1) && (*euc2in <= 0xfefe)) {
			    start = HEADER1;
			    end = TRAILER1; 
			    middle = (end + start)/2; 
...
/* DESCRIPTION : Free Memory Allocated for CNS11643.1986-1-GR_IBM-eucCN   */
...
/* DESCRIPTION : Initialize CNS11643.1986-1-GR_IBM-eucCN Converter-       */
/*               Specific Descriptor                                      */
/* EXTERNAL REFERENCES:                                                   */
