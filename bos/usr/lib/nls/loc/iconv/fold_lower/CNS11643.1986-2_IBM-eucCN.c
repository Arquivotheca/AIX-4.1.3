static char sccsid[] = "@(#)16	1.2  src/bos/usr/lib/nls/loc/iconv/fold_lower/CNS11643.1986-2_IBM-eucCN.c, ils-zh_CN, bos41J, 9514A_all 3/28/95 14:47:05";
/*
...
/*                                                                         */
/* MODULE NAME:        CNS11643.1986-2_IBM-eucCN.c                         */
/*                                                                         */
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
  ...
  ***************************/
			if((*euc2in >= 0x2121) && (*euc2in <= 0x7e7e)) {
			    start  = HEADER;
			    end    = TRAILER; 
			    middle = (end + start) / 2; 
 /********************
...
/* DESCRIPTION : Free Memory Allocated for CNS11643.1986-2_IBM-eucCN      */
...
/* DESCRIPTION : Initialize CNS11643.1986-2_IBM-eucCN Converter_Specific  */
/*               Descriptor                                               */
/* EXTERNAL REFERENCES:                                                   */
