static char sccsid[] = "@(#)79  1.5  src/bos/usr/lib/nls/loc/iconv/fold_lower/CNS11643.1986-2_IBM-eucTW.c, cmdiconv, bos411, 9428A410j 6/1/94 02:47:49";
/*
...
/*      while (1) {                             @V42 */
        while (in < e_in) {                  /* @V42 */
                ...
                if (in[0] < 0x21 || in[1] < 0x21 || 0x7e < in[0] || 0x7e < in[1]) {
 ...
 *
 *   RETURNS:   Poniter to the descriptor.
 */
