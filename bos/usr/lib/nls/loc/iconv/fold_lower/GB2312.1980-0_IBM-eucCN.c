static char sccsid[] = "@(#)26	1.1  src/bos/usr/lib/nls/loc/iconv/fold_lower/GB2312.1980-0_IBM-eucCN.c, ils-zh_CN, bos41B, 9504A 12/19/94 15:16:28";
/*
...
/*                                                                         */
/* MODULE NAME:        GB2312.1980-0_IBM-eucCN                             */
/*                                                                         */
/* DESCRIPTIVE NAME:   Convert data encoding in GB to IBM-eucCN            */
/*                                                                         */
                                ...
                                unsigned char** outbuf, size_t *outbytesleft)
{
     ...
     while (in < e_in) {
 /*********************************************
  Begin convert, first process various errors
  *********************************************/
        ...
        if (in[1] < 0x21 || in[1] > 0x7e) {
            errno = EILSEQ;
            ret_value = -1;
            break;
        }
 /************************************************
  Convert Characters in GB2312.1980-0 to IBM-eucCN
  ************************************************/
        out[0] = in[0] | 0x80;
        out[1] = in[1] | 0x80;
        in += 2;
...
/* DESCRIPTION : Free Memory Allocated for GB2312.1980-0_IBM-eucCN        */
...
/* DESCRIPTION : Initialize GB2312.1980-0_IBM-eucCN Converter-Specific    */
/*               Descriptor                                               */
/* EXTERNAL REFERENCES:                                                   */
