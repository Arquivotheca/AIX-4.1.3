static char sccsid[] = "@(#)09  1.4  src/bos/usr/lib/nls/loc/iconv/fold_lower/IBM-eucJP_JISX0201.1976-GL.c, cmdiconv, bos411, 9428A410j 8/26/93 01:05:44";
/*
...
static	size_t	_iconv_exec (
	...
	while (1) {
		...
		if (*in != EUCSS2 || *(in + 1) < 0xa1 || 0xdf < *(in + 1)) {
