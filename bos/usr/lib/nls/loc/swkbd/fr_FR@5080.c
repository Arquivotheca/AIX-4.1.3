static char sccsid[] = "@(#)17  1.6  src/bos/usr/lib/nls/loc/swkbd/fr_FR@5080.c, lftdd, bos411, 9428A410j 10/25/93 15:36:22";
/*
...
{graphic,norm,0,p0,0xE9},      /* e acute accent                    pos 3   */
...
{graphic,norm,0,p0,0xE0},      /* a grave                           pos 11  */
...
{graphic,norm,0,p0,0xA3},      /* pound sterling                     pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,0xB5},      /* mu small                           pos 42  */
...
{graphic,norm,0,p0,0xA7},      /* section symbol                     pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
...
{graphic,norm,0,p0,0xA4},      /* intl currency symbol               pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
main ()
{
    ...
    fd = open("fr_FR.ISO8859-1@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
