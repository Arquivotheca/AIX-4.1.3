static char sccsid[] = "@(#)88	1.1  src/bos/usr/lib/nls/loc/swkbd/pt_BR.c, lftdd, bos411, 9430C411a 7/19/94 16:52:07";
/*
...
{graphic,dead,0,p0,0xB4},      /* acute accent                       pos 27  */
...
{graphic,dead,0,p0,IC_APPROX}, /* tilde                              pos 41  */
...
{graphic,norm,0,p0,IC_SEMI},   /* ;                                  pos 55  */
{graphic,norm,0,p0,IC_SLASH},  /* /                                  pos 56  */
...
{graphic,norm,0,p0,IC_PERIOD}, /* .                             pos 107 */
...
{graphic,dead,0,p0,0xA8},      /* diaeresis                           pos 7   */
...
{graphic,dead,0,p0,0x60},      /* grave accent                        pos 27  */
...
{graphic,dead,0,p0,IC_AND},    /* circumflex accent                   pos 41  */
{graphic,norm,0,p0,IC_RBRACE}, /* right curly brace                   pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{graphic,norm,0,p0,IC_OR},     /* pipe                                pos 45  */
...
{graphic,norm,0,p0,IC_QUES},   /* ?                                   pos 56  */
...
{ctlfunc,cpfk,0, 0,KF_PF98},   /* PFK 98                             pos 8   */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 9   */
{ctlfunc,cpfk,0, 0,KF_PF57},   /* PFK 57                             pos 10  */
...
{ctlfunc,cpfk,0, 0,KF_PF55},   /* PFK 55                             pos 27  */
{sgl_ctl,norm,0, 0,IC_ESC},    /* Escape control                     pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{ctlfunc,cpfk,0, 0,KF_PF96},   /* PFK 96                             pos 55  */
{ctlfunc,cpfk,0, 0,KF_PF112},  /* PFK 112                            pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD            pos 59  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Alternate key; do not alter   pos 60  */
...
{ctlfunc,cpfk,0, 0,KF_PF85},   /* PFK 85                             pos 27  */
...
{ctlfunc,cpfk,0, 0,KF_PF97},   /* PFK 97                             pos 55  */
{ctlfunc,cpfk,0, 0,KF_PF113},  /* PFK 113                            pos 56  */
...
{graphic,norm,0,p0,0xA3},      /* Pound Sterling                     pos 5   */
{graphic,norm,0,p0,0xA2},      /* Cent Sign                          pos 6   */
...
{graphic,norm,0,p0,0xA7},      /* section symbol                     pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
{graphic,norm,0,p0,0xAA},      /* ordinal ind feminine               pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,0xBA},      /* ordinal ind masculine              pos 42  */
...
{graphic,norm,0,p0,0xB0},      /* Degree Symbol                      pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD            pos 59  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Alternate key; do not alter   pos 60  */
...
main ()
{
    ...
    fd = open("pt_BR.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&brazilian_key_map,sizeof(lft_swkbd_t));
