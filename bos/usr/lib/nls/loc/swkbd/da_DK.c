static char sccsid[] = "@(#)10  1.3  src/bos/usr/lib/nls/loc/swkbd/da_DK.c, lftdd, bos411, 9428A410j 10/25/93 15:27:31";
/*
...
{graphic,norm,0,p0,0xBD},       /* 1/2                           pos 1   */
...
{graphic,norm,0,p0,0xF8},       /* o slash small                 pos 41  */
...
{graphic,norm,0,p0,0xA4},      /* intl. cur sym                       pos 5   */
...
{graphic,norm,0,p0,0xC5},      /* A overcirle capital                 pos 27  */
...
{graphic,norm,0,p0,0xD8},      /* O slash capital                     pos 41  */
...
main ()
{
    ...
    fd = open("da_DK.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
