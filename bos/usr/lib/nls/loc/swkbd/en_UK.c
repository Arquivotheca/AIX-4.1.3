static char sccsid[] = "@(#)11  1.5  src/bos/usr/lib/nls/loc/swkbd/en_UK.c, lftdd, bos411, 9428A410j 10/25/93 15:30:54";
/*
...
{graphic,norm,0,p0,0xAC},      /* not sign                           pos 13  */
...
{graphic,norm,0,p0,0xAF},       /* overbar                            pos 13  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 14  */
...
{graphic,norm,0,p0,0xB1},       /* plus or minus sign                 pos 10  */
...
main ()
{
    ...
    fd = open("en_GB.ISO8859-1@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
