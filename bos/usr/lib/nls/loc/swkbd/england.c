static char sccsid[] = "@(#)01  1.20  src/bos/usr/lib/nls/loc/swkbd/england.c, lftdd, bos411, 9428A410j 10/25/93 15:34:14";
/*
...
{graphic,norm,0,p0,0xAA},      /* not sign                           pos 13  */
...
{graphic,norm,0,p0,0x40},      /* at sign                            pos 27  */
{graphic,norm,0,p0,IC_LSB},    /* left square bracket                pos 28  */
...
{graphic,norm,0,p0,0x3A},      /* :                                  pos 41  */
{graphic,norm,0,p0,0x5D},      /* right square bracket               pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift Key; do not alter       pos 44  */
{graphic,norm,0,p0,0x7C},      /* broken vertical line               pos 45  */
...
{graphic,norm,0,p0,0x7C},       /* logical OR                         pos 1   */
...
{graphic,norm,0,p0,0x27},       /* '                                  pos 8   */
{graphic,norm,0,p0,IC_LPAR},    /* (                                  pos 9   */
{graphic,norm,0,p0,IC_RPAR},    /* )                                  pos 10  */
{graphic,norm,0,p0,0x23},       /* #                                  pos 11  */
{graphic,norm,0,p0,0x3D},       /* =                                  pos 12  */
{graphic,norm,0,p0,0xEE},       /* overbar                            pos 13  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 14  */
...
{graphic,norm,0,p0,0x7B},       /* left brace                         pos 28  */
...
{graphic,norm,0,p0,0x2B},       /* +                                  pos 40  */
{graphic,norm,0,p0,0x2A},       /* *                                  pos 41  */
{graphic,norm,0,p0,0x7D},       /* right brace                        pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* shift left                         pos 44  */
{graphic,norm,0,p0,0x5F},       /* _                                  pos 45  */
...
---------------------------------------------------------------------------*/
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 0   */
{sgl_ctl,norm,0, 0,0x1C},      /* single shift 4                    pos 1   */
...
{sgl_ctl,norm,0, 0,0x0},       /* NULL                              pos 27  */
...
{sgl_ctl,norm,0, 0,0x1E},      /* single shift 2                    pos 41  */
{sgl_ctl,norm,0, 1,0x1D},      /* single shift 3                    pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                   pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter      pos 44  */
{sgl_ctl,norm,0, 0,0x1F},      /* single shift 1                    pos 45  */
...
{graphic,norm,0,p0,0xF1},       /* plus or minus sign                 pos 10  */
...
main ()
{
    ...
    fd = open("En_GB.IBM-850@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&british_key_map,sizeof(lft_swkbd_t));
