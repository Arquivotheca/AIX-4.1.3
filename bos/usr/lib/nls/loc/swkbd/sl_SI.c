static char sccsid[] = "@(#)72	1.4  src/bos/usr/lib/nls/loc/swkbd/sl_SI.c, lftdd, bos411, 9428A410j 6/29/94 09:15:16";
/*
...
main ()
{
    ...
    fd = open("sl_SI.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&slovene_key_map,sizeof(lft_swkbd_t));
