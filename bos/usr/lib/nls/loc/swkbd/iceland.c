static char sccsid[] = "@(#)73  1.15  src/bos/usr/lib/nls/loc/swkbd/iceland.c, lftdd, bos411, 9428A410j 10/25/93 15:55:58";
/*
...
{graphic,dead,0,p0,IC_DEGREE},  /* overcircle accent             pos 1   */
...
{graphic,norm,0,p0,IC_LCOUML},  /* lowwer case o umlaut          pos 12  */
{graphic,dead,0,p0,IC_DASH},    /* minus sign                    pos 13  */
...
{graphic,norm,0,p0,IC_LCEICE},  /* lowwer case eth icelandic     pos 27  */
{graphic,norm,0,p0,IC_1QUOT},   /* apostrophe                    pos 28  */
...
{graphic,norm,0,p0,IC_LCAE},    /* ae dipthong                   pos 40  */
{graphic,dead,0,p0,IC_ACUTE},   /* acute accent                  pos 41  */
{graphic,norm,0,p0,IC_PLUS},    /* +                             pos 42  */
...
{graphic,norm,0,p0,IC_LCTICE},  /* lowwer case thorn icelandic   pos 55  */
...
{graphic,dead,0,p0,IC_UMLAUT}, /* diaeresis accent                    pos 1   */
...
{graphic,norm,0,p0,IC_UCOUML}, /* upper case o umlaut                 pos 12  */
{graphic,dead,0,p0,IC__},      /* underscore                          pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 14  */
...
{graphic,norm,0,p0,IC_UCEICE}, /* upper case eth icelandic            pos 27  */
{graphic,norm,0,p0,IC_QUES},   /* ?                                   pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
...
{graphic,norm,0,p0,IC_UCAE},   /* AE dipthong capital                 pos 40  */
{graphic,dead,0,p0,IC_ACUTE},  /* acute accent                        pos 41  */
...
{graphic,norm,0,p0,IC_UCTICE}, /* upper case thorn icelandic          pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift right                         pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control                             pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD             pos 59  */
...
---------------------------------------------------------------------------*/
{es_func,norm,0, 1,KF_IGNORE},/* not available                     pos 0   */
{ctlfunc,cpfk,0, 0,KF_PF69},  /* PFK 69                            pos 1   */
...
{graphic,norm,0,p0,IC_LSB},    /* left square bracket                pos 9   */
{graphic,norm,0,p0,IC_RSB},    /* right square bracket               pos 10  */
...
{graphic,dead,0,p0,0x5E},      /* circumflex accent                  pos 41  */
...
main ()
{
    ...
    fd = open("Is_IS.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&iceland_key_map,sizeof(lft_swkbd_t));
