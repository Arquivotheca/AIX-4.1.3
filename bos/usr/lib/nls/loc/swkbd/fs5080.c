static char sccsid[] = "@(#)57  1.7  src/bos/usr/lib/nls/loc/swkbd/fs5080.c, lftdd, bos411, 9428A410j 10/25/93 15:48:40";
/*
...
{graphic,norm,0,p0,IC_INTLCU}, /* intl currency symbol               pos 5   */
...
{graphic,norm,0,p0,IC_LBRACE}, /* left brace                         pos 11  */
{graphic,norm,0,p0,IC_RBRACE}, /* right brace                        pos 12  */
{graphic,dead,0,p0,IC_APPROX}, /* tilde                              pos 13  */
...
main ()
{
    ...
    fd = open("Fi_FI.IBM-850@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    swedish_key_map.kbdname[0] = 'S';
    swedish_key_map.kbdname[1] = 'v';
    swedish_key_map.kbdname[3] = 'S';
    swedish_key_map.kbdname[4] = 'E';
    fd = open("Sv_SE.IBM-850@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
