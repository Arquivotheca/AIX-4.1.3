static char sccsid[] = "@(#)13  1.3  src/bos/usr/lib/nls/loc/swkbd/en_US.c, lftdd, bos411, 9428A410j 10/25/93 15:33:29";
/*
 * COMPONENT_NAME: (LFTDD) Low Function Terminal - en_US.c
 *
 * ORIGINS: 27
 *
...
main ()
{
    ...
    fd = open("en_US.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    usa_key_map.kbdname[0] = 'C';
    usa_key_map.kbdname[1] = '\0';
    usa_key_map.kbdname[2] = '\0';
    usa_key_map.kbdname[3] = '\0';
    usa_key_map.kbdname[4] = '\0';
    usa_key_map.disp_set[0] = 'C';
    usa_key_map.disp_set[1] = '\0';
    usa_key_map.disp_set[2] = '\0';
    usa_key_map.disp_set[3] = '\0';
    usa_key_map.disp_set[4] = '\0';
    usa_key_map.disp_set[5] = '\0';
    usa_key_map.disp_set[6] = '\0';
    usa_key_map.disp_set[7] = '\0';
    fd = open("C.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
