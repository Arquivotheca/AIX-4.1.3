static char sccsid[] = "@(#)71	1.4  src/bos/usr/lib/nls/loc/swkbd/sh_SP.c, lftdd, bos411, 9428A410j 6/29/94 09:15:10";
/*
...
{graphic,dead,0,p0,0xB8},       /* cedilla                       pos 1   */
...
{graphic,norm,0,p0,IC_0},       /* 0                          0  pos 11  */
...
{graphic,norm,0,p0,0xB9},       /* s caron small              f  pos 27  */
{graphic,norm,0,p0,0xF0},       /* d stroke small                pos 28  */
...
{graphic,norm,0,p0,0xE8},       /* c caron small                 pos 40  */
{graphic,norm,0,p0,0xE6},       /* c acute small                 pos 41  */
{graphic,norm,0,p0,0xBE},       /* z caron small                 pos 42  */
...
{graphic,dead,0,p0,0xA8},      /* diaeresis                           pos 1   */
...
{graphic,norm,0,p0,0xA9},      /* S caron capital                     pos 27  */
{graphic,norm,0,p0,0xD0},      /* D stroke capital                    pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
...
{graphic,norm,0,p0,0xC8},      /* C caron capital                     pos 40  */
{graphic,norm,0,p0,0xC6},      /* C acute capital                     pos 41  */
{graphic,norm,0,p0,0xAE},      /* Z caron capital                     pos 42  */
...
{graphic,norm,0,p0,0xA7},      /* section symbol                     pos 52  */
...
main ()
{
    ...
    fd = open("sh_SP.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&yulatin_key_map,sizeof(lft_swkbd_t));
