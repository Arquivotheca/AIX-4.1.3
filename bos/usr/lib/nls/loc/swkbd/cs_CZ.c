static char sccsid[] = "@(#)63	1.4  src/bos/usr/lib/nls/loc/swkbd/cs_CZ.c, lftdd, bos411, 9428A410j 6/29/94 09:15:04";
/*
...
{graphic,norm,0,p0,IC_SEMI},    /* semicolon                  0  pos 1   */
{graphic,norm,0,p0,IC_PLUS},    /* +                          0  pos 2   */
{graphic,norm,0,p0,0xEC},       /* e caron small              0  pos 3   */
{graphic,norm,0,p0,0xB9},       /* s caron small              0  pos 4   */
{graphic,norm,0,p0,0xE8},       /* c caron small              0  pos 5   */
{graphic,norm,0,p0,0xF8},       /* r caron small              0  pos 6   */
{graphic,norm,0,p0,0xBE},       /* z caron small              0  pos 7   */
{graphic,norm,0,p0,0xFD},       /* y acute small              0  pos 8   */
{graphic,norm,0,p0,0xE1},       /* a acute small              0  pos 9   */
{graphic,norm,0,p0,0xED},       /* i acute small              0  pos 10  */
{graphic,norm,0,p0,0xE9},       /* e acute small              0  pos 11  */
{graphic,norm,0,p0,IC_EQ},      /* =                          0  pos 12  */
{graphic,dead,0,p0,0xB4},       /* acute accent               0  pos 13  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available              0  pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},      /* Backspace                  0  pos 15  */
{sgl_ctl,curs,0, 0,IC_HT},      /*  horizontal tab            0  pos 16  */
{graphic,norm,0,p0,IC_LCQ},     /* q                          1  pos 17  */
{graphic,norm,0,p0,IC_LCW},     /* w                          1  pos 18  */
{graphic,norm,0,p0,IC_LCE},     /* e                          1  pos 19  */
{graphic,norm,0,p0,IC_LCR},     /* r                          1  pos 20  */
{graphic,norm,0,p0,IC_LCT},     /* t                          1  pos 21  */
{graphic,norm,0,p0,IC_LCZ},     /* z                          1  pos 22  */
{graphic,norm,0,p0,IC_LCU},     /* u                          1  pos 23  */
{graphic,norm,0,p0,IC_LCI},     /* i                          1  pos 24  */
{graphic,norm,0,p0,IC_LCO},     /* o                          1  pos 25  */
{graphic,norm,0,p0,IC_LCP},     /* p                          1  pos 26  */
{graphic,norm,0,p0,0xFA},       /* u acute small              0  pos 27  */
{graphic,norm,0,p0,IC_RPAR},    /* )                          0  pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* not avail on WT KBD        0  pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key; do not alter0  pos 30  */
{graphic,norm,0,p0,IC_LCA},     /* a                          1  pos 31  */
{graphic,norm,0,p0,IC_LCS},     /* s                          1  pos 32  */
{graphic,norm,0,p0,IC_LCD},     /* d                          1  pos 33  */
{graphic,norm,0,p0,IC_LCF},     /* f                          1  pos 34  */
{graphic,norm,0,p0,IC_LCG},     /* g                          1  pos 35  */
{graphic,norm,0,p0,IC_LCH},     /* h                          1  pos 36  */
{graphic,norm,0,p0,IC_LCJ},     /* j                          1  pos 37  */
{graphic,norm,0,p0,IC_LCK},     /* k                          1  pos 38  */
{graphic,norm,0,p0,IC_LCL},     /* l                          1  pos 39  */
{graphic,norm,0,p0,0xF9},       /* u overcircle small         0  pos 40  */
{graphic,norm,0,p0,0xA7},       /* section symbol             0  pos 41  */
{graphic,dead,0,p0,0xA8},       /* diaeresis accent           0  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return            0  pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alte0  pos 44  */
{graphic,norm,0,p0,IC_AMP},     /* &                          0  pos 45  */
{graphic,norm,0,p0,IC_LCY},     /* y                          1  pos 46  */
{graphic,norm,0,p0,IC_LCX},     /* x                          1  pos 47  */
{graphic,norm,0,p0,IC_LCC},     /* c                          1  pos 48  */
{graphic,norm,0,p0,IC_LCV},     /* v                          1  pos 49  */
{graphic,norm,0,p0,IC_LCB},     /* b                          1  pos 50  */
{graphic,norm,0,p0,IC_LCN},     /* n                          1  pos 51  */
...
{graphic,dead,0,p0,0xB0},       /* overcircle accent             pos 1   */
...
{graphic,norm,0,p0,IC_PERCENT} ,/* %                             pos 12  */
{graphic,dead,0,p0,0xB7},       /* caron accent                  pos 13  */
...
{graphic,norm,0,p0,IC_SLASH},  /* /                                   pos 27  */
{graphic,norm,0,p0,IC_LPAR},   /* (                                   pos 28  */
...
{graphic,norm,0,p0,IC_2QUOT},  /* "                                   pos 40  */
{graphic,norm,0,p0,IC_EXC},    /* !                                   pos 41  */
{graphic,norm,0,p0,IC_1QUOT},  /* '                                   pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{graphic,norm,0,p0,0x2A},      /* *                                   pos 45  */
...
{graphic,norm,0,p0,0x7E},      /* tilde                              pos 2   */
{graphic,dead,0,p0,0xB7},      /* caron accent                       pos 3   */
{graphic,dead,0,p0,0x5E},      /* circumflex accent                  pos 4   */
{graphic,dead,0,p0,0xA2},      /* breve accent                       pos 5   */
{graphic,dead,0,p0,0xB0},      /* overcircle accent                  pos 6   */
{graphic,dead,0,p0,0xB2},      /* ogonek accent                      pos 7   */
{graphic,norm,0,p0,0x60},      /* grave                              pos 8   */
{graphic,dead,0,p0,0xFF},      /* overdot accent                     pos 9   */
{graphic,dead,0,p0,0xB4},      /* acute accent                       pos 10  */
{graphic,dead,0,p0,0xBD},      /* double acute accent                pos 11  */
{graphic,dead,0,p0,0xA8},      /* diaeresis accent                   pos 12  */
...
{graphic,norm,0,p0,IC_BSLASH}, /* backslash                          pos 17  */
{graphic,norm,0,p0,IC_OR},     /* vertical bar                       pos 18  */
...
{graphic,norm,0,p0,0xF7},      /* divide sign                        pos 27  */
{graphic,norm,0,p0,0xD7},      /* multiply sign                      pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 31  */
{graphic,norm,0,p0,0xF0},      /* d stroke small                     pos 32  */
{graphic,norm,0,p0,0xD0},      /* D stroke capital                   pos 33  */
{graphic,norm,0,p0,IC_LSB},    /* [                                  pos 34  */
{graphic,norm,0,p0,IC_RSB},    /* ]                                  pos 35  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 36  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 37  */
{graphic,norm,0,p0,0xB3},      /* l stroke small                     pos 38  */
{graphic,norm,0,p0,0xA3},      /* L stroke capital                   pos 39  */
{graphic,norm,0,p0,0x24},      /* dollar sign                        pos 40  */
{graphic,norm,0,p0,0xDF},      /* s sharp                            pos 41  */
{graphic,norm,0,p0,0xA4},      /* currency symbol                    pos 42  */
...
{graphic,norm,0,p0,0x3E},      /* >                                  pos 46  */
{graphic,norm,0,p0,0x23},      /* #                                  pos 47  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 48  */
{graphic,norm,0,p0,IC_AT},     /* at sign                            pos 49  */
{graphic,norm,0,p0,IC_LBRACE}, /* left curly brace                   pos 50  */
{graphic,norm,0,p0,IC_RBRACE}, /* right curly brace                  pos 51  */
...
{graphic,norm,0,p0,0x49},       /* I                             pos 1   */
{graphic,norm,0,p0,IC_1},       /* 1                             pos 2   */
{graphic,norm,0,p0,IC_2},       /* 2                             pos 3   */
{graphic,norm,0,p0,IC_3},       /* 3                             pos 4   */
{graphic,norm,0,p0,IC_4},       /* 4                             pos 5   */
...
main ()
{
    ...
    fd = open("cs_CZ.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&czech_key_map,sizeof(lft_swkbd_t));
