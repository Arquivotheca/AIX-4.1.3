static char sccsid[] = "@(#)74	1.3  src/bos/usr/lib/nls/loc/swkbd/sr_SP.c, lftdd, bos411, 9428A410j 6/29/94 09:15:22";
/*
 * COMPONENT_NAME: (LFTDD) Low Function Terminal - sr_SP.c
 *
 * ORIGINS: 27
 *
...
{graphic,norm,0,p0,0x5C},       /* \                          0  pos 1   */
...
{graphic,norm,0,p0,0x27},       /* '                          0  pos 12  */
{graphic,norm,0,p0,0x2B},       /* +                          0  pos 13  */
...
{graphic,norm,0,p0,IC_LCZ},     /* z                          1  pos 22  */
...
{graphic,norm,0,p0,0x5B},       /* [                     f    1  pos 27  */
{graphic,norm,0,p0,0x5D},       /* ]                          1  pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* not avail on WT KBD        0  pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key;             0  pos 30  */
{graphic,norm,0,p0,IC_LCA},     /* a                     9    1  pos 31  */
...
{graphic,norm,0,p0,0x5E},       /* ^                          1  pos 40  */
{graphic,norm,0,p0,0xFD},       /* section                    1  pos 41  */
{graphic,norm,0,p0,0x40},       /* @                          1  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return       e    0  pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key;            0  pos 44  */
{graphic,norm,0,p0,IC_LT},      /* <                          0  pos 45  */
{graphic,norm,0,p0,IC_LCY},     /* y                          1  pos 46  */
...
{graphic,norm,0,p0,IC_COM},     /* ,                          0  pos 53  */
{graphic,norm,0,p0,IC_PERIOD},  /* .                          0  pos 54  */
{graphic,norm,0,p0,0x2D},       /* -                     8    0  pos 55  */
...
{graphic,norm,0,p0,0x3F},      /* ?                                   pos 12  */
{graphic,norm,0,p0,0x2A},      /* *                                   pos 13  */
...
{graphic,norm,0,p0,IC_UCZ},    /* Z                                   pos 22  */
...
{graphic,norm,0,p0,0x5E},      /* ^                                   pos 40  */
{graphic,norm,0,p0,0xFD},      /* section                             pos 41  */
{graphic,norm,0,p0,0x40},      /* @                                   pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{graphic,norm,0,p0,IC_GT},     /* >                                   pos 45  */
{graphic,norm,0,p0,IC_UCY},    /* Y                                   pos 46  */
...
{graphic,norm,0,p0,0x5F},      /* _                                   pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift right                         pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control                             pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD             pos 59  */
...
{graphic,norm,0,p0,0x5C},      /* \                                  pos 17  */
{graphic,norm,0,p0,0x7C},      /* |                                  pos 18  */
...
{graphic,norm,0,p0,0xA3},      /* gj  capital                        pos 27  */
{graphic,norm,0,p0,0xF3},      /* gj  small                          pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 31  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 32  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 33  */
{graphic,norm,0,p0,0x5B},      /* [                                  pos 34  */
{graphic,norm,0,p0,0x5D},      /* ]                                  pos 35  */
...
{graphic,norm,0,p0,0xAC},      /* kj  capital                        pos 40  */
{graphic,norm,0,p0,0xFC},      /* kj  small                          pos 41  */
...
{graphic,norm,0,p0,0x40},      /* @                                  pos 49  */
{graphic,norm,0,p0,0x7B},      /* {                                  pos 50  */
{graphic,norm,0,p0,0x7D},      /* }                                  pos 51  */
{graphic,norm,0,p0,0xFD},      /* section                            pos 52  */
...
{graphic,norm,0,p0,0x27},       /* '                             pos 12  */
{graphic,norm,0,p0,0x2B},       /* +                             pos 13  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                 pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},      /* Backspace                     pos 15  */
{sgl_ctl,curs,0, 0,IC_HT},      /*  horizontal tab               pos 16  */
{graphic,norm,0,p0,0xF9},       /* lj small                      pos 17  */
{graphic,norm,0,p0,0xFA},       /* nj small                      pos 18  */
{graphic,norm,0,p0,0xD5},       /* e small                       pos 19  */
{graphic,norm,0,p0,0xE0},       /* r small                       pos 20  */
{graphic,norm,0,p0,0xE2},       /* t small                       pos 21  */
{graphic,norm,0,p0,0xD7},       /* z small                       pos 22  */
{graphic,norm,0,p0,0xE3},       /* u small                       pos 23  */
{graphic,norm,0,p0,0xD8},       /* i small                       pos 24  */
{graphic,norm,0,p0,0xDE},       /* o small                       pos 25  */
{graphic,norm,0,p0,0xDF},       /* p small                       pos 26  */
{graphic,norm,0,p0,0xE8},       /* sh small                      pos 27  */
{graphic,norm,0,p0,0xF2},       /* dje small                     pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* not avail on WT KBD           pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key; do not alter   pos 30  */
{graphic,norm,0,p0,0xD0},       /* a small                       pos 31  */
{graphic,norm,0,p0,0xE1},       /* s small                       pos 32  */
{graphic,norm,0,p0,0xD4},       /* d small                       pos 33  */
{graphic,norm,0,p0,0xE4},       /* f small                       pos 34  */
{graphic,norm,0,p0,0xD3},       /* g small                       pos 35  */
{graphic,norm,0,p0,0xE5},       /* h small                       pos 36  */
{graphic,norm,0,p0,0xF8},       /* j small                       pos 37  */
{graphic,norm,0,p0,0xDA},       /* k small                       pos 38  */
{graphic,norm,0,p0,0xDB},       /* l small                       pos 39  */
{graphic,norm,0,p0,0xE7},       /* ch small                      pos 40  */
{graphic,norm,0,p0,0xFB},       /* cje small                     pos 41  */
{graphic,norm,0,p0,0xD6},       /* zh small                      pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return               pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter  pos 44  */
{graphic,norm,0,p0,0x3C},       /* <                             pos 45  */
{graphic,norm,0,p0,0xF5},       /* dz small                      pos 46  */
{graphic,norm,0,p0,0xFF},       /* dzh small                     pos 47  */
{graphic,norm,0,p0,0xE6},       /* c small                       pos 48  */
{graphic,norm,0,p0,0xD2},       /* v small                       pos 49  */
{graphic,norm,0,p0,0xD1},       /* b small                       pos 50  */
{graphic,norm,0,p0,0xDD},       /* n small                       pos 51  */
{graphic,norm,0,p0,0xDC},       /* m small                       pos 52  */
{graphic,norm,0,p0,0x2C},       /* ,                             pos 53  */
{graphic,norm,0,p0,0x2E},       /* .                             pos 54  */
{graphic,norm,0,p0,0x2D},       /* -                             pos 55  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                 pos 56  */
{es_func,norm,0, 1,KF_IGNORE},  /* shift right                   pos 57  */
{es_func,norm,0, 1,KF_IGNORE},  /* control                       pos 58  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available on WT KBD       pos 59  */
...
---------------------------------------------------------------------------*/
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 0   */
{graphic,norm,0,p0,0x7C},      /* |                                   pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                   pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                   pos 3   */
{graphic,norm,0,p0,0x23},      /* #                                   pos 4   */
{graphic,norm,0,p0,IC_DOLLAR}, /* $                                   pos 5   */
{graphic,norm,0,p0,IC_PERCENT},/* %                                   pos 6   */
{graphic,norm,0,p0,0x26},      /* &                                   pos 7   */
{graphic,norm,0,p0,IC_SLASH},  /* /                                   pos 8   */
{graphic,norm,0,p0,IC_LPAR},   /* (                                   pos 9   */
{graphic,norm,0,p0,IC_RPAR},   /* )                                   pos 10  */
{graphic,norm,0,p0,IC_EQ},     /* =                                   pos 11  */
...
{sgl_ctl,curs,0, 0,IC_BS},     /* Back Space                          pos 15  */
{ctlfunc,curs,0, 1,KF_CBT},    /* cursor Back Horizontal Tab          pos 16  */
{graphic,norm,0,p0,0xA9},      /* lj capital                          pos 17  */
{graphic,norm,0,p0,0xAA},      /* nj capital                          pos 18  */
{graphic,norm,0,p0,0xB5},      /* e capital                           pos 19  */
{graphic,norm,0,p0,0xC0},      /* r capital                           pos 20  */
{graphic,norm,0,p0,0xC2},      /* t capital                           pos 21  */
{graphic,norm,0,p0,0xB7},      /* z capital                           pos 22  */
{graphic,norm,0,p0,0xC3},      /* u capital                           pos 23  */
{graphic,norm,0,p0,0xB8},      /* i capital                           pos 24  */
{graphic,norm,0,p0,0xBE},      /* o capital                           pos 25  */
{graphic,norm,0,p0,0xBF},      /* p capital                           pos 26  */
{graphic,norm,0,p0,0xC8},      /* sh capital                          pos 27  */
{graphic,norm,0,p0,0xA2},      /* dje capital                         pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
{graphic,norm,0,p0,0xB0},      /* a capital                           pos 31  */
{graphic,norm,0,p0,0xC1},      /* s capital                           pos 32  */
{graphic,norm,0,p0,0xB4},      /* d capital                           pos 33  */
{graphic,norm,0,p0,0xC4},      /* f capital                           pos 34  */
{graphic,norm,0,p0,0xB3},      /* g capital                           pos 35  */
{graphic,norm,0,p0,0xC5},      /* h capital                           pos 36  */
{graphic,norm,0,p0,0xA8},      /* j capital                           pos 37  */
{graphic,norm,0,p0,0xBA},      /* k capital                           pos 38  */
{graphic,norm,0,p0,0xBB},      /* l capital                           pos 39  */
{graphic,norm,0,p0,0xC7},      /* ch capital                          pos 40  */
{graphic,norm,0,p0,0xAB},      /* cje capital                         pos 41  */
{graphic,norm,0,p0,0xB6},      /* zh capital                          pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{graphic,norm,0,p0,0x3E},      /* >                                   pos 45  */
{graphic,norm,0,p0,0xA5},      /* dz capital                          pos 46  */
{graphic,norm,0,p0,0xAF},      /* dzh capital                         pos 47  */
{graphic,norm,0,p0,0xC6},      /* c capital                           pos 48  */
{graphic,norm,0,p0,0xB2},      /* v capital                           pos 49  */
{graphic,norm,0,p0,0xB1},      /* b capital                           pos 50  */
{graphic,norm,0,p0,0xBD},      /* n capital                           pos 51  */
{graphic,norm,0,p0,0xBC},      /* m capital                           pos 52  */
{graphic,norm,0,p0,IC_SEMI},   /* ;                                   pos 53  */
{graphic,norm,0,p0,IC_COLON},  /* :                                   pos 54  */
{graphic,norm,0,p0,0x5F},      /* _                                   pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
...
main ()
{
    ...
    fd = open("sr_SP.ISO8859-5.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&serbian_key_map,sizeof(lft_swkbd_t));
