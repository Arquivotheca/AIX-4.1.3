static char sccsid[] = "@(#)05  1.16  src/bos/usr/lib/nls/loc/swkbd/italy.c, lftdd, bos411, 9428A410j 10/25/93 15:58:57";
/*
...
{ctlfunc,cpfk,0, 0,KF_PF69},   /* PFK 69                            pos 7   */
...
{graphic,norm,0,p0,IC_LBRACE}, /* {                                  pos 8   */
{graphic,norm,0,p0,0x5b},      /* [                                  pos 9   */
{graphic,norm,0,p0,0x5d},      /* ]                                  pos 10  */
{graphic,norm,0,p0,IC_RBRACE}, /* }                                  pos 11  */
...
{graphic,norm,0,p0,IC_APPROX}, /* tilde                              pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
main ()
{
    ...
    fd = open("It_IT.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
