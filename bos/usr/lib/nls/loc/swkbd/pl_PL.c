static char sccsid[] = "@(#)67	1.3  src/bos/usr/lib/nls/loc/swkbd/pl_PL.c, lftdd, bos411, 9428A410j 4/8/94 13:58:51";
/*
...
{graphic,dead,0,p0,0xB2},       /* ogonek                        pos 1   */
...
{graphic,norm,0,p0,0xBF},       /* z abovedot small              pos 27  */
{graphic,norm,0,p0,0xB6},       /* s acute  small                pos 28  */
...
{graphic,norm,0,p0,0xB3},       /* l stroke small                pos 40  */
{graphic,norm,0,p0,0xB1},       /* a ogonek small                pos 41  */
{graphic,norm,0,p0,0xF3},       /* o acute small                 pos 42  */
...
{graphic,norm,0,p0,0xF1},      /* n acute small                       pos 27  */
{graphic,norm,0,p0,0xE6},      /* c acute small                       pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
...
{graphic,norm,0,p0,0xA3},      /* L stroke capital                    pos 40  */
{graphic,norm,0,p0,0xEA},      /* e ogonek small                      pos 41  */
{graphic,norm,0,p0,0xBC},      /* z acute small                       pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
...
{graphic,norm,0,p0,IC_DOLLAR}, /* dollar                             pos 40  */
...
main ()
{
    ...
    fd = open("pl_PL.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&polish_key_map,sizeof(lft_swkbd_t));
