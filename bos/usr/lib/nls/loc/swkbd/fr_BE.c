static char sccsid[] = "@(#)14  1.5  src/bos/usr/lib/nls/loc/swkbd/fr_BE.c, lftdd, bos411, 9428A410j 4/26/94 10:22:05";
/*
...
{graphic,norm,0,p0,0xB2},      /* superscript 2                     pos 1   */
{graphic,norm,0,p0,IC_AMP},    /* &                                 pos 2   */
{graphic,norm,0,p0,0xE9},      /* e-acute                           pos 3   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                 pos 4   */
{graphic,norm,0,p0,0x27},      /* '                                 pos 5   */
{graphic,norm,0,p0,IC_LPAR},   /* (                                 pos 6   */
{graphic,norm,0,p0,0xA7},      /* section symbol                    pos 7   */
{graphic,norm,0,p0,0xE8},      /* e-grave accent                    pos 8   */
{graphic,norm,0,p0,IC_EXC},    /* !                                 pos 9   */
{graphic,norm,0,p0,0xE7},      /* c-cedilla small                   pos 10  */
{graphic,norm,0,p0,0xE0},      /* a-grave accent                    pos 11  */
{graphic,norm,0,p0,IC_RPAR},   /* )                                 pos 12  */
...
{graphic,norm,0,p0,IC_LCA},    /* a                                 pos 17  */
{graphic,norm,0,p0,IC_LCZ},    /* z                                 pos 18  */
...
{graphic,dead,0,p0,IC_AND},    /* circumflex accent                 pos 27  */
{graphic,norm,0,p0,IC_DOLLAR}, /* $                                 pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD           pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter       pos 30  */
{graphic,norm,0,p0,IC_LCQ},    /* q                                 pos 31  */
...
{graphic,norm,0,p0,IC_LCM},    /* m                                 pos 40  */
{graphic,norm,0,p0,0xF9},      /* u-grave accent                    pos 41  */
{graphic,norm,0,p0,0xB5},      /* Greek mu small                    pos 42  */
...
{graphic,norm,0,p0,IC_LCW},    /* w                                 pos 46  */
...
{graphic,norm,0,p0,0xB3},      /* superscript 3                     pos 1   */
...
{graphic,norm,0,p0,0xB0},      /* degree                            pos 12  */
{graphic,norm,0,p0,IC__},      /* _                                 pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},     /* Back Space                        pos 15  */
{ctlfunc,curs,0, 1,KF_CBT},    /* cursor Back Horizontal Tab        pos 16  */
{graphic,norm,0,p0,IC_UCA},    /* A                                 pos 17  */
{graphic,norm,0,p0,IC_UCZ},    /* Z                                 pos 18  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD           pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter       pos 30  */
{graphic,norm,0,p0,IC_UCQ},    /* Q                                 pos 31  */
...
{graphic,norm,0,p0,IC_UCM},    /* M                                 pos 40  */
{graphic,norm,0,p0,IC_PERCENT},/* %                                 pos 41  */
{graphic,norm,0,p0,0xA3},      /* pound sterling                    pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                   pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                        pos 44  */
{graphic,norm,0, 0,IC_GT},     /* >                                 pos 45  */
{graphic,norm,0,p0,IC_UCW},    /* W                                 pos 46  */
...
{graphic,norm,0,p0,IC_QUES},   /* ?                                 pos 52  */
{graphic,norm,0,p0,IC_PERIOD}, /* .                                 pos 53  */
{graphic,norm,0,p0,IC_SLASH},  /* /                                 pos 54  */
{graphic,norm,0,p0,IC_PLUS},   /* +                                 pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 56  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Right Alternate key; do not alter pos 62  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 63  */
{es_func,norm,0, 1,KF_IGNORE}, /* VTRM Prev Window key; do not alterpos 64  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 65  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 66  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 67  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 68  */
...
{ctlfunc,cpfk,0, 0,KF_PF69},   /* PFK 69                            pos 12  */
{sgl_ctl,norm,0, 0,IC_SS1},    /* single shift 1                    pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 14  */
{sgl_ctl,norm,0, 0,IC_DEL},    /* Delete                            pos 15  */
{ctlfunc,cpfk,0, 0,KF_PF72},   /* PFK 72                            pos 16  */
{sgl_ctl,norm,0, 0,IC_SOH},    /* Start of Header                   pos 17  */
{sgl_ctl,norm,0, 0,IC_SUB},    /* Substitute Character              pos 18  */
...
{sgl_ctl,norm,0, 0,IC_NAK},    /* No Acknowledge                    pos 23  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter       pos 30  */
{sgl_ctl,norm,0, 0,IC_DC1},    /* device control 1                  pos 31  */
...
{sgl_ctl,norm,0, 0,IC_CR},     /* Carriage Return                   pos 40  */
{ctlfunc,cpfk,0, 0,KF_PF98},   /* PFK 98                            pos 41  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                            pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                   pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter      pos 44  */
{sgl_ctl,norm,0, 0,IC_SS4},    /* single shift 4                    pos 45  */
{sgl_ctl,norm,0, 0,IC_ETB},    /* end trans blk                     pos 46  */
...
{ctlfunc,cpfk,0, 0,KF_PF96},   /* PFK 96                            pos 52  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter     pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter         pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD               pos 59  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Alternate key; do not alter  pos 60  */
{graphic,norm,0,p0,IC_SP},     /* Space Bar                         pos 61  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Alternate key; do not alter pos 62  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 63  */
...
{ctlfunc,cpfk,0,0,KF_PF70},   /* PFK 70                             pos 12  */
{ctlfunc,cpfk,0,0,KF_PF68},   /* PFK 68                             pos 13  */
{es_func,norm,0,1,KF_IGNORE}, /* not available                      pos 14  */
{ctlfunc,cpfk,0,0,KF_PF71},   /* PFK 71                             pos 15  */
{ctlfunc,cpfk,0,0,KF_PF73},   /* PFK 73                             pos 16  */
{ctlfunc,cpfk,0,0,KF_PF87},   /* PFK 87                             pos 17  */
{ctlfunc,cpfk,0,0,KF_PF101},  /* PFK 101                            pos 18  */
...
{es_func,norm,0,1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0,1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
{ctlfunc,cpfk,0,0,KF_PF74},   /* PFK 74                             pos 31  */
...
{ctlfunc,cpfk,0,0,KF_PF107},  /* PFK 107                            pos 40  */
{ctlfunc,cpfk,0,0,KF_PF99},   /* PFK 99                             pos 41  */
{es_func,norm,0,1,KF_IGNORE}, /* ignore                             pos 42  */
{ctlfunc,cpfk,0,0,KF_PF100},  /* PFK 100                            pos 43  */
{es_func,norm,0,1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{ctlfunc,cpfk,0,0,KF_PF86},   /* PFK 86                             pos 45  */
{ctlfunc,cpfk,0,0,KF_PF75},   /* PFK 75                             pos 46  */
...
{ctlfunc,cpfk,0,0,KF_PF97},   /* PFK 97                             pos 52  */
...
{graphic,norm,0,p0,IC_OR},     /* pipe symbol                        pos 2   */
...
{graphic,norm,0,p0,IC_AND},    /* caret symbol                       pos 7   */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 8   */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 9   */
{graphic,norm,0,p0,IC_LBRACE}, /* left curly brace                   pos 10  */
...
{graphic,norm,0,p0,IC_LSB},    /* left square bracket                pos 27  */
{graphic,norm,0,p0,IC_RSB},    /* right square bracket               pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,dead,0,p0,0xB4},      /* acute accent                       pos 41  */
{graphic,dead,0,p0,0x60},      /* grave accent                       pos 42  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{graphic,norm,0,p0,IC_BSLASH}, /* reverse slash                      pos 45  */
...
{graphic,dead,0,p0,IC_APPROX}, /* tilde                              pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD            pos 59  */
...
main ()
{
    ...
    fd = open("fr_BE.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&belgium_key_map,sizeof(lft_swkbd_t));
    ...
    belgium_key_map.kbdname[0] = 'd';
    belgium_key_map.kbdname[1] = 'e';
    fd = open("de_BE.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
    ...
    belgium_key_map.kbdname[0] = 'n';
    belgium_key_map.kbdname[1] = 'l';
    fd = open("nl_BE.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
...
#ifdef NL_ALTERNATE
    /* 
     * Defect 139355 - the nl_NL.c will be the default and if user
     * wants fr_NL then they can choose it explicitly.
     */
    belgium_key_map.kbdname[3] = 'N';
    belgium_key_map.kbdname[4] = 'L';
    fd = open("nl_NL.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
