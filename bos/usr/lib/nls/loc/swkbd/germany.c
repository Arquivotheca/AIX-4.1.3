static char sccsid[] = "@(#)04  1.16  src/bos/usr/lib/nls/loc/swkbd/germany.c, lftdd, bos411, 9428A410j 5/18/94 11:18:15";
/*
...
{graphic,norm,0,p0,IC_LCSSHP}, /* double s                          pos 12  */
...
{graphic,norm,0,p0,IC_LCUUML}, /* u diaeresis                       pos 27  */
...
{graphic,norm,0,p0,IC_MULTPL}, /* Multiplication  symbol        pos 100 */
...
{graphic,norm,0,p0,IC_SECT},   /* section symbol                      pos 4   */
...
{graphic,norm,0,p0,IC_UCUUML}, /* U diaeresis capital                 pos 27  */
...
{graphic,norm,0,p0,IC_UCOUML}, /* O diaeresis capital                 pos 40  */
{graphic,norm,0,p0,IC_UCAUML}, /* A diaeresis capital                 pos 41  */
...
{graphic,norm,0,p0,IC_SSTWO},  /* superscript 2                      pos 3   */
{graphic,norm,0,p0,IC_SSTHRE}, /* superscript 3                      pos 4   */
...
{graphic,norm,0,p0,IC_LCMU},   /* mu small                           pos 52  */
...
main ()
{
    ...
    fd = open("De_DE.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
