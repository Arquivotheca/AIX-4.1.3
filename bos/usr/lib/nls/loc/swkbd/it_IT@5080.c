static char sccsid[] = "@(#)25  1.6  src/bos/usr/lib/nls/loc/swkbd/it_IT@5080.c, lftdd, bos411, 9428A410j 10/25/93 15:58:32";
/*
...
{graphic,norm,0,p0,0xEC},      /* i grave accent                    pos 13  */
...
{graphic,norm,0,p0,0xE8},      /* e grave accent                    pos 27  */
...
{graphic,norm,0,p0,0xF2},      /* o grave accent                    pos 40  */
{graphic,norm,0,p0,0xE0},      /* a grave accent                    pos 41  */
{graphic,norm,0,p0,0xF9},      /* u grave accent                    pos 42  */
...
{graphic,norm,0,p0,0xE9},      /* e acute accent                     pos 27  */
...
{graphic,norm,0,p0,0xE7},      /* c cedilla                          pos 40  */
{graphic,norm,0,p0,0xB0},      /* degree symbol                      pos 41  */
{graphic,norm,0,p0,0xA7},      /* section symbol                     pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
...
main ()
{
    ...
    fd = open("it_IT.ISO8859-1@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
