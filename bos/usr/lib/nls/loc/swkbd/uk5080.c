static char sccsid[] = "@(#)59  1.8  src/bos/usr/lib/nls/loc/swkbd/uk5080.c, lftdd, bos411, 9428A410j 10/25/93 16:04:37";
/*
...
{graphic,norm,0,p0,IC_LQUOT},  /* grave accent                       pos 1   */
...
{graphic,norm,0,p0,IC_AT},      /* @                                  pos 41  */
...
main ()
{
    ...
    fd = open("En_GB.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
