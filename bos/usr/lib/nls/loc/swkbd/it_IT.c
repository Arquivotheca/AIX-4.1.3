static char sccsid[] = "@(#)24  1.4  src/bos/usr/lib/nls/loc/swkbd/it_IT.c, lftdd, bos411, 9428A410j 10/25/93 15:57:53";
/*
...
main ()
{
    ...
    fd = open("it_IT.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
