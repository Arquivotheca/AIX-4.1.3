static char sccsid[] = "@(#)97  1.14  src/bos/usr/lib/nls/loc/swkbd/canada.c, lftdd, bos411, 9428A410j 10/25/93 15:26:57";
/*
...
{graphic,norm,0,p0,IC_POUND},   /* #                                 pos 1   */
...
{graphic,dead,0,p0,IC_CEDILLA}, /* cedilla accent                    pos 28  */
...
{graphic,norm,0,p0,IC_LANGQUO}, /* left angle quotes                 pos 45  */
...
{graphic,norm,0,p0,IC_LCEACC},  /* e acute small                     pos 55  */
...
{graphic,norm,0,p0,IC__},       /* _ (underscore)                     pos 12  */
...
{graphic,dead,0,p0,IC_AND},     /* circumflex accent                  pos 27  */
{graphic,dead,0,p0,IC_UMLAUT},  /* diaeresis accent                   pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,IC_RANGQUO}, /* right angle quotes                 pos 45  */
...
{graphic,norm,0,p0,IC_1QUOT},   /* '                                  pos 53  */
{graphic,norm,0,p0,IC_PERIOD},  /* .                                  pos 54  */
{graphic,norm,0,p0,IC_UCEACC},  /* E acute capital                    pos 55  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 56  */
...
{graphic,norm,0,p0,IC_PLSMNS}, /* plus or minus sign                  pos 2   */
{graphic,norm,0,p0,IC_AT},     /* @                                   pos 3   */
{graphic,norm,0,p0,IC_STRLNG}, /* pound sterling                      pos 4   */
{graphic,norm,0,p0,IC_CENT},   /* cent                                pos 5   */
{graphic,norm,0,p0,IC_INTLCU}, /* intl cur symbol                     pos 6   */
{graphic,norm,0,p0,IC_NOTSIGN}, /* notsign                            pos 7   */
{graphic,norm,0,p0,IC_VLBROK}, /* vert line broken                    pos 8   */
{graphic,norm,0,p0,IC_SSTWO},  /* superscript 2                       pos 9   */
{graphic,norm,0,p0,IC_SSTHRE}, /* superscript 3                       pos 10  */
{graphic,norm,0,p0,IC_QUARTER}, /* one quarter symbol                 pos 11  */
{graphic,norm,0,p0,IC_HALF},   /* one half symbol                     pos 12  */
{graphic,norm,0,p0,IC_3QUART}, /* three quarter symbol                pos 13  */
...
{graphic,norm,0,p0,IC_SECT},   /* section symbol                      pos 25  */
{graphic,norm,0,p0,IC_PARA},   /* paragraph symbol                    pos 26  */
...
{graphic,dead,0,p0,IC_APPROX}, /* tilde accent                        pos 40  */
{graphic,norm,0,p0,IC_LBRACE}, /* left brace                          pos 41  */
{graphic,dead,0,p0,IC_RBRACE}, /* right brace                         pos 42  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                              pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter        pos 44  */
{graphic,norm,0,p0,IC_DEGREE}, /* degree symbol                       pos 45  */
...
{graphic,norm,0,p0,IC_LCMU},   /* micro symbol                        pos 52  */
{graphic,norm,0,p0,IC_OVRBAR}, /* overline/overbar                    pos 53  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                              pos 54  */
{graphic,dead,0,p0,IC_ACUTE},  /* acute accent                        pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter       pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter           pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD             pos 59  */
...
main ()
{
    ...
    fd = open("Fr_CA.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&canada_key_map,sizeof(lft_swkbd_t));
