static char sccsid[] = "@(#)26  1.3  src/bos/usr/lib/nls/loc/swkbd/no_NO.c, lftdd, bos411, 9428A410j 10/25/93 16:00:26";
/*
...
{graphic,norm,0,p0,0xE5},      /* a overcircle small                pos 27  */
...
{graphic,norm,0,p0,0xF8},      /* o slash small                     pos 40  */
{graphic,norm,0,p0,0xE6},      /* ae dipthong small                 pos 41  */
...
{graphic,norm,0,p0,0xA4},       /* international curr.               pos 5   */
...
{graphic,norm,0,p0,0xD8},       /* O slash capital                   pos 40  */
{graphic,norm,0,p0,0xC6},       /* AE dipthong capital               pos 41  */
...
{graphic,norm,0,p0,0xA3},      /* Pounds Sterling                    pos 4   */
...
main ()
{
    ...
    fd = open("no_NO.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
