static char sccsid[] = "@(#)08  1.13  src/bos/usr/lib/nls/loc/swkbd/portugal.c, lftdd, bos411, 9428A410j 10/25/93 16:14:00";
/*
...
{graphic,norm,0,p0,IC_LANGQUO},/* left angle quotes                  pos 13  */
...
{graphic,dead,0,p0,IC_ACUTE},  /* acute accent                       pos 28  */
...
{graphic,norm,0,p0,IC_LCCCED}, /* c cedilla small                    pos 40  */
{graphic,norm,0,p0,IC_LCOUND}, /* ordinal ind masculine              pos 41  */
...
{graphic,norm,0,p0,IC_RANGQUO},/* right angle quotes                  pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 14  */
...
{graphic,dead,0,p0,IC_LQUOT},  /* grave accent                        pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
...
{graphic,norm,0,p0,IC_UCCCED}, /* C cedilla capital                   pos 40  */
{graphic,norm,0,p0,IC_LCAUND}, /* ordinal ind feminine                pos 41  */
...
{graphic,norm,0,p0,IC_SECT},   /* section symbol                     pos 5   */
...
main ()
{
    ...
    fd = open("Pt_PT.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
