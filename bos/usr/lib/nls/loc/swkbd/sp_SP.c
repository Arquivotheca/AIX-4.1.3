static char sccsid[] = "@(#)28  1.3  src/bos/usr/lib/nls/loc/swkbd/sp_SP.c, lftdd, bos411, 9428A410j 10/25/93 16:01:47";
/*
...
{graphic,norm,0,p0,0xBA},      /* masculine symbol                   pos 1   */
...
{graphic,norm,0,p0,0xA1},      /* inverted !                         pos 13  */
...
{graphic,norm,0,p0,0xF1},      /* n tilde small                      pos 40  */
{graphic,dead,0,p0,0xB4},      /* acute accent                       pos 41  */
{graphic,norm,0,p0,0xE7},      /* c cedilla small                    pos 42  */
...
{graphic,norm,0,p0,0xAA},      /* feminine symbol                    pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                  pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                  pos 3   */
{graphic,norm,0,p0,0xB7},      /* filled middle dot                  pos 4   */
...
{graphic,norm,0,p0,0xBF},      /* inverted ?                         pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
{graphic,norm,0,p0,0xD1},      /* N tilde capital                    pos 40  */
{graphic,dead,0,p0,0xA8},      /* diaeresis                          pos 41  */
{graphic,norm,0,p0,0xC7},      /* C cedilla capital                  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
...
{graphic,dead,0,p0,IC_APPROX}, /* tilde                              pos 5   */
...
main ()
{
    ...
    fd = open("es_ES.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
