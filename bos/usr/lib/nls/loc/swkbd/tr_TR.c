static char sccsid[] = "@(#)93  1.3  src/bos/usr/lib/nls/loc/swkbd/tr_TR.c, lftdd, bos411, 9428A410j 10/25/93 16:04:12";
/*
...
{graphic,norm,0,p0,IC_PLUS},   /* +                                  pos 1   */
...
{graphic,norm,0,p0,IC_SLASH},  /* /                                  pos 12  */
{graphic,norm,0,p0,IC_DASH},   /* -                                  pos 13  */
...
{graphic,norm,0,p0,IC_LCF},    /* f                                  pos 17  */
{graphic,norm,0,p0,IC_LCG},    /* g                                  pos 18  */
{graphic,dead,0,p0,0xF0},      /* g breve                            pos 19  */
{graphic,norm,0,p0,0xFD},      /* dotless i                          pos 20  */
{graphic,norm,0,p0,IC_LCO},    /* o                                  pos 21  */
{graphic,norm,0,p0,IC_LCD},    /* d                                  pos 22  */
{graphic,norm,0,p0,IC_LCR},    /* r                                  pos 23  */
{graphic,norm,0,p0,IC_LCN},    /* n                                  pos 24  */
{graphic,norm,0,p0,IC_LCH},    /* h                                  pos 25  */
{graphic,norm,0,p0,IC_LCP},    /* p                                  pos 26  */
{graphic,norm,0,p0,IC_LCQ},    /* q                                  pos 27  */
{graphic,norm,0,p0,IC_LCW},    /* w                                  pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
{graphic,norm,0,p0,IC_LCU},    /* u                                  pos 31  */
{graphic,norm,0,p0,IC_LCI},    /* i                                  pos 32  */
{graphic,norm,0,p0,IC_LCE},    /* e                                  pos 33  */
{graphic,norm,0,p0,IC_LCA},    /* a                                  pos 34  */
{graphic,norm,0,p0,0xFC},      /* u umlaut                           pos 35  */
{graphic,norm,0,p0,IC_LCT},    /* t                                  pos 36  */
{graphic,norm,0,p0,IC_LCK},    /* k                                  pos 37  */
{graphic,norm,0,p0,IC_LCM},    /* m                                  pos 38  */
{graphic,norm,0,p0,IC_LCL},    /* l                                  pos 39  */
{graphic,norm,0,p0,IC_LCY},    /* y                                  pos 40  */
{graphic,norm,0,p0,0xFE},      /* s cedilla small                    pos 41  */
{graphic,norm,0,p0,IC_LCX},    /* x                                  pos 42  */
...
{graphic,norm,0,p0,IC_LCJ},    /* j                                  pos 46  */
{graphic,norm,0,p0,0xF6},      /* o umlaut small                     pos 47  */
{graphic,norm,0,p0,IC_LCV},    /* v                                  pos 48  */
{graphic,norm,0,p0,IC_LCC},    /* c                                  pos 49  */
{graphic,norm,0,p0,0xE7},      /* c cedilla small                    pos 50  */
{graphic,norm,0,p0,IC_LCZ},    /* z                                  pos 51  */
{graphic,norm,0,p0,IC_LCS},    /* s                                  pos 52  */
{graphic,norm,0,p0,IC_LCB},    /* b                                  pos 53  */
{graphic,norm,0,p0,0x2E},      /* period                             pos 54  */
{graphic,norm,0,p0,0x2C},      /* comma                              pos 54  */
...
{graphic,norm,0,p0,IC_AST},    /* Asterisk                           pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                  pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* double quote                       pos 3   */
{graphic,dead,0,p0,IC_AND},    /* ^                                  pos 4   */
...
{graphic,norm,0,p0,0x5F},      /* _                                  pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},     /* Back Space                         pos 15  */
{ctlfunc,curs,0, 1,KF_CBT},    /* cursor Back Horizontal Tab         pos 16  */
{graphic,norm,0,p0,IC_UCF},    /* F                                  pos 17  */
{graphic,norm,0,p0,IC_UCG},    /* G                                  pos 18  */
{graphic,norm,0,p0,0xD0},      /* G breve capital                    pos 19  */
{graphic,norm,0,p0,IC_UCI},    /* I                                  pos 20  */
{graphic,norm,0,p0,IC_UCO},    /* O                                  pos 21  */
{graphic,norm,0,p0,IC_UCD},    /* D                                  pos 22  */
{graphic,norm,0,p0,IC_UCR},    /* R                                  pos 23  */
{graphic,norm,0,p0,IC_UCN},    /* N                                  pos 24  */
{graphic,norm,0,p0,IC_UCH},    /* H                                  pos 25  */
{graphic,norm,0,p0,IC_UCP},    /* P                                  pos 26  */
{graphic,norm,0,p0,IC_UCQ},    /* Q                                  pos 27  */
{graphic,norm,0,p0,IC_UCW},    /* W                                  pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
{graphic,norm,0,p0,IC_UCU},    /* U                                  pos 31  */
{graphic,norm,0,p0,0xDD},      /* i overdot capital                  pos 31  */
{graphic,norm,0,p0,IC_UCE},    /* E                                  pos 33  */
{graphic,norm,0,p0,IC_UCA},    /* A                                  pos 34  */
{graphic,norm,0,p0,0xDC},      /* U umlaut capital                   pos 35  */
{graphic,norm,0,p0,IC_UCT},    /* T                                  pos 36  */
{graphic,norm,0,p0,IC_UCK},    /* K                                  pos 37  */
{graphic,norm,0,p0,IC_UCM},    /* M                                  pos 38  */
{graphic,norm,0,p0,IC_UCL},    /* L                                  pos 39  */
{graphic,norm,0,p0,IC_UCY},    /* Y                                  pos 40  */
{graphic,norm,0,p0,0xDE},      /* S cedilla capital                  pos 41  */
{graphic,norm,0,p0,IC_UCX},    /* X                                  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                         pos 44  */
{graphic,norm,0,p0,IC_GT},     /* >                                  pos 45  */
{graphic,norm,0,p0,IC_UCJ},    /* J                                  pos 46  */
{graphic,norm,0,p0,0xD6},      /* o umlaut capital                   pos 47  */
{graphic,norm,0,p0,IC_UCV},    /* V                                  pos 48  */
{graphic,norm,0,p0,IC_UCC},    /* C                                  pos 49  */
{graphic,norm,0,p0,0xC7},      /* C cedilla capital                  pos 50  */
{graphic,norm,0,p0,IC_UCZ},    /* Z                                  pos 51  */
{graphic,norm,0,p0,IC_UCS},    /* S                                  pos 52  */
{graphic,norm,0,p0,IC_UCB},    /* B                                  pos 53  */
{graphic,norm,0,p0,0x3A},      /* :                                  pos 54  */
{graphic,norm,0,p0,0x3B},      /* ;                                  pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 2   */
{sgl_ctl,norm,0, 0,IC_NUL},    /* Null                              pos 3   */
{sgl_ctl,norm,0, 0,0x1E},      /* IS2                               pos 4   */
...
{sgl_ctl,norm,0, 0,0x1B},      /* escape                            pos 9   */
{sgl_ctl,norm,0, 0,0x1D},      /* IS3                               pos 10  */
{ctlfunc,cpfk,0, 0,KF_PF56},   /* PFK 56                            pos 11  */
{sgl_ctl,norm,0, 0,0x1C},      /* IS4                               pos 12  */
{sgl_ctl,norm,0, 0,0x1F},      /* IS1                               pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 14  */
{sgl_ctl,norm,0, 0,IC_DEL},    /* Delete                            pos 15  */
{ctlfunc,cpfk,0, 0,KF_PF72},   /* PFK 72                            pos 16  */
{sgl_ctl,norm,0, 0,IC_ACK},    /* Acknowledge                       pos 17  */
{sgl_ctl,norm,0, 0,IC_BEL},    /* Bell                              pos 18  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                            pos 19  */
{sgl_ctl,norm,0, 0,IC_HT},     /* Horizontal Tab                    pos 20  */
{sgl_ctl,norm,0, 0,IC_SI},     /* Shift In                          pos 21  */
{sgl_ctl,norm,0, 0,IC_EOT},    /* End of Transmission               pos 22  */
{sgl_ctl,norm,0, 0,IC_DC2},    /* Device control 2                  pos 23  */
{sgl_ctl,norm,0, 0,IC_SO},     /* Shift Out                         pos 24  */
{sgl_ctl,norm,0, 0,IC_BS},     /* Backspace                         pos 25  */
{sgl_ctl,norm,0, 0,IC_DLE},    /* Data Link Enable                  pos 26  */
{sgl_ctl,norm,0, 0,IC_DC1},    /* Device control 1                  pos 27  */
{sgl_ctl,norm,0, 0,IC_ETB},    /* End trans blk                     pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD               pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter       pos 30  */
{sgl_ctl,norm,0, 0,IC_NAK},    /* No Acknowledgment                 pos 31  */
{ctlfunc,cpfk,0, 0,KF_PF50},   /* PFK 50                            pos 32  */
{sgl_ctl,norm,0, 0,IC_ENQ},    /* Enquiry                           pos 33  */
{sgl_ctl,norm,0, 0,IC_SOH},    /* Start of Header                   pos 34  */
{ctlfunc,cpfk,0, 0,KF_PF54},   /* PFK 54                            pos 35  */
{sgl_ctl,norm,0, 0,IC_DC4},    /* Device control 4                  pos 36  */
{sgl_ctl,norm,0, 0,IC_VT},     /* Vertical Tab                      pos 37  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                   pos 38  */
{sgl_ctl,norm,0, 0,IC_FF},     /* Form Feed                         pos 39  */
{sgl_ctl,norm,0, 0,IC_EM},     /* End of Media                      pos 40  */
{ctlfunc,cpfk,0, 0,KF_PF96},   /* PFK 96                            pos 41  */
{ctlfunc,cpfk,0, 0,IC_CAN},    /* cancel                            pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                   pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                        pos 44  */
{ctlfunc,cpfk,0, 0,KF_PF69},   /* PFK 69                            pos 45  */
{sgl_ctl,norm,0, 0,IC_LF},     /* Line Feed                         pos 46  */
{ctlfunc,cpfk,0, 0,KF_PF108},  /* PFK 108                           pos 47  */
{sgl_ctl,norm,0, 0,IC_SYN},    /* Sync idle                         pos 48  */
{sgl_ctl,norm,0, 0,IC_ETX},    /* End of Text                       pos 49  */
{ctlfunc,cpfk,0, 0,KF_PF110},  /* PFK 110                           pos 50  */
{sgl_ctl,norm,0, 0,IC_SUB},    /* Substitute character              pos 51  */
{sgl_ctl,norm,0, 0,IC_DC3},    /* Device control 3                  pos 52  */
{sgl_ctl,norm,0, 0,IC_STX},    /* Start of Text                     pos 53  */
{ctlfunc,cpfk,0, 0,KF_PF112},  /* PFK 112                           pos 54  */
{ctlfunc,cpfk,0, 0,KF_PF55},   /* PFK 112                           pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter     pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter         pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 59  */
...
{ctlfunc,cpfk,0, 0,KF_PF90},   /* PFK 90                             pos 17  */
{ctlfunc,cpfk,0, 0,KF_PF91},   /* PFK 91                             pos 18  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 19  */
{ctlfunc,cpfk,0, 0,KF_PF81},   /* PFK 81                             pos 20  */
{ctlfunc,cpfk,0, 0,KF_PF82},   /* PFK 82                             pos 21  */
{ctlfunc,cpfk,0, 0,KF_PF89},   /* PFK 89                             pos 22  */
{ctlfunc,cpfk,0, 0,KF_PF77},   /* PFK 77                             pos 23  */
{ctlfunc,cpfk,0, 0,KF_PF106},  /* PFK 106                            pos 24  */
{ctlfunc,cpfk,0, 0,KF_PF92},   /* PFK 92                             pos 25  */
{ctlfunc,cpfk,0, 0,KF_PF83},   /* PFK 83                             pos 26  */
{es_func,norm,0, 1,KF_PF74},   /* PFK 74                             pos 27  */
{ctlfunc,cpfk,0, 0,KF_PF75},   /* PFK 75                             pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
{ctlfunc,cpfk,0, 0,KF_PF80},   /* PFK 80                             pos 31  */
{ctlfunc,cpfk,0, 0,KF_PF99},   /* PFK 99                             pos 32  */
{ctlfunc,cpfk,0, 0,KF_PF76},   /* PFK 76                             pos 33  */
{ctlfunc,cpfk,0, 0,KF_PF87},   /* PFK 87                             pos 34  */
{ctlfunc,cpfk,0, 0,KF_PF84},   /* PFK 84                             pos 35  */
{ctlfunc,cpfk,0, 0,KF_PF78},   /* PFK 78                             pos 36  */
{ctlfunc,cpfk,0, 0,KF_PF94},   /* PFK 94                             pos 37  */
{ctlfunc,cpfk,0, 0,KF_PF107 }, /* PFK 107                            pos 38  */
{ctlfunc,cpfk,0, 0,KF_PF95},   /* PFK 95                             pos 39  */
{ctlfunc,cpfk,0, 0,KF_PF79},   /* PFK 79                             pos 40  */
{ctlfunc,cpfk,0, 0,KF_PF97},   /* PFK 97                             pos 41  */
{ctlfunc,cpfk,0, 0,KF_PF102},  /* PFK 102                            pos 42  */
{ctlfunc,cpfk,0, 0,KF_PF100},  /* PFK 100                            pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{ctlfunc,cpfk,0, 0,KF_PF115},  /* PFK 115                            pos 45  */
{ctlfunc,cpfk,0, 0,KF_PF93},   /* PFK 93                             pos 46  */
{ctlfunc,cpfk,0, 0,KF_PF109},  /* PFK 109                            pos 47  */
{ctlfunc,cpfk,0, 0,KF_PF104},  /* PFK 104                            pos 48  */
{ctlfunc,cpfk,0, 0,KF_PF103},  /* PFK 103                            pos 49  */
{ctlfunc,cpfk,0, 0,KF_PF111},  /* PFK 111                            pos 50  */
{ctlfunc,cpfk,0, 0,KF_PF101},  /* PFK 101                            pos 51  */
{ctlfunc,cpfk,0, 0,KF_PF88},   /* PFK 88                             pos 52  */
{ctlfunc,cpfk,0, 0,KF_PF105},  /* PFK 105                            pos 53  */
{ctlfunc,cpfk,0, 0,KF_PF113},  /* PFK 113                            pos 54  */
{ctlfunc,cpfk,0, 0,KF_PF85},   /* PFK 85                             pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 59  */
...
{graphic,norm,0,p0,0xAC},      /* logical not                        pos 1   */
{graphic,norm,0,p0,0xB9},      /* superscript one                    pos 2   */
{graphic,norm,0,p0,0xB2},      /* superscript two                    pos 3   */
{graphic,norm,0,p0,0x23},      /* number sign                        pos 4   */
{graphic,norm,0,p0,0xBC},      /* one quarter                        pos 5   */
{graphic,norm,0,p0,0xBD},      /* one half                           pos 6   */
{graphic,norm,0,p0,0xBE},      /* three quarters                     pos 7   */
{graphic,norm,0,p0,0x7B},      /* {                                  pos 8   */
{graphic,norm,0,p0,0x5B},      /* [                                  pos 9   */
{graphic,norm,0,p0,0x5D},      /* ]                                  pos 10  */
{graphic,norm,0,p0,0x7D},      /* }                                  pos 11  */
{graphic,norm,0,p0,0x5C},      /* \                                  pos 12  */
{graphic,dead,0,p0,0xB8},      /* cedilla accent                     pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 15  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 16  */
{graphic,norm,0,p0,0x40},      /* @                                  pos 17  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 18  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 19  */
{graphic,norm,0,p0,0xB6},      /* paragraph symbol                   pos 20  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 21  */
{graphic,norm,0,p0,0xA5},      /* yen sign                           pos 22  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 23  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 24  */
{graphic,norm,0,p0,0xF8},      /* o slash small                      pos 25  */
{graphic,norm,0,p0,0xA3},      /* english pound sign                 pos 26  */
{graphic,dead,0,p0,0xA8},      /* umlaut                             pos 27  */
{graphic,dead,0,p0,0x7E},      /* tilde                              pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
{graphic,norm,0,p0,0xE6},      /* ae dipthong                        pos 31  */
{graphic,norm,0, p0,0xDF},     /* s sharp                            pos 32  */
...
{graphic,dead,0,p0,0xB4},      /* acute accent                       pos 40  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{graphic,norm,0,p0,0x7C},      /* |                                  pos 45  */
{graphic,norm,0,p0,0xAB},      /* <<                                 pos 46  */
{graphic,norm,0,p0,0xBB},      /* >>                                 pos 47  */
{graphic,norm,0,p0,0xA2},      /* cent sign                          pos 48  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 49  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 50  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 51  */
{graphic,norm,0,p0,0xB5},      /* micro symbol                       pos 52  */
{graphic,norm,0,p0,0xD7},      /* multiply sign                      pos 53  */
{graphic,norm,0,p0,0xF7},      /* divide sign                        pos 54  */
{graphic,norm,0,p0,0xAD},      /* syllable hyphen                    pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 59  */
...
main ()
{
    ...
    fd = open("tr_TR.ISO8859-9@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&turkish_key_map,sizeof(lft_swkbd_t));
