static char sccsid[] = "@(#)09  1.14  src/bos/usr/lib/nls/loc/swkbd/spain.c, lftdd, bos411, 9428A410j 10/25/93 16:02:20";
/*
...
{graphic,norm,0,p0,IC_LCOUND}, /* masculine symbol                   pos 1   */
...
{graphic,norm,0,p0,IC_LCCCED}, /* c cedilla small                    pos 42  */
...
{graphic,norm,0,p0,IC_LCAUND}, /* feminine symbol                    pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                  pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                  pos 3   */
{graphic,norm,0,p0,IC_MDDOTF}, /* filled middle dot                  pos 4   */
...
{graphic,dead,0,p0,IC_UMLAUT}, /* diaeresis                          pos 41  */
{graphic,norm,0,p0,IC_UCCCED}, /* C cedilla capital                  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
...
main ()
{
    ...
    fd = open("Es_ES.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
