static char sccsid[] = "@(#)54  1.5  src/bos/usr/lib/nls/loc/swkbd/ko_KR.c, lftdd, bos411, 9428A410j 3/23/94 13:51:52";
/*
...
{graphic,norm,0,p0,IC_EQ},     /* equals                            pos 13  */
{graphic,norm,0,p0,0x5c},      /* Won Symbol                        pos 14  */
...
{graphic,norm,0,p0,0x7c},      /* pipe symbol                       pos 42  */
...
{graphic,norm,0,p0,IC_APPROX}, /* tilde                              pos 1   */
...
{graphic,norm,0,p0,IC_AND},    /* circumflex                         pos 7   */
...
{graphic,norm,0,p0,0x7c},      /* Vertical Bar (Registration)        pos 14  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* cent symbol (N/A in ASC & KSC)     pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* logical not (N/A in ASC & KSC)     pos 56  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 133   */
           ...
           {
/*---------------------------------------------------------------------------
                 ALT KEY ASSIGNMENTS  ----  Main key bank  (Modified One)
---------------------------------------------------------------------------*/
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 0   */
...
{ctlfunc,cpfk,0, 0,KF_IGNORE}, /* not available                      pos 14  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 29  */
{ctlfunc,cpfk,0, 0,KF_IGNORE}, /* not available                      pos 30  */
...
{ctlfunc,cpfk,0, 0,KF_IGNORE}, /* not available                      pos 42  */
...
main ()
{
    ...
    fd = open("ko_KR.IBM-eucKR.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&korean_key_map,sizeof(lft_swkbd_t));
