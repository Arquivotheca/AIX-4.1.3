static char sccsid[] = "@(#)12  1.6  src/bos/usr/lib/nls/loc/swkbd/en_UK@5080.c, lftdd, bos411, 9428A410j 10/25/93 15:31:11";
/*
...
{graphic,norm,0,p0,0x60},      /* grave accent                       pos 1   */
...
{graphic,norm,0,p0,0xAC},       /* notsign                            pos 1   */
...
main ()
{
    ...
    fd = open("en_GB.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
