static char sccsid[] = "@(#)65	1.2  src/bos/usr/lib/nls/loc/swkbd/hu_HU.c, lftdd, bos411, 9428A410j 10/27/93 13:28:32";
/*
 * COMPONENT_NAME: (LFTDD) Low Function Terminal - hu_HU.c
 *
 * ORIGINS: 27
 *
...
{graphic,norm,0,p0,0xA7},      /* section symbol                      pos 1   */
{graphic,norm,0,p0,IC_1QUOT},  /* '                                   pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                   pos 3   */
{graphic,norm,0,p0,IC_PLUS},   /* +                                   pos 4   */
{graphic,norm,0,p0,IC_EXC},    /* !                                   pos 5   */
{graphic,norm,0,p0,IC_PERCENT},/* %                                   pos 6   */
{graphic,norm,0,p0,IC_SLASH},  /* /                                   pos 7   */
{graphic,norm,0,p0,IC_EQ},     /* =                                   pos 8   */
{graphic,norm,0,p0,IC_LPAR},   /* (                                   pos 9   */
{graphic,norm,0,p0,IC_RPAR},   /* )                                   pos 10  */
{graphic,norm,0,p0,0xD6},      /* O diaresis capital                  pos 11  */
{graphic,norm,0,p0,0xDC},      /* U diaresis capital                  pos 12  */
{graphic,norm,0,p0,0xD3},      /* O acute capital                     pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 14  */
...
{graphic,norm,0,p0,0xD5},      /* O double acute capital              pos 27  */
{graphic,norm,0,p0,0xDA},      /* U acute  capital                    pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
...
{graphic,norm,0,p0,0xC9},      /* E acute capital                     pos 40  */
{graphic,norm,0,p0,0xC1},      /* A acute capital                     pos 41  */
{graphic,norm,0,p0,0xDB},      /* U double acute capital              pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{graphic,norm,0,p0,0xCD},      /* I acute capital                     pos 45  */
...
{graphic,norm,0,p0,IC_QUES},   /* ?                                   pos 53  */
...
{graphic,norm,0,p0,IC_DOLLAR}, /* dollar sign                        pos 40  */
...
{graphic,norm,0,p0,IC_GT},     /* >                                  pos 46  */
{graphic,norm,0,p0,IC_POUND},  /* pound sign                         pos 47  */
{graphic,norm,0,p0,IC_AMP},    /* ampersand                          pos 48  */
...
{graphic,norm,0,p0,IC_AST},    /* *                                  pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
...
main ()
{
    ...
    fd = open("hu_HU.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&hungarian_key_map,sizeof(lft_swkbd_t));
