static char sccsid[] = "@(#)03  1.5  src/bos/usr/lib/nls/loc/swkbd/netherlands.c, lftdd, bos411, 9440B411a 10/7/94 09:11:29";
/*
...
lft_swkbd_t netherlands_key_map = {
       {'i','b','m','-','8','5','0','\0'},
       {'N','l','_','N','L','\0','\0','\0'},
       {
...
{graphic,norm,0,p0,0xF8},      /* degree symbol                     pos 13  */
...
{graphic,dead,0,p0,0xF9},      /* umlaut accent                     pos 27  */
...
{graphic,norm,0,p0,0xF5},      /* section symbol                     pos 1   */
{graphic,norm,0,p0,0x21},      /* !                                  pos 2   */
...
{graphic,norm,0,p0,0x5f},      /* _                                  pos 8   */
{graphic,norm,0,p0,IC_LPAR},   /* (                                  pos 9   */
{graphic,norm,0,p0,IC_RPAR},   /* )                                  pos 10  */
{graphic,norm,0,p0,IC_1QUOT},  /* quote/apostrophe                   pos 11  */
{graphic,norm,0,p0,IC_QUES},   /* ?                                  pos 12  */
{graphic,dead,0,p0,0x7e},      /* tilde accent                       pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
{graphic,norm,0,p0,0x7C},      /* pipe symbol                        pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,0xF1},      /* plus or minus                      pos 40  */
{graphic,dead,0,p0,0x60},      /* grave accent                       pos 41  */
{graphic,norm,0,p0,IC_GT},     /* >                                  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* sshift left                        pos 44  */
{graphic,norm,0,p0,0x5b},      /* [                                  pos 45  */
...
{sgl_ctl,norm,0, 0,IC_ETB},    /* end of blk                         pos 18  */
...
{sgl_ctl,norm,0, 0,IC_SS2},    /* info sep 2                         pos 27  */
...
{sgl_ctl,norm,0, 0,IC_SS3},    /* info sep 3                         pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{sgl_ctl,norm,0, 0,IC_ESC},    /* escape                             pos 45  */
...
{ctlfunc,cpfk,0, 0,KF_PF84},   /* PFK 84                             pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{ctlfunc,cpfk,0, 0,KF_PF85},   /* PFK 85                             pos 42  */
...
{graphic,norm,0,p0,0xAA},      /* logical not                        pos 1   */
{graphic,norm,0,p0,0xFB},      /* 1 superscript                      pos 2   */
{graphic,norm,0,p0,0xFD},      /* 2 superscript                      pos 3   */
{graphic,norm,0,p0,0xFC},      /* 3 superscript                      pos 4   */
{graphic,norm,0,p0,0xAC},      /* One-quarter                        pos 5   */
{graphic,norm,0,p0,0xAB},      /* One-half                           pos 6   */
{graphic,norm,0,p0,0xF3},      /* Three-quarters                     pos 7   */
{graphic,norm,0,p0,0x9C},      /* pound sterling                     pos 8   */
{graphic,norm,0,p0,0x7B},      /* {                                  pos 9   */
{graphic,norm,0,p0,0x7D},      /* }                                  pos 10  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 11  */
{graphic,norm,0,p0,0x5C},      /* \                                  pos 12  */
{graphic,dead,0,p0,0xF7},      /* cedilla accent                     pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
{graphic,norm,0, p0,0xF4},     /* Paragraph symbol                   pos 20  */
...
{graphic,norm,0,p0,0xE1},      /* sharp s small                      pos 32  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{graphic,norm,0,p0,0xDD},      /* vertical line broken               pos 45  */
{graphic,norm,0,p0,0xAE},      /* left angle quotes                  pos 46  */
{graphic,norm,0,p0,0xAF},      /* right angle quotes                 pos 47  */
{graphic,norm,0,p0,0xBD},      /* cent sign                          pos 48  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 49  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 50  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 51  */
{graphic,norm,0,p0,0xE6},      /* micro sign                         pos 52  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 53  */
{graphic,norm,0,p0,0xFA},      /* middle dot                         pos 54  */
...
main ()
{
...
#ifdef NL_ALTERNATE
    fd = open("Nl_NL.IBM-850@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
#else /* no NL_ALTERNATE */
    fd = open("Nl_NL.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
#endif /* no NL_ALTERNATE */
    if (fd == -1) {
    ...
    rc = write(fd,&netherlands_key_map,sizeof(lft_swkbd_t));
