static char sccsid[] = "@(#)03	1.1  src/bos/usr/lib/nls/loc/swkbd/ja_JP@alt.c, lftdd, bos411, 9434B411a 8/25/94 05:11:22";
/*
...
main ()
{
    ...
    fd = open("ja_JP.IBM-eucJP@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
