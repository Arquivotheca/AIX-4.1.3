static char sccsid[] = "@(#)07  1.13  src/bos/usr/lib/nls/loc/swkbd/norway.c, lftdd, bos411, 9428A410j 10/25/93 16:00:41";
/*
...
{graphic,norm,0,p0,IC_BSLASH}, /* reverse slash                     pos 13  */
...
{graphic,norm,0,p0,IC_LCAOVC}, /* overcircle small                  pos 27  */
...
{graphic,norm,0,p0,IC_LCOSLS}, /* o slash small                     pos 40  */
{graphic,norm,0,p0,IC_LCAE},   /* ae dipthong small                 pos 41  */
{graphic,norm,0,p0,IC_1QUOT},  /* quote/apostrophe                  pos 42  */
...
{graphic,norm,0,p0,IC_POUND},   /* number sign                       pos 4   */
{graphic,norm,0,p0,IC_INTLCU},  /* international curr.               pos 5   */
...
{graphic,norm,0,p0,IC_UCOSLS},  /* O slash capital                   pos 40  */
{graphic,norm,0,p0,IC_UCAE},    /* AE dipthong capital               pos 41  */
...
{sgl_ctl,norm,0, 0,IC_SS4},    /* ss4                               pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 14  */
...
{graphic,norm,0,p0,IC_STRLNG}, /* Pounds Sterling                    pos 4   */
{graphic,norm,0,p0,IC_DOLLAR}, /* Dollar sign                        pos 5   */
...
main ()
{
    ...
    fd = open("No_NO.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&norway_key_map,sizeof(lft_swkbd_t));
