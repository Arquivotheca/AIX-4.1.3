static char sccsid[] = "@(#)58  1.7  src/bos/usr/lib/nls/loc/swkbd/it5080.c, lftdd, bos411, 9428A410j 10/25/93 15:57:22";
/*
...
{graphic,norm,0,p0,IC_LCIGRV}, /* i grave accent                    pos 13  */
...
{graphic,norm,0,p0,IC_LCEGRV}, /* e grave accent                    pos 27  */
...
{graphic,norm,0,p0,IC_LCOGRV}, /* o grave accent                    pos 40  */
{graphic,norm,0,p0,IC_LCAGRV}, /* a grave accent                    pos 41  */
{graphic,norm,0,p0,IC_LCUGRV}, /* u grave accent                    pos 42  */
...
{graphic,norm,0,p0,IC_LCEACC}, /* e acute accent                     pos 27  */
...
{graphic,norm,0,p0,IC_LCCCED}, /* c cedilla                          pos 40  */
{graphic,norm,0,p0,IC_DEGREE}, /* degree symbol                      pos 41  */
{graphic,norm,0,p0,IC_SECT},   /* section symbol                     pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
...
{sgl_ctl,norm,0, 0,IC_SUB},    /* Substitute                        pos 46  */
...
{graphic,norm,0,p0,IC_LBRACE}, /* left brace                         pos 9   */
{graphic,norm,0,p0,IC_RBRACE}, /* right brace                        pos 10  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 11  */
{graphic,norm,0,p0,IC_APPROX}, /* tilde                              pos 12  */
...
{graphic,norm,0,p0,IC_AT},     /* @                                  pos 40  */
{graphic,norm,0,p0,IC_POUND},  /* #                                  pos 41  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* VTRM Next Window key; do not alter pos 64  */
     /*    ALT KEY ASSIGNMENTS  ----  Function keys bank    */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 65  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 66  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 67  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 68  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 69  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 70  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 71  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 72  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 73  */
{es_func,norm,1,KF_IGNORE}, /* not available                 pos 74  */
    /*       ALT KEY ASSIGNMENTS  ----  cursor keys bank   */
...
main ()
{
    ...
    fd = open("It_IT.IBM-850@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&italian_key_map,sizeof(lft_swkbd_t));
