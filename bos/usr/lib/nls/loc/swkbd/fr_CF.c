static char sccsid[] = "@(#)15  1.3  src/bos/usr/lib/nls/loc/swkbd/fr_CF.c, lftdd, bos411, 9428A410j 10/25/93 15:35:31";
/*
...
{graphic,dead,0,p0,0xB8},       /* cedilla accent                    pos 28  */
...
{graphic,norm,0,p0,0xAB},       /* left angle quotes                 pos 45  */
...
{graphic,norm,0,p0,0xE9},       /* e acute small                     pos 55  */
...
{graphic,norm,0,p0,0xBB},       /* right angle quotes                 pos 45  */
...
{graphic,norm,0,p0,IC_PERIOD},  /* .                                  pos 54  */
{graphic,norm,0,p0,0xC9},       /* E acute capital                    pos 55  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 56  */
...
{graphic,norm,0,p0,0xB1},      /* plus or minus sign                  pos 2   */
{graphic,norm,0,p0,IC_AT},     /* @                                   pos 3   */
{graphic,norm,0,p0,0xA3},      /* pound sterling                      pos 4   */
{graphic,norm,0,p0,0xA2},      /* cent                                pos 5   */
{graphic,norm,0,p0,0xA4},      /* intl cur symbol                     pos 6   */
{graphic,norm,0,p0,0xAC},      /* notsign                            pos 7   */
{graphic,norm,0,p0,0xA6},      /* vert line broken                    pos 8   */
{graphic,norm,0,p0,0xB2},      /* superscript 2                       pos 9   */
{graphic,norm,0,p0,0xB3},      /* superscript 3                       pos 10  */
{graphic,norm,0,p0,0xBC},      /* one quarter symbol                 pos 11  */
{graphic,norm,0,p0,0xBD},      /* one half symbol                     pos 12  */
{graphic,norm,0,p0,0xBE},      /* three quarter symbol                pos 13  */
...
{graphic,norm,0,p0,0xA7},      /* section symbol                      pos 25  */
{graphic,norm,0,p0,0xB6},      /* paragraph symbol                    pos 26  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter        pos 44  */
{graphic,norm,0,p0,0xB0},      /* degree symbol                       pos 45  */
...
{graphic,norm,0,p0,0xAF},      /* overline/overbar                    pos 53  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                              pos 54  */
{graphic,dead,0,p0,0xB4},      /* acute accent                        pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter       pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter           pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD             pos 59  */
...
main ()
{
    ...
    fd = open("fr_CA.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
