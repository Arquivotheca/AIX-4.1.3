static char sccsid[] = "@(#)64	1.3  src/bos/usr/lib/nls/loc/swkbd/hr_HR.c, lftdd, bos411, 9428A410j 4/8/94 13:58:34";
/*
...
{graphic,norm,0,p0,0xB9},       /* s caron small                 pos 27  */
...
main ()
{
    ...
    fd = open("hr_HR.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&croatian_key_map,sizeof(lft_swkbd_t));
