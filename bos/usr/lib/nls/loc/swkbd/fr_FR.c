static char sccsid[] = "@(#)16  1.4  src/bos/usr/lib/nls/loc/swkbd/fr_FR.c, lftdd, bos411, 9428A410j 10/25/93 15:35:55";
/*
...
{graphic,norm,0,p0,0xB5},      /* greek mu                          pos 42  */
...
main ()
{
    ...
    fd = open("fr_FR.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
