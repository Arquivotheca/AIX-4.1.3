static char sccsid[] = "@(#)20  1.7  src/bos/usr/lib/nls/loc/swkbd/gk_GK.c, lftdd, bos411, 9428A410j 10/25/93 16:13:24";
/*
...
{graphic,norm,0,p0,0x5B},       /* [                             pos 27  */
{graphic,norm,0,p0,0x5D},       /* ]                             pos 28  */
...
{graphic,norm,0,p0,0xB4},       /* acute accent                  pos 40  */
{graphic,norm,0,p0,0x5E},       /* ^                             pos 41  */
{graphic,norm,0,p0,0x60},       /* `                             pos 42  */
...
{graphic,norm,0,p0,0xA8},      /* umlaut                              pos 40  */
{graphic,dead,0,p0,0x7E},      /* ~                                   pos 41  */
...
{graphic,dead,0,p0,0xB5},      /* acute and umlaut                   pos 40  */
...
/* BASE KEY ASSIGNMENTS  ----  Main key bank    */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore, not on keyboard       pos 0   */
{graphic,norm,0,p0,0xBD},       /* one half                      pos 1   */
{graphic,norm,0,p0,IC_1},       /* 1                             pos 2   */
{graphic,norm,0,p0,IC_2},       /* 2                             pos 3   */
{graphic,norm,0,p0,IC_3},       /* 3                             pos 4   */
{graphic,norm,0,p0,IC_4},       /* 4                             pos 5   */
...
{sgl_ctl,curs,0, 0,IC_BS},      /* Backspace                     pos 15  */
{sgl_ctl,curs,0, 0,IC_HT},      /*  horizontal tab               pos 16  */
{graphic,norm,0,p0,0xB7},       /* middle dot                    pos 17  */
{graphic,norm,0,p0,0xF2},       /* sigma small                   pos 18  */
{graphic,norm,0,p0,0xE5},       /* epsilon small                 pos 19  */
{graphic,norm,0,p0,0xF1},       /* rho small                     pos 20  */
{graphic,norm,0,p0,0xF4},       /* tau small                     pos 21  */
{graphic,norm,0,p0,0xF5},       /* upsilon small                 pos 22  */
{graphic,norm,0,p0,0xE8},       /* theta small                   pos 23  */
{graphic,norm,0,p0,0xE9},       /* iota small                    pos 24  */
{graphic,norm,0,p0,0xEF},       /* omicron small                 pos 25  */
{graphic,norm,0,p0,0xF0},       /* pi small                      pos 26  */
{graphic,norm,0,p0,0x5B},       /* [                             pos 27  */
{graphic,norm,0,p0,0x5D},       /* ]                             pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* not avail on WT KBD           pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key; do not alter   pos 30  */
{graphic,norm,0,p0,0xE1},       /* alpha small                   pos 31  */
{graphic,norm,0,p0,0xF3},       /* sigma small                   pos 32  */
{graphic,norm,0,p0,0xE4},       /* delta small                   pos 33  */
{graphic,norm,0,p0,0xF6},       /* phi small                     pos 34  */
{graphic,norm,0,p0,0xE3},       /* gamma small                   pos 35  */
{graphic,norm,0,p0,0xE7},       /* eta small                     pos 36  */
{graphic,norm,0,p0,0xEE},       /* xi small                      pos 37  */
{graphic,norm,0,p0,0xEA},       /* kappa small                   pos 38  */
{graphic,norm,0,p0,0xEB},       /* lambda small                  pos 39  */
{graphic,dead,0,p0,0xB4},       /* acute accent                  pos 40  */
{graphic,norm,0,p0,0xA2},       /* right single quote            pos 41  */
{graphic,norm,0,p0,0xB2},       /* superscript 2                 pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return               pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter  pos 44  */
{graphic,norm,0,p0,0xA7},       /* section symbol                pos 45  */
{graphic,norm,0,p0,0xE6},       /* zeta small                    pos 46  */
{graphic,norm,0,p0,0xF7},       /* chi small                     pos 47  */
{graphic,norm,0,p0,0xF8},       /* psi small                     pos 48  */
{graphic,norm,0,p0,0xF9},       /* omega small                   pos 49  */
{graphic,norm,0,p0,0xE2},       /* beta small                    pos 50  */
{graphic,norm,0,p0,0xED},       /* nu small                      pos 51  */
{graphic,norm,0,p0,0xEC},       /* mu small                      pos 52  */
...
---------------------------------------------------------------------------*/
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 0   */
{graphic,dead,0,p0,0xB1},      /* plus or minus sign                  pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                   pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                   pos 3   */
{graphic,norm,0,p0,0xA3},      /* pound sterling                      pos 4   */
{graphic,norm,0,p0,IC_DOLLAR}, /* $                                   pos 5   */
{graphic,norm,0,p0,IC_PERCENT},/* %                                   pos 6   */
{graphic,norm,0,p0,0xAC},      /* logical not                         pos 7   */
{graphic,norm,0,p0,IC_SLASH},  /* /                                   pos 8   */
{graphic,norm,0,p0,IC_LPAR},   /* (                                   pos 9   */
{graphic,norm,0,p0,IC_RPAR},   /* )                                   pos 10  */
{graphic,norm,0,p0,IC_EQ},     /* =                                   pos 11  */
{graphic,norm,0,p0,0xB0},      /* degree symbol                       pos 12  */
{graphic,dead,0,p0,0x2A},      /* *                                   pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},     /* Back Space                          pos 15  */
{ctlfunc,curs,0, 1,KF_CBT},    /* cursor Back Horizontal Tab          pos 16  */
{graphic,norm,0,p0,0xAF},      /* long dash                           pos 17  */
{graphic,norm,0,p0,0xA6},      /* vertical line broken                pos 18  */
{graphic,norm,0,p0,0xC5},      /* epsilon capital                     pos 19  */
{graphic,norm,0,p0,0xD1},      /* rho capital                         pos 20  */
{graphic,norm,0,p0,0xD4},      /* tau capital                         pos 21  */
{graphic,norm,0,p0,0xD5},      /* upsilon capital                     pos 22  */
{graphic,norm,0,p0,0xC8},      /* theta capital                       pos 23  */
{graphic,norm,0,p0,0xC9},      /* iota capital                        pos 24  */
{graphic,norm,0,p0,0xCF},      /* omicron capital                     pos 25  */
{graphic,norm,0,p0,0xD0},      /* pi capital                          pos 26  */
{graphic,norm,0,p0,0xAB},      /* left angle quotes                   pos 27  */
{graphic,norm,0,p0,0xBB},      /* right angle quotes                  pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
{graphic,norm,0,p0,0xC1},      /* alpha capital                       pos 31  */
{graphic,norm,0,p0,0xD3},      /* sigma capital                       pos 32  */
{graphic,norm,0,p0,0xC4},      /* delta capital                       pos 33  */
{graphic,norm,0,p0,0xD6},      /* phi capital                         pos 34  */
{graphic,norm,0,p0,0xC3},      /* gamma capital                       pos 35  */
{graphic,norm,0,p0,0xC7},      /* eta capital                         pos 36  */
{graphic,norm,0,p0,0xCE},      /* xi capital                          pos 37  */
{graphic,norm,0,p0,0xCA},      /* kappa capital                       pos 38  */
{graphic,norm,0,p0,0xCB},      /* lambda capital                      pos 39  */
{graphic,dead,0,p0,0xA8},      /* umlaut accent                       pos 40  */
{graphic,norm,0,p0,0xA1},      /* left single quote                   pos 41  */
{graphic,norm,0,p0,0xB3},      /* superscript 3                       pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{graphic,norm,0,p0,0xA9},      /* copyright symbol                    pos 45  */
{graphic,norm,0,p0,0xC6},      /* zeta capital                        pos 46  */
{graphic,norm,0,p0,0xD7},      /* chi capital                         pos 47  */
{graphic,norm,0,p0,0xD8},      /* psi capital                         pos 48  */
{graphic,norm,0,p0,0xD9},      /* omega capital                       pos 49  */
{graphic,norm,0,p0,0xC2},      /* beta capital                        pos 50  */
{graphic,norm,0,p0,0xCD},      /* nu capital                          pos 51  */
{graphic,norm,0,p0,0xCC},      /* mu capital                          pos 52  */
{graphic,norm,0,p0,IC_SEMI},   /* ;                                   pos 53  */
{graphic,norm,0,p0,IC_COLON},  /* :                                   pos 54  */
{graphic,norm,0,p0,0x5F},      /* _                                   pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
...
main ()
{
    ...
    fd = open("el_GR.ISO8859-7.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&greek_key_map,sizeof(lft_swkbd_t));
