static char sccsid[] = "@(#)69  1.3  src/bos/usr/lib/nls/loc/swkbd/ru101.c, lftdd, bos411, 9428A410j 4/14/94 13:45:58";
/*
...
{graphic,norm,0,p0,IC_LQUOT},   /* `                         1   pos 1   */
{graphic,norm,0,p0,IC_1},       /* 1                         0   pos 2   */
{graphic,norm,0,p0,IC_2},       /* 2                      4  0   pos 3   */
...
{graphic,norm,0,p0,IC_RSB},     /* ]                         1   pos 28  */
{graphic,norm,0,p0,IC_BSLASH},  /* \                         0   pos 29  */
...
{graphic,norm,0,p0,IC_SEMI},    /* ;                         1   pos 40  */
{graphic,norm,0,p0,IC_1QUOT},   /* '                         1   pos 41  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore - not on 101 kbd   0   pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return        c  0   pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key;           0   pos 44  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore - not on 101 kbd   0   pos 45  */
...
{graphic,norm,0,p0,IC_SLASH},   /* /                      e  0   pos 55  */
...
{graphic,norm,0,p0,IC_LBRACE}, /* {                                   pos 27  */
{graphic,norm,0,p0,IC_RBRACE}, /* }                                   pos 28  */
{graphic,norm,0,p0,IC_OR},     /* |                                   pos 29  */
...
{graphic,norm,0,p0,IC_COLON},  /* :                                   pos 40  */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                   pos 41  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore - not on 101 kbd             pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore - not on 101 kbd             pos 45  */
...
{graphic,norm,0,p0,IC_AND},    /* ^                                  pos 7   */
{graphic,norm,0, 1,IC_AMP},    /* &                                  pos 8   */
{graphic,norm,0, 1,IC_DOLLAR}, /* $                                  pos 9   */
...
{graphic,norm,0,p0,IC_LSB},    /* [                                  pos 27  */
{graphic,norm,0,p0,IC_RSB},    /* ]                                  pos 28  */
...
{graphic,norm,0,p0,IC_OR},     /* |                                  pos 41  */
...
{graphic,norm,0,p0,0xF1},       /* e diaeresis small             pos 1   */
...
{graphic,norm,0,p0,IC_EQ},      /* =                             pos 13  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                 pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},      /* Backspace                     pos 15  */
{sgl_ctl,curs,0, 0,IC_HT},      /*  horizontal tab               pos 16  */
{graphic,norm,0,p0,0xD9},       /* shorti small                  pos 17  */
{graphic,norm,0,p0,0xE6},       /* tse small                     pos 18  */
{graphic,norm,0,p0,0xE3},       /* u small                       pos 19  */
{graphic,norm,0,p0,0xDA},       /* ka small                      pos 20  */
{graphic,norm,0,p0,0xD5},       /* ie small                      pos 21  */
{graphic,norm,0,p0,0xDD},       /* en small                      pos 22  */
{graphic,norm,0,p0,0xD3},       /* ghe small                     pos 23  */
{graphic,norm,0,p0,0xE8},       /* sha small                     pos 24  */
{graphic,norm,0,p0,0xE9},       /* shcha small                   pos 25  */
{graphic,norm,0,p0,0xD7},       /* ze small                      pos 26  */
{graphic,norm,0,p0,0xE5},       /* ha small                      pos 27  */
{graphic,norm,0,p0,0xEA},       /* hardsign                      pos 28  */
{graphic,norm,0,p0,IC_BSLASH},  /* \                             pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key; do not alter   pos 30  */
{graphic,norm,0,p0,0xE4},       /* ef small                      pos 31  */
{graphic,norm,0,p0,0xEB},       /* yeru small                    pos 32  */
{graphic,norm,0,p0,0xD2},       /* ve small                      pos 33  */
{graphic,norm,0,p0,0xD0},       /* a small                       pos 34  */
{graphic,norm,0,p0,0xDF},       /* pe small                      pos 35  */
{graphic,norm,0,p0,0xE0},       /* er small                      pos 36  */
{graphic,norm,0,p0,0xDE},       /* o small                       pos 37  */
{graphic,norm,0,p0,0xDB},       /* el small                      pos 38  */
{graphic,norm,0,p0,0xD4},       /* de small                      pos 39  */
{graphic,norm,0,p0,0xD6},       /* zh small                      pos 40  */
{graphic,norm,0,p0,0xED},       /* e  small                      pos 41  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore - not on 101 kbd       pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return               pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter  pos 44  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore -  not on 101 kbd      pos 45  */
{graphic,norm,0,p0,0xEF},       /* ia small                      pos 46  */
{graphic,norm,0,p0,0xE7},       /* tch small                     pos 47  */
{graphic,norm,0,p0,0xE1},       /* es small                      pos 48  */
{graphic,norm,0,p0,0xDC},       /* em small                      pos 49  */
{graphic,norm,0,p0,0xD8},       /* i small                       pos 50  */
{graphic,norm,0,p0,0xE2},       /* te small                      pos 51  */
{graphic,norm,0,p0,0xEC},       /* softsign                      pos 52  */
{graphic,norm,0,p0,0xD1},       /* be small                      pos 53  */
{graphic,norm,0,p0,0xEE},       /* iu small                      pos 54  */
{graphic,norm,0,p0,IC_PERIOD},  /* .                             pos 55  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                 pos 56  */
{es_func,norm,0, 1,KF_IGNORE},  /* shift right                   pos 57  */
{es_func,norm,0, 1,KF_IGNORE},  /* control                       pos 58  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available on WT KBD       pos 59  */
...
---------------------------------------------------------------------------*/
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 0   */
{graphic,norm,0,p0,0xA1},      /* e diaeresis capital                 pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                   pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                   pos 3   */
{graphic,norm,0,p0,0xF0},      /* numero sign                         pos 4   */
{graphic,norm,0,p0,IC_SEMI},   /* ;                                   pos 5   */
{graphic,norm,0,p0,IC_PERCENT},/* %                                   pos 6   */
{graphic,norm,0,p0,IC_COLON},  /* :                                   pos 7   */
{graphic,norm,0,p0,IC_QUES},   /* ?                                   pos 8   */
{graphic,norm,0,p0,IC_AST},    /* *                                   pos 9   */
{graphic,norm,0,p0,IC_LPAR},   /* (                                   pos 10  */
{graphic,norm,0,p0,IC_RPAR},   /* )                                   pos 11  */
{graphic,norm,0,p0,IC__},      /* _                                   pos 12  */
...
{sgl_ctl,curs,0, 0,IC_BS},     /* Back Space                          pos 15  */
{ctlfunc,curs,0, 1,KF_CBT},    /* cursor Back Horizontal Tab          pos 16  */
{graphic,norm,0,p0,0xB9},       /* shorti capital                     pos 17  */
{graphic,norm,0,p0,0xC6},       /* tse capital                        pos 18  */
{graphic,norm,0,p0,0xC3},       /* u capital                          pos 19  */
{graphic,norm,0,p0,0xBA},       /* ka capital                         pos 20  */
{graphic,norm,0,p0,0xB5},       /* ie capital                         pos 21  */
{graphic,norm,0,p0,0xBD},       /* en capital                         pos 22  */
{graphic,norm,0,p0,0xB3},       /* ghe capital                        pos 23  */
{graphic,norm,0,p0,0xC8},       /* sha capital                        pos 24  */
{graphic,norm,0,p0,0xC9},       /* shcha capita                       pos 25  */
{graphic,norm,0,p0,0xB7},       /* ze capital                         pos 26  */
{graphic,norm,0,p0,0xC5},       /* ha capital                         pos 27  */
{graphic,norm,0,p0,0xCA},       /* HARDSIGN                           pos 28  */
{graphic,norm,0,p0,IC_OR},      /* |                                  pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
{graphic,norm,0,p0,0xC4},       /* ef capital                         pos 31  */
{graphic,norm,0,p0,0xCB},       /* yeru capital                       pos 32  */
{graphic,norm,0,p0,0xB2},       /* ve capital                         pos 33  */
{graphic,norm,0,p0,0xB0},       /* a capital                          pos 34  */
{graphic,norm,0,p0,0xBF},       /* pe capital                         pos 35  */
{graphic,norm,0,p0,0xC0},       /* er capital                         pos 36  */
{graphic,norm,0,p0,0xBE},       /* o capital                          pos 37  */
{graphic,norm,0,p0,0xBB},       /* el capital                         pos 38  */
{graphic,norm,0,p0,0xB4},       /* de capital                         pos 39  */
{graphic,norm,0,p0,0xB6},       /* zh capital                         pos 40  */
{graphic,norm,0,p0,0xCD},       /* e  capital                         pos 41  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore - not on 101 kbd            pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore - not on 101 kbd             pos 45  */
{graphic,norm,0,p0,0xCF},       /* ia capital                         pos 46  */
{graphic,norm,0,p0,0xC7},       /* tch capital                        pos 47  */
{graphic,norm,0,p0,0xC1},       /* es capital                         pos 48  */
{graphic,norm,0,p0,0xBC},       /* em capital                         pos 49  */
{graphic,norm,0,p0,0xB8},       /* i capital                          pos 50  */
{graphic,norm,0,p0,0xC2},       /* te capital                         pos 51  */
{graphic,norm,0,p0,0xCC},       /* SOFTSIGN                           pos 52  */
{graphic,norm,0,p0,0xB1},       /* be capital                         pos 53  */
{graphic,norm,0,p0,0xCE},       /* iu capital                         pos 54  */
{graphic,norm,0,p0,IC_COM},     /* ,                                  pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift right                         pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control                             pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD             pos 59  */
...
main ()
{
    ...
    fd = open("ru_RU.ISO8859-5.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&russian_key_map,sizeof(lft_swkbd_t));
