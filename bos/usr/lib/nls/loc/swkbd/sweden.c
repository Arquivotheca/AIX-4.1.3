static char sccsid[] = "@(#)10  1.16  src/bos/usr/lib/nls/loc/swkbd/sweden.c, lftdd, bos411, 9428A410j 10/25/93 16:03:12";
/*
...
{graphic,norm,0,p0,IC_PLUS},   /* +                                 pos 12  */
{graphic,dead,0,p0,IC_ACUTE},  /* acute accent                      pos 13  */
...
{graphic,norm,0,p0,IC_LCAOVC}, /* overcircle small a                pos 27  */
...
{graphic,norm,0,p0,IC_LCOUML}, /* o diaeresis                       pos 40  */
{graphic,norm,0,p0,IC_LCAUML}, /* a diaeresis                       pos 41  */
...
{graphic,norm,0,p0,IC_DIVIDE}, /* division symbol               pos 95  */
...
{graphic,norm,0,p0,IC_MULTPL}, /* multiplication                pos 100 */
...
{graphic,norm,0,p0,IC_DASH},   /* dash                          pos 105 */
...
{graphic,norm,0,p0,IC_HALF},   /* half                               pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                  pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                  pos 3   */
{graphic,norm,0,p0,0x23},      /* #                                  pos 4   */
{graphic,norm,0,p0,0xCF},      /* international currency symbol      pos 5   */
...
{graphic,norm,0,p0,IC_UCAOVC}, /* A overcircle capital               pos 27  */
{graphic,dead,0,p0,IC_AND},    /* circumflex accent                  pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,IC_UCOUML}, /* O diaeresis                        pos 40  */
{graphic,norm,0,p0,IC_UCAUML}, /* A diaeresis                        pos 41  */
...
{sgl_ctl,norm,0, 0,IC_ESC},    /* escape                            pos 9   */
...
{ctlfunc,cpfk,0, 0,KF_PF69},   /* PFT 69                            pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 14  */
...
{graphic,norm,0,p0,0x9C},      /* pound sterling                     pos 4   */
...
{graphic,norm,0,p0,IC_RBRACE}, /* right brace                        pos 11  */
...
{graphic,dead,0,p0,0x7E},      /* tilde accent                       pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{graphic,norm,0,p0,0x7C},      /* pipe symbol                        pos 45  */
...
main ()
{
    ...
    fd = open("Sv_SE.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&swedish_key_map,sizeof(lft_swkbd_t));
    ...
    swedish_key_map.kbdname[0] = 'F';
    swedish_key_map.kbdname[1] = 'i';
    swedish_key_map.kbdname[3] = 'F';
    swedish_key_map.kbdname[4] = 'I';
    fd = open("Fi_FI.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
