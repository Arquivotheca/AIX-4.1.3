static char sccsid[] = "@(#)72  1.1  src/bos/usr/lib/nls/loc/swkbd/es_LA.c, lftdd, bos41J, 9520A_all 5/10/95 14:09:38";
/*
...
main ()
{
    ...
    fd = open("es_LA.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
