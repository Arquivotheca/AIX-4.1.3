static char sccsid[] = "@(#)73	1.3  src/bos/usr/lib/nls/loc/swkbd/sk_SK.c, lftdd, bos411, 9428A410j 4/8/94 13:59:54";
/*
...
{graphic,norm,0,p0,IC_SEMI},    /* semicolon                     pos 1   */
{graphic,norm,0,p0,IC_PLUS},    /* +                             pos 2   */
{graphic,norm,0,p0,0xB5},       /* l caron small                 pos 3   */
{graphic,norm,0,p0,0xB9},       /* s caron small                 pos 4   */
{graphic,norm,0,p0,0xE8},       /* c caron small                 pos 5   */
{graphic,norm,0,p0,0xBB},       /* t caron small                 pos 6   */
{graphic,norm,0,p0,0xBE},       /* z caron small                 pos 7   */
{graphic,norm,0,p0,0xFD},       /* y acute small                 pos 8   */
{graphic,norm,0,p0,0xE1},       /* a acute small                 pos 9   */
{graphic,norm,0,p0,0xED},       /* i acute small                 pos 10  */
{graphic,norm,0,p0,0xE9},       /* e acute small                 pos 11  */
{graphic,norm,0,p0,IC_EQ},      /* =                             pos 12  */
{graphic,norm,0,p0,IC_1QUOT},   /* '                             pos 13  */
...
{graphic,norm,0,p0,0xFA},       /* u acute small                 pos 27  */
{graphic,norm,0,p0,0xE4},       /* a diaeresis small             pos 28  */
...
{graphic,norm,0,p0,0xF4},       /* o circumflex small            pos 40  */
{graphic,norm,0,p0,0xA7},       /* section symbol                pos 41  */
{graphic,dead,0,p0,0xF2},       /* n caron small                 pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return               pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter  pos 44  */
{graphic,norm,0,p0,IC_AMP},     /* &                             pos 45  */
...
{graphic,norm,0,p0,IC_RPAR},   /* )                                   pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
...
main ()
{
    ...
    fd = open("sk_SK.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&slovak_key_map,sizeof(lft_swkbd_t));
