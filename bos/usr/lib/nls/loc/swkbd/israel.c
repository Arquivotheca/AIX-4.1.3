static char sccsid[] = "@(#)85	1.3  src/bos/usr/lib/nls/loc/swkbd/israel.c, lftdd, bos411, 9440C411a 10/7/94 17:08:13";
/*
 * COMPONENT_NAME: (LFTDD) Low Function Terminal - israel.c
 *
 * ORIGINS: 27
 *
...
lft_swkbd_t hebrew_key_map = {
       {'i','b','m','-','8','5','6','\0'},
       {'I','w','_','I','L','\0','\0','\0'},
       {

           {
   /*           BASE KEY ASSIGNMENTS            */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore, not on keyboard            pos 0   */
{graphic,norm,0,p0,IC_1QUOT},  /* '                                  pos 1   */
...
{graphic,norm,0,p0,IC_LQUOT},  /* grave accent                       pos 40  */
{graphic,norm,0,p0,IC_COM},    /* ,                                  pos 41  */
{graphic,norm,0,p0,IC_SLASH},  /* /                                  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift Key; do not alter       pos 44  */
{graphic,norm,0,p0,IC_BSLASH}, /* \                                  pos 45  */
...
{graphic,norm,0,p0,IC_APPROX}, /* ~                                  pos 53  */
{graphic,norm,0,p0,0xA6},      /* broken bar                         pos 54  */
...
{graphic,norm,0,p0,IC_DASH},   /* Dash (Minus)                  pos 105 */
{graphic,norm,0,p0,IC_PLUS},   /* Plus                          pos 106 */
...
{graphic,norm,0,p0,IC_2QUOT},   /* "                                  pos 1   */
...
{graphic,norm,0,p0,IC_LBRACE},  /* left brace                         pos 27  */
{graphic,norm,0,p0,IC_RBRACE},  /* right brace                        pos 28  */
...
{graphic,norm,0,p0,0xAC},       /* not sign                           pos 40  */
{graphic,norm,0,p0,IC_SEMI},    /* ;                                  pos 41  */
{graphic,norm,0,p0,IC_QUES},    /* ?                                  pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* shift left                         pos 44  */
{graphic,norm,0,p0,IC_OR},      /* | (or sign)                        pos 45  */
...
{graphic,norm,0,p0,IC_COLON},   /* :                                  pos 55  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 56  */
...
{ctlfunc,cpfk,0, 0,KF_PF254},  /* Num Lock key; do not alter    pos 90  */
...
{ctlfunc,cpfk,0, 0,KF_PF256},  /* Left Shift key; do not alter       pos 44  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
{ctlfunc,cpfk,0, 0,KF_PF255},  /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 59  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Alternate key; do not alter   pos 60  */
...
{ctlfunc,cpfk,0, 0,KF_PF86},    /* PFK 86                             pos 1   */
{graphic,norm,0,p0,0xFB},       /* superscript 1                      pos 2   */
{graphic,norm,0,p0,0xFD},       /* superscript 2                      pos 3   */
{graphic,norm,0,p0,0xFC},       /* superscript 3                      pos 4   */
{graphic,norm,0,p0,0xAC},       /* one quarter                        pos 5   */
{graphic,norm,0,p0,0xAB},       /* one half                           pos 6   */
{graphic,norm,0,p0,0xF3},       /* three quarters                     pos 7   */
{ctlfunc,cpfk,0, 0,KF_PF64},    /* PFK 64                             pos 8   */
{graphic,norm,0,p0,0x9E},       /* multiply                           pos 9   */
{graphic,norm,0,p0,0xBD},       /* cent sign                          pos 10  */
{graphic,norm,0,p0,0xF8},       /* degree symbol                      pos 11  */
{ctlfunc,cpfk,0, 0,KF_PF68},    /* PFK 68                             pos 12  */
{graphic,norm,0,p0,0xF1},       /* plus or minus sign                 pos 13  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 14  */
{ctlfunc,cpfk,0, 0,KF_PF71},    /* PFK 71                             pos 15  */
{ctlfunc,cpfk,0, 0,KF_PF73},    /* PFK 73                             pos 16  */
{graphic,norm,0,p0,0xEE},       /* macron                             pos 17  */
{ctlfunc,cpfk,0, 0,KF_PF75},    /* PFK 75                             pos 18  */
{ctlfunc,cpfk,0, 0,KF_PF76},    /* PFK 76                             pos 19  */
{graphic,norm,0,p0,0xA9},       /* registered                         pos 20  */
{ctlfunc,cpfk,0, 0,KF_PF78},    /* PFK 78                             pos 21  */
{graphic,norm,0,p0,0xBE},       /* yen sign                           pos 22  */
{ctlfunc,cpfk,0, 0,KF_PF80},    /* PFK 80                             pos 23  */
{ctlfunc,cpfk,0, 0,KF_PF81},    /* PFK 81                             pos 24  */
{graphic,norm,0,p0,0xCF},       /* currency sign                      pos 25  */
{graphic,norm,0,p0,0xF4},       /* paragraph                          pos 26  */
{graphic,norm,0,p0,0xAE},       /* guillemot left                     pos 27  */
{graphic,norm,0,p0,0xAF},       /* guillemot right                    pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key; do not alter        pos 30  */
{ctlfunc,cpfk,0, 0,KF_PF87},    /* PFK 87                             pos 31  */
{graphic,norm,0,p0,0xF5},       /* section                            pos 32  */
{graphic,norm,0,p0,0xF9},       /* diaeresis                          pos 33  */
{graphic,norm,0,p0,0xF7},       /* cedilla                            pos 34  */
{ctlfunc,cpfk,0, 0,KF_PF91},    /* PFK 91                             pos 35  */
{ctlfunc,cpfk,0, 0,KF_PF92},    /* PFK 92                             pos 36  */
{ctlfunc,cpfk,0, 0,KF_PF93},    /* PFK 93                             pos 37  */
{ctlfunc,cpfk,0, 0,KF_PF94},    /* PFK 94                             pos 38  */
{graphic,norm,0,p0,0x9C},       /* sterling sign                      pos 39  */
{ctlfunc,cpfk,0, 0,KF_PF97},    /* PFK 97                             pos 40  */
{ctlfunc,cpfk,0, 0,KF_PF99},    /* PFK 99                             pos 41  */
{graphic,norm,0,p0,0xF6},       /* division                           pos 42  */
{ctlfunc,cpfk,0, 0,KF_PF100},   /* PFK 100                            pos 43  */
{ctlfunc,cpfk,0, 0,KF_PF256},   /* Left Shift key; do not alter       pos 44  */
{ctlfunc,cpfk,0, 0,KF_PF115},   /* PFK 115                            pos 45  */
{ctlfunc,cpfk,0, 0,KF_PF101},   /* PFK 101                            pos 46  */
{ctlfunc,cpfk,0, 0,KF_PF102},   /* PFK 102                            pos 47  */
{graphic,norm,0,p0,0xB8},       /* copyright                          pos 48  */
{ctlfunc,cpfk,0, 0,KF_PF104},   /* PFK 104                            pos 49  */
{ctlfunc,cpfk,0, 0,KF_PF105},   /* PFK 105                            pos 50  */
{ctlfunc,cpfk,0, 0,KF_PF106},   /* PFK 106                            pos 51  */
{graphic,norm,0,p0,0xE6},       /* microsymbol                        pos 52  */
{ctlfunc,cpfk,0, 0,KF_PF109},   /* PFK 109                            pos 53  */
{ctlfunc,cpfk,0, 0,KF_PF111},   /* PFK 111                            pos 54  */
{graphic,norm,0,p0,0xFA},       /* middle dot                         pos 55  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 56  */
{ctlfunc,cpfk,0, 0,KF_PF255},   /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE},  /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 59  */
...
main ()
{
    ...
    fd = open("Iw_IL.IBM-856.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&hebrew_key_map,sizeof(lft_swkbd_t));
