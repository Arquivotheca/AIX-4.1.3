static char sccsid[] = "@(#)22  1.3  src/bos/usr/lib/nls/loc/swkbd/gr_SW.c, lftdd, bos411, 9428A410j 10/25/93 15:55:38";
/*
...
main ()
{
    ...
    fd = open("de_CH.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
