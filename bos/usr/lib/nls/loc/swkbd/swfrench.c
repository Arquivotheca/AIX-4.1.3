static char sccsid[] = "@(#)11  1.13  src/bos/usr/lib/nls/loc/swkbd/swfrench.c, lftdd, bos411, 9428A410j 10/25/93 16:03:26";
/*
...
lft_swkbd_t swiss_french_key_map = {
       {'i','b','m','-','8','5','0','\0'},
       {'F','r','_','C','H','\0','\0','\0'},
       {
...
{graphic,norm,0,p0,IC_SECT},   /* section symbol                    pos 1   */
...
{graphic,norm,0,p0,IC_1QUOT},  /* quote/apostrophe                  pos 12  */
{graphic,dead,0,p0,IC_AND},    /* circumflex accent                 pos 13  */
...
{graphic,norm,0,p0,IC_LCEGRV}, /* e grave small                     pos 27  */
...
{graphic,norm,0,p0,IC_LCEACC}, /* e acute small                     pos 40  */
{graphic,norm,0,p0,IC_LCAGRV}, /* a grave small                     pos 41  */
{graphic,norm,0,p0,IC_DOLLAR}, /* dollar sign                       pos 42  */
...
{graphic,norm,0,p0,IC_AST},    /* *                                 pos 4   */
{graphic,norm,0,p0,IC_LCCCED,}, /* c-cedilla small                   pos 5   */
...
{graphic,dead,0,p0,0x60},      /* grave accent                      pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 14  */
...
{graphic,norm,0,p0,IC_LCUUML}, /* u diaeresis small                 pos 27  */
{graphic,norm,0,p0,IC_EXC},    /* !                                 pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD               pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter       pos 30  */
...
{graphic,norm,0,p0,IC_LCOUML}, /* o diaeresis small                 pos 40  */
{graphic,norm,0,p0,IC_LCAUML}, /* a diaeresis small                 pos 41  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Right Alternate key; do not alter pos 62  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 63  */
{es_func,norm,0, 1,KF_IGNORE}, /* VTRM Previous Window key; do not apos 64  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 65  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 66  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 67  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 68  */
...
{sgl_ctl,norm,0, 0,IC_SUB},    /* substitute character              pos 22  */
...
{sgl_ctl,norm,0, 0,IC_EM},     /* end of media                      pos 46  */
...
{graphic,norm,0,p0,IC_OR},     /* logical or symbol                  pos 2   */
...
{graphic,norm,0,p0,IC_VLBROK}, /* vertical line broken               pos 8   */
{graphic,norm,0,p0,IC_CENT},   /* cent sign                          pos 9   */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 10  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 11  */
{graphic,dead,0,p0,IC_ACUTE},  /* acute accent                       pos 12  */
{graphic,dead,0,p0,IC_APPROX}, /* tilde accent                       pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
{graphic,norm,0,p0,IC_LSB},    /* left bracket                       pos 27  */
{graphic,norm,0,p0,IC_RSB},    /* right bracket                      pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{graphic,norm,0,p0,IC_BSLASH}, /* back slash                         pos 45  */
...
main ()
{
    ...
    fd = open("Fr_CH.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&swiss_french_key_map,sizeof(lft_swkbd_t));
