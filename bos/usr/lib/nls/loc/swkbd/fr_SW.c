static char sccsid[] = "@(#)18  1.3  src/bos/usr/lib/nls/loc/swkbd/fr_SW.c, lftdd, bos411, 9428A410j 10/25/93 15:36:48";
/*
...
{graphic,norm,0,p0,0xE8},      /* e grave small                     pos 27  */
{graphic,dead,0,p0,0xA8},      /* diaeresis accent                  pos 28  */
...
{graphic,norm,0,p0,0xE0},      /* a grave small                     pos 41  */
...
{graphic,norm,0,p0,0xFC},      /* u diaeresis small                 pos 27  */
...
{graphic,norm,0,p0,0xF6},      /* o diaeresis small                 pos 40  */
{graphic,norm,0,p0,0xE4},      /* a diaeresis small                 pos 41  */
...
{graphic,norm,0,p0,0xAC},      /* notsign                            pos 7   */
{graphic,norm,0,p0,0xA6},      /* vertical line broken               pos 8   */
{graphic,norm,0,p0,0xA2},      /* cent sign                          pos 9   */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 10  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 11  */
{graphic,dead,0,p0,0xB4},      /* acute accent                       pos 12  */
...
main ()
{
    ...
    fd = open("fr_CH.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
