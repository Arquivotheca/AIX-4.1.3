static char sccsid[] = "@(#)13  1.12  src/bos/usr/lib/nls/loc/swkbd/usa.c, lftdd, bos411, 9428A410j 10/25/93 16:04:58";
/*
...
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_ULCORN},  /* upper left    corner       pos 91  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_RARM},  /* vertical bar    w/right arm  pos 92  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_LLCORN},  /* lower left    corner       pos 93  */
...
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_TEE},  /* upright tee                   pos 96  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_CROSS},  /* crossed bars                pos 97  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_INVTEE},  /* inverted tee               pos 98  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_VERTBAR},  /* vertical bar              pos 99  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_AST},    /* Asterisk                    pos 100 */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_URCORN},  /* upper right   corner       pos 101  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_LARM},  /* vertical bar    w/left arm   pos 102  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_LRCORN},  /* lower right   corner       pos 103  */
{FLAG_GRAPHIC,       CODE_STAT_NONE,  0,CHARSET_P0,IC_HORZBAR},  /* horizontal   bar          pos 104  */
...
main ()
{
    ...
    fd = open("En_US.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
