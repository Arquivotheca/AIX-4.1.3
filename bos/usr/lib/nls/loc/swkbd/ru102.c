static char sccsid[] = "@(#)70  1.3  src/bos/usr/lib/nls/loc/swkbd/ru102.c, lftdd, bos411, 9428A410j 4/14/94 13:46:19";
/*
...
{graphic,norm,0,p0,IC_BSLASH},  /* \                         1   pos 42  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* ignore not on WT keyboard           pos 29  */
...
{graphic,norm,0,p0,IC_OR},     /* or sign                             pos 42  */
...
{graphic,norm,0,p0,IC_BSLASH},  /* \                             pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return               pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter  pos 44  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore -  not on 101 kbd      pos 45  */
...
main ()
{
    ...
    fd = open("ru_RU.ISO8859-5@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
