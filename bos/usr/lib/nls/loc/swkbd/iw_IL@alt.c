static char sccsid[] = "@(#)87	1.2  src/bos/usr/lib/nls/loc/swkbd/iw_IL@alt.c, lftdd, bos411, 9428A410j 10/27/93 13:28:53";
/*
 * COMPONENT_NAME: (LFTDD) Low Function Terminal - iw$alt.c
 *
 * ORIGINS: 27
 *
...
{FLAG_CNTL_FUNCTION, CODE_STAT_PF_KEY,0,         0,KF_PF254},  /* Num Lock key; do not alter pos 90  */
...
{FLAG_ESC_FUNCTION,  CODE_STAT_NONE,  0,         1,KF_IGNORE}, /* not available              pos 94  */
{FLAG_CNTL_FUNCTION, CODE_STAT_PF_KEY,0,         0,KF_PF253},  /* /                          pos 95  */
...
{FLAG_CNTL_FUNCTION,CODE_STAT_PF_KEY,0, 0,KF_PF256},  /* Left Shift key; do not alter       pos 44  */
{FLAG_ESC_FUNCTION, CODE_STAT_NONE,  0, 1,KF_IGNORE}, /* not available                      pos 45  */
...
{FLAG_ESC_FUNCTION, CODE_STAT_NONE,  0, 1,KF_IGNORE}, /* not available                      pos 56  */
{FLAG_CNTL_FUNCTION,CODE_STAT_PF_KEY,0, 0,KF_PF255},  /* Right Shift key; do not alter      pos 57  */
{FLAG_ESC_FUNCTION, CODE_STAT_NONE,  0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
{FLAG_ESC_FUNCTION, CODE_STAT_NONE,  0, 1,KF_IGNORE}, /* not available                      pos 59  */
{FLAG_ESC_FUNCTION, CODE_STAT_NONE,  0, 1,KF_IGNORE}, /* Left Alternate key; do not alter   pos 60  */
...
main ()
{
    ...
    fd = open("iw_IL.ISO8859-8@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    hebrew_key_map.kbdname[0] = 'I';
    hebrew_key_map.disp_set[0] = 'i';
    hebrew_key_map.disp_set[1] = 'b';
    hebrew_key_map.disp_set[2] = 'm';
    hebrew_key_map.disp_set[3] = '-';
    hebrew_key_map.disp_set[4] = '8';
    hebrew_key_map.disp_set[5] = '5';
    hebrew_key_map.disp_set[6] = '6';
    hebrew_key_map.disp_set[7] = '\0';
    fd = open("Iw_IL.IBM-856@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
