static char sccsid[] = "@(#)68	1.3  src/bos/usr/lib/nls/loc/swkbd/ro_RO.c, lftdd, bos411, 9428A410j 4/8/94 13:59:05";
/*
...
{graphic,norm,0,p0,0xE2},       /* a circumflex small            pos 1   */
{graphic,norm,0,p0,IC_1},       /* 1                             pos 2   */
{graphic,norm,0,p0,IC_2},       /* 2                        4    pos 3   */
...
{graphic,norm,0,p0,0x2B},       /* +                             pos 12  */
{graphic,norm,0,p0,0x27},       /* '                             pos 13  */
...
{graphic,norm,0,p0,0xE3},       /* a breve small            f    pos 27  */
{graphic,norm,0,p0,0xEE},       /* i circumflex small            pos 28  */
...
{graphic,norm,0,p0,0xBA},       /* s cedilla small               pos 40  */
{graphic,norm,0,p0,0xFE},       /* t cedilla small               pos 41  */
{graphic,norm,0,p0,0x5C},       /* \                             pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return          c    pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter  pos 44  */
{graphic,norm,0,p0,0xD7},       /* multiple                      pos 45  */
{graphic,norm,0,p0,IC_LCZ},     /* z                             pos 46  */
{graphic,norm,0,p0,IC_LCX},     /* x                        3    pos 47  */
...
{graphic,norm,0,p0,0xC2},      /* A circumflex capital                pos 1   */
...
{graphic,norm,0,p0,0xC3},      /* A breve capital                     pos 27  */
{graphic,norm,0,p0,0xCE},      /* I circumflex capital                pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
...
{graphic,norm,0,p0,0xAA},      /* S cedilla capital                   pos 40  */
{graphic,norm,0,p0,0xDE},      /* T cedilla capital                   pos 41  */
{graphic,norm,0,p0,0x7C},      /* bar                                 pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{graphic,norm,0,p0,0xF7},      /* division                            pos 45  */
...
{graphic,norm,0,p0,0x5B},      /*  left bracket                      pos 39  */
{graphic,norm,0,p0,0x5D},      /* right bracket                      pos 40  */
{graphic,norm,0,p0,0xDF},      /* s sharp                            pos 41  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 42  */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore                             pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{graphic,norm,0,p0,0xA7},      /* paragraph                          pos 45  */
...
{graphic,norm,0,p0,0x3C},      /* <                                  pos 46  */
{graphic,norm,0,p0,0x3E},      /* >                                  pos 46  */
{graphic,norm,0,p0,0x40},      /* @                                  pos 46  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
...
main ()
{
    ...
    fd = open("ro_RO.ISO8859-2.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&romanian_key_map,sizeof(lft_swkbd_t));
