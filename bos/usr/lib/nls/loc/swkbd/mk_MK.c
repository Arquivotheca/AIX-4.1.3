static char sccsid[] = "@(#)66  1.3  src/bos/usr/lib/nls/loc/swkbd/mk_MK.c, lftdd, bos411, 9428A410j 4/14/94 13:45:36";
/*
...
lft_swkbd_t macedonian_key_map = {
       {'8','8','5','9','-','5','\0','\0'},
       {'m','k','_','M','K','\0','\0','\0'},
       {
...
{graphic,norm,0,p0,0xA2},      /* dj  capital                        pos 27  */
{graphic,norm,0,p0,0xF2},      /* dj  small                          pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,0xAB},      /* cj  capital                        pos 40  */
{graphic,norm,0,p0,0xFB},      /* cj  small                          pos 41  */
...
{graphic,norm,0,p0,0xF3},       /* gje small                     pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* not avail on WT KBD           pos 29  */
{es_func,norm,0, 1,KF_IGNORE},  /* caps Lock key; do not alter   pos 30  */
...
{graphic,norm,0,p0,0xFC},       /* kje small                     pos 41  */
...
{graphic,norm,0,p0,0xA3},      /* gje capital                         pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                 pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter         pos 30  */
...
{graphic,norm,0,p0,0xAC},      /* kje capital                         pos 41  */
...
main ()
{
    ...
    fd = open("mk_MK.ISO8859-5.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&macedonian_key_map,sizeof(lft_swkbd_t));
