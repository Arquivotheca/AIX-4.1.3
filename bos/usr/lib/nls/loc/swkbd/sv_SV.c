static char sccsid[] = "@(#)29  1.3  src/bos/usr/lib/nls/loc/swkbd/sv_SV.c, lftdd, bos411, 9428A410j 10/25/93 16:02:41";
/*
...
{graphic,dead,0,p0,0xB4},      /* acute accent                      pos 13  */
...
{graphic,norm,0,p0,0xE5},      /* overcircle small a                pos 27  */
...
{graphic,norm,0,p0,0xF6},      /* o diaeresis                       pos 40  */
{graphic,norm,0,p0,0xE4},      /* a diaeresis                       pos 41  */
...
{graphic,norm,0,p0,0xF7},      /* division symbol               pos 95  */
...
{graphic,norm,0,p0,0xD7},      /* multiplication                pos 100 */
...
{graphic,norm,0,p0,0xBD},      /* half                               pos 1   */
{graphic,norm,0,p0,IC_EXC},    /* !                                  pos 2   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                  pos 3   */
{graphic,norm,0,p0,0x23},      /* #                                  pos 4   */
{graphic,norm,0,p0,0xA4},      /* international currency symbol      pos 5   */
...
{graphic,norm,0,p0,0xC5},      /* A overcircle capital               pos 27  */
...
{graphic,norm,0,p0,0xD6},      /* O diaeresis                        pos 40  */
{graphic,norm,0,p0,0xC4},      /* A diaeresis                        pos 41  */
...
main ()
{
    ...
    fd = open("sv_SE.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    fd = open("fi_FI.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
        printf("ERROR:  bad open of software keyboard output file.\n");
        printf("        errno=%d\n",errno);
        exit(-1);
