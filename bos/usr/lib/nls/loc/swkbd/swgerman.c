static char sccsid[] = "@(#)12  1.13  src/bos/usr/lib/nls/loc/swkbd/swgerman.c, lftdd, bos411, 9428A410j 10/25/93 16:03:42";
/*
...
lft_swkbd_t swiss_german_key_map = {
       {'i','b','m','-','8','5','0','\0'},
       {'D','e','_','C','H','\0','\0','\0'},
       {
...
{graphic,norm,0,p0,IC_LCOUML}, /* u diaeresis small                 pos 40  */
...
main ()
{
    ...
    fd = open("De_CH.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&swiss_german_key_map,sizeof(lft_swkbd_t));
