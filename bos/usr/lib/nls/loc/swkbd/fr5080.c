static char sccsid[] = "@(#)56  1.7  src/bos/usr/lib/nls/loc/swkbd/fr5080.c, lftdd, bos411, 9428A410j 10/25/93 15:34:40";
/*
...
{graphic,norm,0,p0,IC_LCEACC}, /* e acute accent                    pos 3   */
{graphic,norm,0,p0,IC_2QUOT},  /* "                                 pos 4   */
{graphic,norm,0,p0,IC_1QUOT},  /* quote/apostrophe                  pos 5   */
{graphic,norm,0,p0,IC_LPAR},   /* {                                 pos 6   */
{graphic,norm,0,p0,IC_DASH},   /* -                                 pos 7   */
{graphic,norm,0,p0,IC_LCEGRV}, /* e grave accent                    pos 8   */
{graphic,norm,0,p0,IC__},      /* _                                 pos 9   */
{graphic,norm,0,p0,IC_LCCCED}, /* c cedilla small                   pos 10  */
{graphic,norm,0,p0,IC_LCAGRV}, /* a grave                           pos 11  */
...
{graphic,dead,0,p0,IC_AND},    /* circumflex                        pos 27  */
...
{graphic,norm,0,p0,IC_AST},    /* *                                 pos 42  */
{sgl_ctl,norm,0,p0,IC_CR},     /* carriage Return                   pos 43  */
...
{graphic,norm,0,p0,IC_EXC},    /* !                                 pos 55  */
...
{graphic,norm,0,p0,IC_DEGREE}, /* degree symbol                      pos 12  */
...
{graphic,norm,0,p0,IC_STRLNG}, /* pound sterling                     pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,IC_LCMU},   /* mu small                           pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* sshift left                        pos 44  */
...
{graphic,norm,0,p0,IC_SECT},   /* section symbol                     pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 73  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 74  */
{ctlfunc,cpfk,0, 0,KF_PF139},  /* PFK 139                            pos 75  */
{ctlfunc,norm,0, 1,KF_DCH},    /* Delete character                   pos 76  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 77  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 78  */
...
{ctlfunc,cpfk,0, 0,KF_PF52},   /* PFK 52                             pos 27  */
{ctlfunc,cpfk,0, 0,KF_PF54},   /* PFK 54                             pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{ctlfunc,cpfk,0, 0,KF_PF96},   /* PFK 96                             pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 45  */
{sgl_ctl,norm,0, 0,IC_ETB},    /* end of blk                         pos 46  */
...
{sgl_ctl,norm,0, 0,IC_SS1},    /* single shift                       pos 52  */
...
{ctlfunc,cpfk,0, 0,KF_PF86},   /* PFK 86                             pos 9   */
...
{ctlfunc,cpfk,0, 0,KF_PF65},   /* PFK 65                             pos 42  */
...
{graphic,dead,0,p0,IC_APPROX}, /* tilde                              pos 3   */
{graphic,norm,0,p0,IC_POUND},  /* #                                  pos 4   */
{graphic,norm,0,p0,IC_LBRACE}, /* left brace                         pos 5   */
{graphic,norm,0,p0,IC_LSB},    /* left bracket                       pos 6   */
{graphic,norm,0,p0,IC_OR},     /* pipe symbol                        pos 7   */
{graphic,dead,0,p0,0x60},      /* grave accent                       pos 8   */
{graphic,norm,0,p0,IC_BSLASH}, /* reverse slash                      pos 9   */
{graphic,norm,0,p0,IC_AND},    /* circumflex                         pos 10  */
{graphic,norm,0,p0,IC_AT},     /* @                                  pos 11  */
{graphic,norm,0,p0,IC_RSB},    /* right bracket                      pos 12  */
{graphic,norm,0,p0,IC_RBRACE}, /* right brace                        pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
{graphic,norm,0,p0,IC_INTLCU}, /* intl currency symbol               pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{es_func,norm,0,1,KF_IGNORE}, /* ignore                        pos 107 */
...
main ()
{
    ...
    fd = open("Fr_FR.IBM-850@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&french_key_map,sizeof(lft_swkbd_t));
