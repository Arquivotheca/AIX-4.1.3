static char sccsid[] = "@(#)61  1.4  src/bos/usr/lib/nls/loc/swkbd/bg101.c, lftdd, bos411, 9428A410j 5/6/94 09:00:01";
/*
...
{graphic,norm,0,p0,IC_OR},     /* or symbol                           pos 29  */
...
{es_func,norm,0, 1,KF_IGNORE},  /* not on 101 kbd                pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* carriage Return               pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter  pos 44  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                 pos 45  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on 101KBD                 pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift left                          pos 44  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 45  */
...
main ()
{
    ...
    fd = open("bg_BG.ISO8859-5@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
