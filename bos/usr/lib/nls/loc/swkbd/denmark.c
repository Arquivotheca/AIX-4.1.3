static char sccsid[] = "@(#)99  1.14  src/bos/usr/lib/nls/loc/swkbd/denmark.c, lftdd, bos411, 9428A410j 10/25/93 15:27:55";
/*
...
{graphic,norm,0,p0,IC_HALF},    /* 1/2                           pos 1   */
...
{graphic,norm,0,p0,IC_LCAOVC},  /* a overcircle small            pos 27  */
...
{graphic,norm,0,p0,IC_LCOSLS},  /* o slash small                 pos 41  */
...
{graphic,norm,0,p0,IC_INTLCU}, /* intl. cur sym                       pos 5   */
...
{graphic,norm,0,p0,IC_UCAOVC}, /* A overcirle capital                 pos 27  */
...
{graphic,norm,0,p0,IC_UCOSLS}, /* O slash capital                     pos 41  */
...
{graphic,norm,0,p0,IC_OR},     /* pipe symbol                        pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
main ()
{
    ...
    fd = open("Da_DK.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&danish_key_map,sizeof(lft_swkbd_t));
