static char sccsid[] = "@(#)88  1.4  src/bos/usr/lib/nls/loc/swkbd/ja_JP.c, lftdd, bos411, 9428A410j 3/23/94 13:51:41";
/*
...
main ()
{
    ...
    fd = open("ja_JP.IBM-eucJP.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
