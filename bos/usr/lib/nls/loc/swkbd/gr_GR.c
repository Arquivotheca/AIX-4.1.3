static char sccsid[] = "@(#)21  1.3  src/bos/usr/lib/nls/loc/swkbd/gr_GR.c, lftdd, bos411, 9428A410j 10/25/93 15:55:04";
/*
...
{graphic,dead,0,p0,IC_AND},    /* circumflex accent                 pos 1   */
...
{graphic,norm,0,p0,0xDF},      /* double s                          pos 12  */
...
{graphic,norm,0,p0,0xFC},      /* u diaeresis                       pos 27  */
...
{graphic,norm,0,p0,IC_POUND},  /* #                                 pos 42  */
...
{graphic,norm,0,p0,0xD7},      /* Multiplication  symbol        pos 100 */
...
{graphic,norm,0,p0,0xA7},      /* section symbol                      pos 4   */
...
{graphic,norm,0,p0,0xDC},      /* U diaeresis capital                 pos 27  */
...
{graphic,norm,0,p0,0xD6},      /* O diaeresis capital                 pos 40  */
{graphic,norm,0,p0,0xC4},      /* A diaeresis capital                 pos 41  */
...
{graphic,norm,0,p0,0x2C},      /* ,                             pos 104 */
{graphic,norm,0,p0,IC_DASH},   /* -                             pos 105 */
{graphic,norm,0,p0,IC_PLUS},   /* +                             pos 106 */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 107 */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return               pos 108 */
...
{sgl_ctl,cpfk,0, 0,IC_ESC},    /* escape                            pos 9   */
{sgl_ctl,cpfk,0, 0,IC_SS3},    /* Single Shift 3                    pos 10  */
{ctlfunc,cpfk,0, 0,KF_PF56},   /* PFK 56                            pos 11  */
{sgl_ctl,norm,0, 0,IC_SS4},    /* Single Shift 4                    pos 12  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on 4 WT KBD             pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter       pos 30  */
...
{ctlfunc,cpfk,0, 0,KF_PF112},  /* PFK 112                           pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                   pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter      pos 44  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift key; do not alter       pos 44  */
{graphic,norm,0,p0,IC_OR},     /* pipe symbol                        pos 45  */
...
{graphic,norm,0,p0,0xB5},      /* mu small                           pos 52  */
...
main ()
{
    ...
    fd = open("de_DE.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&german_key_map,sizeof(lft_swkbd_t));
