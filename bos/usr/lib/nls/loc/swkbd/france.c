static char sccsid[] = "@(#)02  1.17  src/bos/usr/lib/nls/loc/swkbd/france.c, lftdd, bos411, 9428A410j 10/25/93 15:37:42";
/*
...
{graphic,norm,0,p0,0xf5},      /* section symbol                    pos 7   */
{graphic,norm,0,p0,IC_LCEGRV}, /* e grave accent                    pos 8   */
{graphic,norm,0,p0,0x21},      /* !                                 pos 9   */
...
{graphic,norm,0,p0,0xe6},      /* greek mu                          pos 42  */
...
{graphic,norm,0,p0,0xfc},      /* superscript 3                      pos 1   */
...
{graphic,norm,0,p0,0x9c},      /* pound sterling                     pos 42  */
...
{graphic,dead,0,p0,0x7e},      /* tilde accent                       pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter      pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter          pos 58  */
...
main ()
{
    ...
    fd = open("Fr_FR.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
