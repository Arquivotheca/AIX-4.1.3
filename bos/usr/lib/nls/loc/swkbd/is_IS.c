static char sccsid[] = "@(#)23  1.3  src/bos/usr/lib/nls/loc/swkbd/is_IS.c, lftdd, bos411, 9428A410j 10/25/93 15:56:48";
/*
...
{graphic,norm,0,p0,0xF6},       /* lowwer case o umlaut          pos 12  */
...
{graphic,norm,0,p0,0xF0},       /* lowwer case eth icelandic     pos 27  */
...
{graphic,norm,0,p0,0xE6},       /* ae dipthong                   pos 40  */
...
{graphic,norm,0,p0,0xFE},       /* lowwer case thorn icelandic   pos 55  */
...
{graphic,dead,0,p0,0xA8},      /* diaeresis accent                    pos 1   */
...
{graphic,norm,0,p0,0xD6},      /* upper case o umlaut                 pos 12  */
...
{graphic,norm,0,p0,0xD0},      /* upper case eth icelandic            pos 27  */
...
{graphic,norm,0,p0,0xC6},      /* AE dipthong capital                 pos 40  */
{graphic,dead,0,p0,0xB4},      /* acute accent                        pos 41  */
...
{graphic,norm,0,p0,0xDE},      /* upper case thorn icelandic          pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* shift right                         pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control                             pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available on WT KBD             pos 59  */
...
{graphic,norm,0,p0,0x2E},      /* .                     pos 104 */
{graphic,norm,0,p0,IC_DASH},   /* -                     pos 105 */
{graphic,norm,0,p0,IC_PLUS},   /* +                     pos 106 */
{es_func,norm,0, 1,KF_IGNORE}, /* not available         pos 107 */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return       pos 108 */
...
main ()
{
    ...
    fd = open("is_IS.ISO8859-1.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
