static char sccsid[] = "@(#)30	1.1  src/bos/usr/lib/nls/loc/CN.im/cnimprof1.c, ils-zh_CN, bos41B, 9504A 12/19/94 14:34:18";
...
case 3:
# line 42 "timprof1.y"
{if(makewordtree(yypvt[-3], yypvt[-1]) == 1)
                                        return(1);} break;
	}
