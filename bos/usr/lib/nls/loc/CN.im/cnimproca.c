static char sccsid[] = "@(#)27	1.1  src/bos/usr/lib/nls/loc/CN.im/cnimproca.c, ils-zh_CN, bos41B, 9504A 12/19/94 14:34:13";
/*
 *   COMPONENT_NAME: ils-zh_CN
 *
 *   FUNCTIONS: CNIMProcessAuxiliary
 *
 *   ORIGINS: 27
 *
...
/* ----------------------------------------------------- */
/* **************  CNIMProcessAuxiliary()  ************** */
/* ----------------------------------------------------- */

int             CNIMProcessAuxiliary(im, aux_id, button, panel_row, panel_col,
                                                    item_row, item_col)
   IMObject        im;
   caddr_t         aux_id;
