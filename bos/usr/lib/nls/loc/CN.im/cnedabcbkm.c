static char sccsid[] = "@(#)99	1.1  src/bos/usr/lib/nls/loc/CN.im/cnedabcbkm.c, ils-zh_CN, bos41B, 9504A 12/19/94 14:33:09";
/*
...
/*                                       $(HOME)/.abcusrrem                   */
/*                                                                            */
/*                     UpdateUser      : Clear The tmmr.rem_area And Read The */
/*                                       Index Of $(HOME)/.abcusrrem          */
/*                                                                            */
...
WORD *buffer;
{
    if (wp.bx_stack[wp.xsyjs])           /* Radical With Strokes              */
        buffer[0]|=0x4000;               /* Append Simple Spelling Flag       */
    else
        if (wp.cmp_stack[wp.xsyjs]==4)   /* Radical is Only Initial Consonant */
            return(0);                   /* Not Adjust Frequency              */
    push_down_stack1();
...
push_down_stack1()
{
    ...
    /* This Cand. Needs To Adjust Frequency More Than Four Times, Rewrite This*/    /* Cand. Frequency                                                        */
...
{
    int i;
    if (wp.cmp_stack[wp.xsyjs]!=2)       /* Radical is Only Initial Consonant */
        buffer[0]|=0x4000;               /* Not Adjust Frequency              */
...
/******************************************************************************/
/* FUNCTION    : UpdateUser                                                   */
/* DESCRIPTION : Clear The tmmr.rem_area And Read The Index Of                */
/*               $(HOME)/.abcusrrem                                           */
/* EXTERNAL REFERENCES:                                                       */
/* INPUT       :                                                              */
/* OUTPUT      :                                                              */
...
UpdateUser()
{
    ...
    if (UpdateFlag) {
        ...
        if (hd==-1)
            lseek(hd,0xa000l,0);
        op_count=read(hd,&kzk_ndx,NDX_REAL_LENGTH);
