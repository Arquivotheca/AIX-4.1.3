/* @(#)35	1.8  src/bos/usr/lib/sendmail/sysexits.h, cmdsend, bos411, 9428A410j 4/7/93 18:56:24 */
/* 
 * COMPONENT_NAME: CMDSEND sysexits.h
 * 
 * FUNCTIONS: 
 *
 * ORIGINS: 10  26  27 
...
# define EX_NOLHOST	80	/* local host not defined */
