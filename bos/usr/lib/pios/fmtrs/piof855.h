/* @(#)55       1.4  src/bos/usr/lib/pios/fmtrs/piof855.h, cmdpios, bos411, 9428A410j 1/19/90 01:52:01 */
/*
...
/*******************************************************************************
*  piof855.h  - Definitions for a Printer Formatter                            *
*******************************************************************************/
...
/* Paper Source Drawer (1: Lower  2: Upper or no sheet feeder  3: Envelopes) */
...
/* Is this current line being printed in double width font */
...
/* Select alternate translate table */
#define SEL_ALT_SET    "c2"
...
/* Send out a three byte escape sequence */
#define THREE_BYTE_CMD "ex"

/* Pass thru graphics images */
#define GRAPHICS       "ey"
...
"wm"   , VAR_INT        , NULL           , (union dtypes *) &_Line_dblwide   ,
...
#define OPTSTRING  "b:g:i:j:l:p:t:v:w:x:J:L:Z:"
