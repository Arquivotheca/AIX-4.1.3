static char sccsid[] = "@(#)52  1.9.1.3  src/bos/usr/lib/pios/fmtrs/piof630.c, cmdpios, bos411, 9433B411a 8/17/94 12:52:25";
/*
...
/*** piof630.c - print formatter for Diablo 630 data stream ***/
...
case 'Y':                                      /* Print ASCII space character */
case 'Z':                      /* Print character at print wheel position 7Fh */
    hpos += Hincr;
case 8:                                             /* Backspace 1/120th inch */
case 10:                                                 /* Reverse line feed */
case '&':                                       /* Stop bold and shadow print */
case '-':                             /* Set vertical tab at current position */
case '0':                             /* Set right margin at current position */
case '1':                           /* Set horizontal tab at current position */
case '2':                                                   /* Clear all tabs */
case '5':                                    /* Bidirectional print - forward */
case '6':                                   /* Bidirectional print - backward */
case '8':                         /* Clear horizontal tab at current position */
case '9':                              /* Set left margin at current position */
case '<':                                      /* All l/r orientation flipped */
case '=':                                 /* Turn on automatic line centering */
case '>':                                     /* Normal print - left to right */
case 'D':                                           /* Reverse half-line feed */
case 'E':                                                 /* Start underscore */
case 'M':                             /* Turn on automatic line justification */
case 'O':                                                 /* Start bold print */
case 'P':                                     /* Turn on proportional spacing */
case 'Q':                                    /* Turn off proportional spacing */
case 'R':                                                  /* Stop underscore */
case 'U':                                                   /* Half-line feed */
case 'W':                                               /* Start shadow print */
case 'X':                          /* Cancel all WP modes except prop spacing */
    CMDOUT(TWO_BYTE_CMD);
    break;

case 9:                                            /* Absolute horizontal tab */
case 11:                                             /* Absolute vertical tab */
case 17:                                                      /* Offset value */
case 30:                                                           /* Set VMI */
case 31:                                                           /* Set HMI */
    CHARIN(Workint2);
...
case 'L':                                                /* set bottom margin */
case 'C':                                                    /* clear margins */
    break;

case 12:                                                /* Set lines per page */
case 22:                               /* Select language or print wheel size */
case 26:                                                /* Remote error reset */
    CHARIN(Workint2);
    break;
