/* @(#)78 1.1 src/bos/usr/lib/pios/fmtrs/piofbull5.h, cmdpios, bos411, 9428A410j 6/23/94 10:48:18 */
/*
...
/*******************************************************************************
*  piofbull5.h  - Definitions for a Printer Formatter                          *
*******************************************************************************/
...
/* Paper Input (1; Manual    3; Automatic) */
#define Paper_input (*(_Paper_input + piomode))  /* variable name */
int *_Paper_input;   /* pointer to the variable */
...
/* Duplex Printing (0: no;  1: Duplex; 2: Long Edge; 3:Short Edge) */
#define Duplex (*(_Duplex + piomode))  /* variable name */
int *_Duplex;   /* pointer to the variable */

/* Style (0: Upright;  1: Italic; 32: Outline ; 64:Inline ;etc) */
#define Style (*(_Style + piomode))  /* variable name */
int *_Style;   /* pointer to the variable */

/* Font selection  (0: primary;  1: Secondary) */
#define font (*(_font + piomode))  /* variable name */
int *_font;   /* pointer to the variable */

/* Stroke Weight Printing (0> <8) */
#define Empha (*(_Empha + piomode))  /* variable name */
int *_Empha;   /* pointer to the variable */

/* Part of Pitch  */
#define frpitch (*(_frpitch + piomode))  /* variable name */
int *_frpitch;   /* pointer to the variable */

/* Print diorection   */
#define Print_dir (*(_Print_dir + piomode))  /* variable name */
int *_Print_dir;   /* pointer to the variable */
...
"_O"   , VAR_INT        , NULL           , (union dtypes *) &_Paper_input   ,
"_S"   , VAR_INT        , NULL           , (union dtypes *) &_Style           ,
"_X"   , VAR_STR        , NULL           , (union dtypes *) &_Codepagename   ,
"_Y"   , VAR_INT        , NULL           , (union dtypes *) &_Duplex         ,
"_U"   , VAR_INT        , NULL           , (union dtypes *) &_Print_dir      ,
...
#define OPTSTRING  "b:g:e:i:j:y:l:p:q:t:u:v:w:x:z:I:J:L:O:S:X:Y:U:Z:"
