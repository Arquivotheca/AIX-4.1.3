static char sccsid[] = "@(#)72	1.4  src/bos/usr/lib/pios/trans2/420x.437.c, cmdpios, bos411, 9428A410j 2/18/90 23:05:27";
...
#define CODEPAGE "420x.437" /* name of the translate table file to be created */
