static char sccsid[] = "@(#)75  1.5  src/bos/usr/lib/pios/trans2/dp2000.c, cmdpios, bos411, 9428A410j 4/2/92 18:03:21";
...
#define CODEPAGE "dp2000" /* name of the translate table file to be created */
