static char sccsid[] = "@(#)77	1.4  src/bos/usr/lib/pios/trans2/hplj.ibmus.c, cmdpios, bos411, 9428A410j 5/14/91 03:39:24";
...
#define CODEPAGE "hplj.ibmus" /* name of the translate table file to be created */
