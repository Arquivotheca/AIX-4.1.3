static char sccsid[] = "@(#)86	1.1  src/bos/usr/lib/pios/trans2/ascii.c, cmdpios, bos411, 9428A410j 2/18/90 22:58:40";
...
#define CODEPAGE "ascii" /* name of the translate table file to be created */
