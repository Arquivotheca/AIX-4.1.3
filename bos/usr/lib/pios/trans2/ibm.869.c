static char sccsid[] = "@(#)79  1.2  src/bos/usr/lib/pios/trans2/ibm.869.c, cmdpios, bos411, 9428A410j 6/26/91 11:21:32";
...
/*** ibm.869.c - generates Stage 2 translate table to print Code Page ***/
/***         869 on IBM printers (For Proprinters)     ***/
...
#define CODEPAGE "ibm.869" /* name of the translate table file to be created */
...
/*98*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{CP}    ,{SC}    ,{SC}    ,{SC}    ,
/*A0*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,
/*A8*/  {SC}    ,{SC}    ,{0x89}  ,{CP}    ,{SC}    ,{SC}    ,{CP}    ,{CP}    ,
/*B0*/  {CP}    ,{CP}    ,{CP}    ,{CP}    ,{CP}    ,{SC}    ,{SC}    ,{SC}    ,
/*B8*/  {0x97}  ,{CP}    ,{CP}    ,{CP}    ,{CP}    ,{SC}    ,{SC}    ,{CP}    ,
/*C0*/  {CP}    ,{CP}    ,{CP}    ,{CP}    ,{0x8e}  ,{CP}    ,{SC}    ,{SC}    ,
/*C8*/  {CP}    ,{CP}    ,{CP}    ,{CP}    ,{CP}    ,{CP}    ,{CP}    ,{SC}    ,
/*D0*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,
/*D8*/  {SC}    ,{CP}    ,{CP}    ,{CP}    ,{CP}    ,{0x8a}  ,{SC}    ,{CP}    ,
/*E0*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{CP}    ,{SC}    ,
/*E8*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{CP}    ,
/*F0*/  {CP}    ,{CP}    ,{SC}    ,{SC}    ,{0x14,1},{CP}    ,{SC}    ,{SC}    ,
/*F8*/  {CP}    ,{CP}    ,{0x88}  ,{SC}    ,{0x9a}  ,{0x99}  ,{CP}    ,{CP}    ,
/*100*/ {SC}    ,{0x01,1},{0x02,1},{0x03,1},{0x04,1},{0x05,1},{0x06,1},{0x07,1},
/*108*/ {0x08,1},{0x09,1},{0x0a,1},{0x0b,1},{0x0c,1},{0x0d,1},{0x0e,1},{0x0f,1},
/*110*/ {0x10,1},{0x11,1},{0x12,1},{0x13,1},{SC}    ,{SC}    ,{0x16,1},{0x17,1},
/*118*/ {0x18,1},{0x19,1},{0x1a,1},{0x1b,1},{0x1c,1},{0x1d,1},{0x1e,1},{0x1f,1},
/*120*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}   ,
/*128*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}   ,
/*130*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{0xd6}  ,{0xa6} ,
/*138*/  {0xea}  ,{0xcf}  ,{0xec}  ,{SC}    ,{0xee}  ,{0xd2}  ,{0xac}  ,{0xd5} ,
/*140*/  {0xdd}  ,{SC}    ,{0xf3}  ,{0xde}  ,{SC}    ,{SC}    ,{SC}    ,{SC}   ,
...
/*1F8*/  {SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{SC}    ,{0x8b} ,
/*200*/  {0x8c}  ,{0xf7}  ,{0x86}  ,{0x8d}  ,{0x8f}  ,{0x90}  ,{0x92}  ,{0x95} ,
/*208*/  {0x98}  ,{0xa1}  ,{0xa7}  ,{0xb6}  ,{0xbd}  ,{0xc6}  ,{0xd4}  ,{SC} ,
/*210*/  {0x91}  ,{0x96}  ,{0x9b}  ,{0x9d}  ,{0x9e}  ,{0x9f}  ,{0xfc}  ,{0xd7} ,
/*218*/  {0xd8}  ,{0xe0}  ,{0xe1}  ,{0xe2}  ,{0xe3}  ,{0xe4}  ,{0xe5}  ,{0xe7} ,
/*220*/  {0xe8}  ,{0xeb}  ,{0xed}  ,{0xf2}  ,{0xf4}  ,{0xf6}  ,{0xfa}  ,{0xa0} ,
/*228*/  {0xfb}  ,{0xa2}  ,{0xa3}  ,{0xfd}
...
*******************************************************************************/
char cmdnames[][2] = {
{'c', '6'},                     /* index 0 - select the code page */
