static char sccsid[] = "@(#)79	1.4  src/bos/usr/lib/pios/trans2/ibm.437.c, cmdpios, bos411, 9428A410j 2/18/90 23:05:43";
...
#define CODEPAGE "ibm.437" /* name of the translate table file to be created */
