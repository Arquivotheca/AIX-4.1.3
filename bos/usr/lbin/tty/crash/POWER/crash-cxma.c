#ifndef lint
static char sccsid[] = "@(#)34  1.1  src/bos/usr/lbin/tty/crash/POWER/crash-cxma.c, cmdtty, bos411, 9428A410j 3/17/94 03:26:51";
#endif
/*
...
main(int argc, char *argv[])
{
    ...
    if (scxma_print((void *)address, verb) < 0) 
	    error("print failed");
