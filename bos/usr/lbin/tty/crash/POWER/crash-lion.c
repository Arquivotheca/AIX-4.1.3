#ifndef lint
static char sccsid[] = "@(#)54  1.1  src/bos/usr/lbin/tty/crash/POWER/crash-lion.c, cmdtty, bos411, 9428A410j 3/11/94 05:39:11";
#endif
/*
...
main(int argc, char *argv[])
{
    ...
    if (slion_print((void *)address, verb) < 0) 
	    error("print failed");
