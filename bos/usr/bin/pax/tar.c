static char sccsid[] = "@(#)80	1.3  src/bos/usr/bin/pax/tar.c, cmdarch, bos412, 9446B 11/11/94 21:54:22";
/*
...
/* tar_usage - print a helpful message and exit
 *
 * DESCRIPTION
 *
 *	Tar_usage prints out the usage message for the TAR interface and then
