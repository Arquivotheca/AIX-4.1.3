static char sccsid[] = "@(#)03  1.4  src/bos/usr/bin/patch/pch.c, cmdposix, bos41B, 9504A 12/19/94 12:25:38";
/*
 * COMPONENT_NAME: (CMDPOSIX) new commands required by Posix 1003.2
 *
 * FUNCTIONS: re_patch, open_patch_file, set_hunkmax, grow_hunkmax,
 *            there_is_another_patch, intuid_diff_type, next_intuid_at,
 *            skip_to, another_hunk, pgets, pch_swap, pch_first,
 *            pch_ptrn_lines, pch_newfirst, pch_repl_lines, pch_end,
 *            pch_context, pch_line_len, pch_char, pfetch, pch_hunk_beg,
 *            do_ed_script
 *
 * ORIGINS: 27, 85
 *
