static char sccsid[] = "@(#)01	1.5  src/bos/usr/bin/rdist/lookup.c, cmdarch, bos411, 9428A410j 5/23/91 08:42:00";
/*
	...
	struct namelist *value;
{
	...
	if (action == LOOKUP) {
		yyerror(sprintf(buf, MSGSTR(UNDEFINE, "%s undefined"), name));
		return(NULL);
	}
