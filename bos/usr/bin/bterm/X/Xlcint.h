/* @(#)80	1.1  src/bos/usr/bin/bterm/X/Xlcint.h, libbidi, bos411, 9428A410j 10/5/93 18:03:32 */
/*
 *   COMPONENT_NAME: LIBBIDI
 *
 *   FUNCTIONS: XmbTextListToTextProperty
 *		for
 *		_XCodesetNameToAtom
 *		iconv_open
 *		if
...
#define	ICCursor		14
#define	ICResourceName		26
#define	ICResourceClass		27
#ifdef	AIXV3
#define	ICGeometryCallback	28
#endif	/* AIXV3 */
...
#ifdef	AIXV3	/* X11R5 I18N */
/*
 *  All callback functions were defined as void function, even
 *  PreeditStartCallback() is defined as an int function in the
 *  MIT X11R5 specification.
 *  The xlc compiler never permit this void to int cast operation.
 */

typedef int (*XIMIntProc)();
...
/*
 *  The following part is prepared to use dynamic loading mechanism
 *  for locale dependent X layer.
 */
#ifdef	AIXV3	/* X11R5 I18N */
/*
 *	LDX Loading Types
 */
#define	LDX_DYNAMIC 	1
#define LDX_STATIC_SIM 	2
#define	LDX_STATIC_MIM 	3
#define	LDX_SERVER 	4
 ...
 *	LDX Loading Types
 */
typedef	struct _LC_core_ldx_type	_LC_core_ldx_t;
struct	_LC_core_ldx_type 
{
