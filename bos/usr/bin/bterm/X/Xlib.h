/* @(#)85	1.1  src/bos/usr/bin/bterm/X/Xlib.h, libbidi, bos411, 9428A410j 10/5/93 18:04:53 */
/*
 *   COMPONENT_NAME: LIBBIDI
 *
 *   FUNCTIONS: EventMaskOfScreen
 *
 *   ORIGINS: 16,27,
 *
...
#ifdef IBMSHM
	XPointer shmTrans;
	char *flushMark;        /* Output buffer flush point */
#endif
} Display;


#ifdef IBMSHM
#define FLUSH_MARK (dpy->flushMark)
#else
#define FLUSH_MARK (dpy->bufmax)
#endif
