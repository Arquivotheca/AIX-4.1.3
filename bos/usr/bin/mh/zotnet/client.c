static char sccsid[] = "@(#)12  1.6  src/bos/usr/bin/mh/zotnet/client.c, cmdmh, bos411, 9428A410j 3/19/91 08:09:51";
/* 
 * COMPONENT_NAME: CMDMH client.c
 * 
 * FUNCTIONS: brkany, brkstring, client, copyip, getcpy, getport, 
 *            inet, rcaux 
 *
 * ORIGINS: 26  27  28  35 
 *
...
static char *getcpy (), **brkstring (), **copyip ();
...
int	rproto;
{
	...
	if (servers != NULL && *servers != (char)NULL)
