static char sccsid[] = "@(#)22	1.4  src/bos/usr/bin/mh/zotnet/lexstring.c, cmdmh, bos411, 9428A410j 10/19/93 11:48:03";
/* 
 * COMPONENT_NAME: CMDMH lexstring.c
 * 
 * FUNCTIONS: allprint, lex_string 
 *
 * ORIGINS: 26  27  28  35 
 *
