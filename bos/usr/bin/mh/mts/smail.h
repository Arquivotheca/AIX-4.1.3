/* @(#)29	1.3  src/bos/usr/bin/mh/mts/smail.h, cmdmh, bos411, 9428A410j 10/12/90 14:12:40 */
/* 
 * COMPONENT_NAME: CMDMH smail.h
 * 
 * FUNCTIONS: rp_gbbit, rp_gbval, rp_gcbit, rp_gcval, rp_gsbit, 
 *            rp_gsval, rp_gval, rp_isbad, rp_isgood 
 *
 * ORIGINS: 26  28  35 
 *
 */
...
#define rp_isgood(val)  ((int)rp_gval (val) >= 0)
				  /* is return value positive?          */
#define rp_isbad(val)   ((int)rp_gval (val) < 0)
