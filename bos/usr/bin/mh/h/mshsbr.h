/* @(#)19	1.4  src/bos/usr/bin/mh/h/mshsbr.h, cmdmh, bos411, 9428A410j 10/12/90 08:39:38 */
/* 
 * COMPONENT_NAME: CMDMH mshsbr.h
 * 
 * FUNCTIONS: 
 *
 * ORIGINS: 26  28  35 
...
extern char *BBoard_ID;		/* BBoard-ID constant */
				...
				/* SIGNALS */
extern void  (*istat) (int);	/* original SIGINT */
extern void  (*qstat) (int);	/* original SIGQUIT */
