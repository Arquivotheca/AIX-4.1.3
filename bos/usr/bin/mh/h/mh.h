/* @(#)18	1.4  src/bos/usr/bin/mh/h/mh.h, cmdmh, bos411, 9428A410j 3/28/91 16:13:39 */
/* 
 * COMPONENT_NAME: CMDMH mh.h
 * 
 * FUNCTIONS: pidXwait, setsig, setsigx 
 *
 * ORIGINS: 26  28  35 
 *
 */
...
#include <nl_types.h>		/* used for message catalogs */	
#include <locale.h>         /* to be used for setting locale by mh programs */             
