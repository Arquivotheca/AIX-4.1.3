/* @(#)50	1.9  src/bos/usr/bin/tip/tip.h, cmdtip, bos411, 9428A410j 3/11/94 09:14:03 */
/* 
 * COMPONENT_NAME: cmdtip tip.h
 * 
...
#ifdef _AIX
struct termios	
		tbuf,		/* for the user's tty */
		tbufsave,	/* for the user's tty */
		FDbuf,		/* for the tty connected to remote */
		FDbufsave;	/* for the tty connected to remote */
#else
...
int pmask = 0177;		/* parity mask:  either 0177 or 0377 */

/* this part of the code may break the new ansi compiler. */
