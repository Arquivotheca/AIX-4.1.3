static char sccsid[] = "@(#)07	1.3  src/bos/usr/bin/uucp/interface.c, cmduucp, bos411, 9428A410j 3/11/94 10:14:53";
/* 
 * COMPONENT_NAME: CMDUUCP interface.c
 * 
 * FUNCTIONS:  interface, usetup, uteardown, dksetup, tread, twrite, tioctl,
 *	       tsetup, tteardown, tssetup, tfaillog, show_tlook
 *            
 *
 * ORIGINS: 10  27  3 
 *
