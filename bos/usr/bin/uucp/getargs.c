static char sccsid[] = "@(#)94	1.5  src/bos/usr/bin/uucp/getargs.c, cmduucp, bos411, 9428A410j 6/17/93 14:05:26";
/* 
 * COMPONENT_NAME: CMDUUCP getargs.c
 * 
 * FUNCTIONS: bsfix, get_args 
 *
 * ORIGINS: 10  27  3 
 *
