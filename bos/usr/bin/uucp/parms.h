/* @(#)07	1.8.1.3  src/bos/usr/bin/uucp/parms.h, cmduucp, bos411, 9428A410j 3/15/94 18:22:29 */
/* 
 * COMPONENT_NAME: CMDUUCP parms.h
 * 
 * FUNCTIONS: GRPCHK 
 *
 * ORIGINS: 10  27  3 
...
#ifndef AIX
#define AIX		/* For "standard" BSD enhancements to AIX */
#endif
			/* ie. select() */
...
#define GRPMAX	5	/* */
#define STAFF	1	/* */
#define GRPCHK(gid)  ( gid >= GRPMIN && gid <= GRPMAX && gid != STAFF ? 1 : 0 )
...
/* #define UUSTAT_TBL 200		old value */
 ...
 */
#define NOSTRANGERS	"/usr/sbin/uucp/remote.unknown"	/* */
 ...
 *
 * define ETCLOCKS to have lock files put in /etc/locks, ie. as
 * 'connect' and 'ate' do on AIX.
 */
