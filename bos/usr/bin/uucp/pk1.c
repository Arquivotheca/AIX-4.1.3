static char sccsid[] = "@(#)11	1.7  src/bos/usr/bin/uucp/pk1.c, cmduucp, bos411, 9428A410j 6/17/93 14:22:30";
/* 
 * COMPONENT_NAME: CMDUUCP pk1.c
 * 
 ...
 */
jmp_buf Getjbuf;
cgalarm(int s) { longjmp(Getjbuf, 1); }
