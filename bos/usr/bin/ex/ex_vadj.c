#if !defined(lint)
static char sccsid [] = "@(#)84  1.12  src/bos/usr/bin/ex/ex_vadj.c, cmdedit, bos411, 9439B411a 9/27/94 10:48:39";
#endif
/*
 * COMPONENT_NAME: (CMDEDIT) ex_vadj.c
 *
 * FUNCTIONS: sethard, vadjAL, vadjDL, vcloseup, vdellin, vdirty, vglitchup,
 ...
 */
int vreopen(int p, int linenum, int l)
{
	register int d;
