/* @(#)33  1.9 src/bos/usr/bin/ex/ex_temp.h, cmdedit, bos41J, 9511A_all 3/10/95 16:36:59 */
/*
 ...
 */
#define	BLKMSK	0777777
#define	NMBLKS	0777770
...
#define BNDRY     2             /* 2 because of funny use of last bit? */
