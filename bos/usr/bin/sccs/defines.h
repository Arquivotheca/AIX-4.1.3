...
#define _ILS_MACROS    /* must be defined before including ctype.h */
...
extern nl_catd	catd;
#define MSGCO(Num, Str) catgets(catd, MS_CO, Num, Str)
#define MSGCM(Num, Str) catgets(catd, MS_CM, Num, Str)
...
struct packet {
	...
	int	p_7bchash;	/* current (input) hash calculated using signed 
chars */
