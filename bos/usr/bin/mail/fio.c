static char sccsid[] = "@(#)54  1.11  src/bos/usr/bin/mail/fio.c, cmdmailx, bos41J, 9516B_all 4/19/95 15:33:26";
/* 
 * COMPONENT_NAME: CMDMAILX fio.c
 * 
 * FUNCTIONS: MSGSTR, append, edstop, expand, fsize, getfold, 
 *            holdsigs, makemessage, opentemp, putline, readline, 
 *            relsesigs, remove_file, setinput, setptr 
 *
 * ORIGINS: 10  26  27  71
 *
