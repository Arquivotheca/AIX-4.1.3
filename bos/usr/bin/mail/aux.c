static char sccsid[] = "@(#)45	1.8  src/bos/usr/bin/mail/aux.c, cmdmailx, bos411, 9428A410j 11/17/93 10:28:11";
/* 
 * COMPONENT_NAME: CMDMAILX aux.c
 * 
 * FUNCTIONS: MSGSTR, alter, anyof, argcount, blankline, 
 *            blockof, charcount, gethfield, hcontents, 
 *            hfield, icequal, isdir, ishfield, isign, 
 *            istrcpy, member, name1, nameto, nameof, offsetof, 
 *            panic, prs, savestr, skin, source,
 *            touch, unstack 
 *
 * ORIGINS: 10  26  27  71
 *
