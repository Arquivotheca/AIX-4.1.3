/* @(#)57       1.6  src/bos/usr/bin/mail/glob.h, cmdmailx, bos41J, 9520B_all 5/19/95 12:20:45 */
/* 
...
char	*ccflag;			/* Carbon Copy given from non tty */
short	mail_test;			/* Run with -e flag */
int	tab_seq; 			/* Test for tabs with "sign" */
int	topl;				/* Value of toplines variable */
int	called_from_top;		/* Indicate if "top" command issued */
