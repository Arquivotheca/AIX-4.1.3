static char sccsid[] = "@(#)88	1.16  src/bos/usr/bin/bsh/cmd.c, cmdbsh, bos411, 9428A410j 9/1/93 17:30:23";
/*
...
register int	esym;
{
	...
	else
	{
		...
		for (;;)
		{
			...
			{
				argp= wdarg;
				wdarg = (struct argnod *)malloc(length(argp->argval) + BYTESPERWORD);
