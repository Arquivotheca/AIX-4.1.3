/* @(#)41    1.4.2.4  src/bos/kernel/sys/POWER/fddiuser.h, sysxcie, bos411, 9428A410j 3/23/94 16:59:13 */
/*
 * COMPONENT_NAME: (SYSXCIE) - COMIO Emulator (FDDI) 
 *
 * FUNCTIONS: fddiuser.h
 *
 * ORIGINS: 27
 *
