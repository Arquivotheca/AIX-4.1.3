/* @(#)18	1.6  src/bos/kernel/sys/POWER/pnp.h, rspc_softros, bos41J, 9515B_all 4/13/95 14:30:22  */
/*
 *   COMPONENT_NAME: rspc_softros
 *
 *   FUNCTIONS: set_tag_count
 *		set_tag_large_item_name
 *		set_tag_small_item_name
 *		set_tag_type
 *		tag_large_item_name
 *		tag_small_count
 *		tag_small_item_name
...
typedef enum _PnP_INTERFACE {
  ...
  PHBMemoryController = 1,              /* PHB Config Method                  */
  RS6KMemoryController = 2,             /* RS6K Config Method                 */
