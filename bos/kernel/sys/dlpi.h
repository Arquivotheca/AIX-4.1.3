/* @(#)41	1.5  src/bos/kernel/sys/dlpi.h, sysxpse, bos412, 9445C412a 11/10/94 15:48:33 */
/*
 ...
 *
 * As  listed in "A STREAMS-based Data Link Provider Interface - Version 2.0"
 * by R.J. Lewis, J.K. Fellin, D.J. Olander
 *
 * Copyright (c) 1991
...
typedef struct {
	...
	ulong	dl_group_address;	/* set to one if multicase/broadcast */
} dl_unitdata_ind_t;
