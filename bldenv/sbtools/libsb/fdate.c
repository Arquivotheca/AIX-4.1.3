static char sccsid[] = "@(#)35  1.1  src/bldenv/sbtools/libsb/fdate.c, bldprocess, bos412, GOLDA411a 4/29/93 12:20:26";
/*
...
static char rcsid[] = "@(#)$RCSfile: fdate.c,v $ $Revision: 1.7 $ (OSF) $Date: 91/12/05 21:04:45 $";
#endif
# include <sys/types.h>
# include <sys/time.h>
#ifdef INC_TIME
...
static int resp;
static char *result;
static dofield(), percent(), formfld(), copyword(), casefix();
static char foldc();
