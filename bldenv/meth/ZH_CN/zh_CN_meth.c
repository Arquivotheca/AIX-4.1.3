static char sccsid[] = "@(#)72	1.1  src/bldenv/meth/zh_CN/zh_CN_meth.c, ils-zh_CN, bos41B, 9504A 12/16/94 16:53:07";
/*
...
extern __mbstopcs_euccn(); 
extern __mbtopc_euccn(); 
extern __pcstombs_euccn(); 
extern __pctomb_euccn(); 
extern __csid_std(); 
extern __charmap_init(); 
extern __mblen_euccn(); 
extern __mbstowcs_euccn(); 
extern __mbtowc_euccn(); 
extern nl_csinfo(); 
extern __wcsid_std(); 
extern __wcstombs_euccn(); 
extern __wcswidth_euccn(); 
extern __wctomb_euccn(); 
extern __wcwidth_euccn(); 
...
{"charmap.__mbstopcs",
  {0, 0, 0, "__mbstopcs_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 0}},
{"charmap.__mbtopc",
  {0, 0, 0, "__mbtopc_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 1}},
{"charmap.__pcstombs",
  {0, 0, 0, "__pcstombs_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 2}},
{"charmap.__pctomb",
  {0, 0, 0, "__pctomb_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 3}},
{"charmap.csid",
  {0, 0, 0, "__csid_std"},
...
{"charmap.mblen",
  ...
  {-1, -1, -1, 6}},
{"charmap.mbstowcs",
  {0, 0, 0, "__mbstowcs_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 7}},
{"charmap.mbtowc",
  {0, 0, 0, "__mbtowc_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 8}},
{"charmap.nl_langinfo",
  {0, 0, 0, "nl_csinfo"},
...
{"charmap.wcsid",
  ...
  {-1, -1, -1, 10}},
{"charmap.wcstombs",
  {0, 0, 0, "__wcstombs_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 11}},
{"charmap.wcswidth",
  {0, 0, 0, "__wcswidth_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 12}},
{"charmap.wctomb",
  {0, 0, 0, "__wctomb_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 13}},
{"charmap.wcwidth",
  {0, 0, 0, "__wcwidth_euccn"},
  {0, 0, 0, "zh_CN.o"},
  {-1, -1, -1, 14}},
{"collate.fnmatch",
  {0, 0, 0, "__fnmatch_std"},
