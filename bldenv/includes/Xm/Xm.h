/* @(#)78	1.9  src/gos/2d/MOTIF/lib/Xm/Xm.h, libxm, gos41J, 9513A_all 3/21/95 08:53:27 */
/*
...
extern XIC XmImGetXIC() ;    /* BIDI: added for bi-directional IM support */
...
extern XIC XmImGetXIC(
                        Widget w) ; /* BIDI: added for bi-directional IM */
...
/* BIDI: The following definitions are added for bi-directional support */
#ifndef _BIDI_TYPES_DEFINED
#define _BIDI_TYPES_DEFINED
typedef unsigned char   XmDirection;
typedef unsigned char   XmTextMode;
typedef unsigned char   XmCsdMode;
typedef unsigned char   XmNssMode;
enum {  XmTEXT_MODE_VISUAL,     XmTEXT_MODE_IMPLICIT,
        XmTEXT_MODE_EXPLICIT
        };

enum {  XmCSD_MODE_AUTOMATIC,   XmCSD_MODE_PASSTHRU, XmCSD_MODE_INITIAL,
        XmCSD_MODE_MIDDLE, XmCSD_MODE_FINAL, XmCSD_MODE_ISOLATED
        };

enum {  XmNSS_MODE_BILINGUAL,   XmNSS_MODE_PASSTHRU, XmNSS_MODE_ARABIC,
        XmNSS_MODE_HINDU
        };
#endif  /* _BIDI_TYPES_DEFINED */
/* end BIDI */
